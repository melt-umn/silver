...
public final class Porigin_Factor_c extends silver.extension.bidirtransform.NOrigin {
	...
	public static final int num_local_attrs = Init.count_local__ON__origins_test_1_origin_Factor_c;
	...
	public common.Node evalForward(final common.DecoratedNode context) {
		throw new common.exceptions.SilverInternalError("Production origins_test_1:origin_Factor_c erroneously claimed to forward");
	}
	...
	public String getName() {
		return "origins_test_1:origin_Factor_c";
	}

	static void initProductionAttributeDefinitions() {
		// o.isBottomOrigin = false
		origins_test_1.Porigin_Factor_c.synthesizedAttributes[silver.extension.bidirtransform.Init.silver_extension_bidirtransform_isBottomOrigin__ON__silver_extension_bidirtransform_Origin] = new common.Lazy() { public final Object eval(final common.DecoratedNode context) { return false; } };
