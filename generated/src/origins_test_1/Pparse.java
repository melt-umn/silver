...
public final class Pparse extends common.FunctionNode {
	...
	public static final int num_local_attrs = Init.count_local__ON__origins_test_1_parse;
	...
	public String getName() {
		return "origins_test_1:parse";
	}

	public static core.NParseResult invoke(final Object c_stringToParse, final Object c_filenameToReport) {
		try {
		return common.Util.callCopperParser(new origins_test_1.Parser_origins_test_1_parse(), c_stringToParse, c_filenameToReport);
		} catch(Throwable t) {
			throw new common.exceptions.TraceException("Error while evaluating function origins_test_1:parse", t);
		}
	}
