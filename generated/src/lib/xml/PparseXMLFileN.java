...
public final class PparseXMLFileN extends common.FunctionNode {
	...
	public static final int num_local_attrs = Init.count_local__ON__lib_xml_parseXMLFileN;
	...
	public PparseXMLFileN(final Object c_filename) {
	...
	public String getName() {
		return "lib:xml:parseXMLFileN";
	}

	public static core.NParseResult invoke(final Object c_filename) {
		try {
		return (core.NParseResult)common.rawlib.RawXML.parseXMLFileN(((common.StringCatter)common.Util.demand(c_filename)));

		} catch(Throwable t) {
			throw new common.exceptions.TraceException("Error while evaluating function lib:xml:parseXMLFileN", t);
		}
	}
	...
	public static final class Factory extends common.NodeFactory<core.NParseResult> {
		...
		public core.NParseResult invoke(final Object[] children, final Object[] namedNotApplicable) {
			return PparseXMLFileN.invoke(children[0]);
		}
	};
}