...
public final class PnodeListXPathReQueryFns extends common.FunctionNode {
	...
	public static final int num_local_attrs = Init.count_local__ON__lib_xml_foreigntypes_nodeListXPathReQueryFns;
	...
	public PnodeListXPathReQueryFns(final Object c_query, final Object c_ns, final Object c_doc) {
	...
	public String getName() {
		return "lib:xml:foreigntypes:nodeListXPathReQueryFns";
	}
	...
	public static Object invoke(final Object c_query, final Object c_ns, final Object c_doc) {
		...
		return (Object)common.rawlib.RawXML.xpathQueryNodeSet(((Object)common.Util.demand(c_doc)), ((common.StringCatter)common.Util.demand(c_query)).toString(), ((common.ConsCell)common.Util.demand(c_ns)));
			...
			throw new common.exceptions.TraceException("Error while evaluating function lib:xml:foreigntypes:nodeListXPathReQueryFns", t);
		}
	}
	...
	public static final class Factory extends common.NodeFactory<Object> {
		...
		public Object invoke(final Object[] children, final Object[] namedNotApplicable) {
			return PnodeListXPathReQueryFns.invoke(children[0], children[1], children[2]);
		}
	};
}