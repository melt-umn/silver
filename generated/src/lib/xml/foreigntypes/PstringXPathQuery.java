...
public final class PstringXPathQuery extends common.FunctionNode {
	...
	public static final int num_local_attrs = Init.count_local__ON__lib_xml_foreigntypes_stringXPathQuery;
	...
	public PstringXPathQuery(final Object c_query, final Object c_doc) {
	...
	public String getName() {
		return "lib:xml:foreigntypes:stringXPathQuery";
	}
	...
	public static common.StringCatter invoke(final Object c_query, final Object c_doc) {
		...
		return (common.StringCatter)common.rawlib.RawXML.xpathQueryString(((Object)common.Util.demand(c_doc)), ((common.StringCatter)common.Util.demand(c_query)).toString(), null);
			...
			throw new common.exceptions.TraceException("Error while evaluating function lib:xml:foreigntypes:stringXPathQuery", t);
		}
	}
	...
	public static final class Factory extends common.NodeFactory<common.StringCatter> {
		...
		public common.StringCatter invoke(final Object[] children, final Object[] namedNotApplicable) {
			return PstringXPathQuery.invoke(children[0], children[1]);
		}
	};
}