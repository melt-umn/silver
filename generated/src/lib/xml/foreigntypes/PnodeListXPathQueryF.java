...
public final class PnodeListXPathQueryF extends common.FunctionNode {
	...
	public static final int num_local_attrs = Init.count_local__ON__lib_xml_foreigntypes_nodeListXPathQueryF;
	...
	public PnodeListXPathQueryF(final Object c_query, final Object c_doc) {
	...
	public String getName() {
		return "lib:xml:foreigntypes:nodeListXPathQueryF";
	}
	...
	public static Object invoke(final Object c_query, final Object c_doc) {
		...
		return (Object)common.rawlib.RawXML.xpathQueryNodeSet(((Object)common.Util.demand(c_doc)), ((common.StringCatter)common.Util.demand(c_query)).toString(), null);
			...
			throw new common.exceptions.TraceException("Error while evaluating function lib:xml:foreigntypes:nodeListXPathQueryF", t);
		}
	}
	...
	public static final class Factory extends common.NodeFactory<Object> {
		...
		public Object invoke(final Object[] children, final Object[] namedNotApplicable) {
			return PnodeListXPathQueryF.invoke(children[0], children[1]);
		}
	};
}