...
public final class Porigin_Factor_c extends silver.extension.bidirtransform.NOrigin {
	...
	public static final int num_local_attrs = Init.count_local__ON__paper_dc_3_origin_Factor_c;
	...
	public common.Node evalForward(final common.DecoratedNode context) {
		throw new common.exceptions.SilverInternalError("Production paper_dc_3:origin_Factor_c erroneously claimed to forward");
	}
	...
	public String getName() {
		return "paper_dc_3:origin_Factor_c";
	}

	static void initProductionAttributeDefinitions() {
		// o.isBottomOrigin = false
		paper_dc_3.Porigin_Factor_c.synthesizedAttributes[silver.extension.bidirtransform.Init.silver_extension_bidirtransform_isBottomOrigin__ON__silver_extension_bidirtransform_Origin] = new common.Lazy() { public final Object eval(final common.DecoratedNode context) { return false; } };
