...
public final class PextendedParser extends common.FunctionNode {
	...
	public static final int num_local_attrs = Init.count_local__ON__terminalSubmit_extendedParser;
	...
	public String getName() {
		return "terminalSubmit:extendedParser";
	}

	public static core.NParseResult invoke(final Object c_stringToParse, final Object c_filenameToReport) {
		try {
		return common.Util.callCopperParser(new terminalSubmit.Parser_terminalSubmit_extendedParser(), c_stringToParse, c_filenameToReport);
		} catch(Throwable t) {
			throw new common.exceptions.TraceException("Error while evaluating function terminalSubmit:extendedParser", t);
		}
	}
