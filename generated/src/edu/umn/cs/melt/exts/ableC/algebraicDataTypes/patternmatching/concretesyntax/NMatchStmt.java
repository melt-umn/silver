...
public abstract class NMatchStmt extends common.Node implements core.Alocation {

	public static final int num_inh_attrs = Init.count_inh__ON__MatchStmt;
	public static final int num_syn_attrs = Init.count_syn__ON__MatchStmt;
	...
	protected NMatchStmt(final Object a_core_location) {
