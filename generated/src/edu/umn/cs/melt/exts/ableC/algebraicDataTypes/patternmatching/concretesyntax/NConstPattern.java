...
public abstract class NConstPattern extends common.Node implements core.Alocation {

	public static final int num_inh_attrs = Init.count_inh__ON__ConstPattern;
	public static final int num_syn_attrs = Init.count_syn__ON__ConstPattern;
	...
	protected NConstPattern(final Object a_core_location) {
