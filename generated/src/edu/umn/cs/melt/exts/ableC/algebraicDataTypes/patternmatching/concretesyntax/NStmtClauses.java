...
public abstract class NStmtClauses extends common.Node implements core.Alocation {

	public static final int num_inh_attrs = Init.count_inh__ON__StmtClauses;
	public static final int num_syn_attrs = Init.count_syn__ON__StmtClauses;
	...
	protected NStmtClauses(final Object a_core_location) {
