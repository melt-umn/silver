...
public abstract class NExprClauses extends common.Node implements core.Alocation {

	public static final int num_inh_attrs = Init.count_inh__ON__ExprClauses;
	public static final int num_syn_attrs = Init.count_syn__ON__ExprClauses;
	...
	protected NExprClauses(final Object a_core_location) {
