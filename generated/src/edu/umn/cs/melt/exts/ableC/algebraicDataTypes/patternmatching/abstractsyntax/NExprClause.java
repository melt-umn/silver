...
public abstract class NExprClause extends common.Node implements core.Alocation {

	public static final int num_inh_attrs = Init.count_inh__ON__ExprClause;
	public static final int num_syn_attrs = Init.count_syn__ON__ExprClause;
	...
	protected NExprClause(final Object a_core_location) {
