...
public abstract class NMatch extends common.Node implements core.Alocation {

	public static final int num_inh_attrs = Init.count_inh__ON__Match;
	public static final int num_syn_attrs = Init.count_syn__ON__Match;
	...
	protected NMatch(final Object a_core_location) {
