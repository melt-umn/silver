...
public abstract class NConstructor extends common.Node implements core.Alocation {

	public static final int num_inh_attrs = Init.count_inh__ON__Constructor;
	public static final int num_syn_attrs = Init.count_syn__ON__Constructor;
	...
	protected NConstructor(final Object a_core_location) {
