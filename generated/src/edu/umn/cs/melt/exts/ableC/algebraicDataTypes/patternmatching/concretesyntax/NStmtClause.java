...
public abstract class NStmtClause extends common.Node implements core.Alocation {

	public static final int num_inh_attrs = Init.count_inh__ON__StmtClause;
	public static final int num_syn_attrs = Init.count_syn__ON__StmtClause;
	...
	protected NStmtClause(final Object a_core_location) {
