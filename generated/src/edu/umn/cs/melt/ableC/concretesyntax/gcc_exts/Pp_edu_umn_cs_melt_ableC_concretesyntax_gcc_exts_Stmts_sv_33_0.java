...
public final class Pp_edu_umn_cs_melt_ableC_concretesyntax_gcc_exts_Stmts_sv_33_0 extends edu.umn.cs.melt.ableC.concretesyntax.NJumpStmt_c {
	...
	public static final Class<?> childTypes[] = {edu.umn.cs.melt.ableC.concretesyntax.gcc_exts.NAsm_Starter_c.class,edu.umn.cs.melt.ableC.concretesyntax.TGOTO.class,edu.umn.cs.melt.ableC.concretesyntax.TLParen_t.class,edu.umn.cs.melt.ableC.concretesyntax.NStringConstant_c.class,edu.umn.cs.melt.ableC.concretesyntax.TColon_t.class,edu.umn.cs.melt.ableC.concretesyntax.TColon_t.class,edu.umn.cs.melt.ableC.concretesyntax.TColon_t.class,edu.umn.cs.melt.ableC.concretesyntax.TColon_t.class,edu.umn.cs.melt.ableC.concretesyntax.NIdentifierList_c.class,edu.umn.cs.melt.ableC.concretesyntax.TRParen_t.class};

	public static final int num_local_attrs = Init.count_local__ON__edu_umn_cs_melt_ableC_concretesyntax_gcc_exts_p_edu_umn_cs_melt_ableC_concretesyntax_gcc_exts_Stmts_sv_33_0;
	...
	public Pp_edu_umn_cs_melt_ableC_concretesyntax_gcc_exts_Stmts_sv_33_0(final Object c__G_9, final Object c__G_8, final Object c__G_7, final Object c__G_6, final Object c__G_5, final Object c__G_4, final Object c__G_3, final Object c__G_2, final Object c__G_1, final Object c__G_0, final Object a_core_location) {
	...
	public final edu.umn.cs.melt.ableC.concretesyntax.TGOTO getChild__G_8() {
		return (edu.umn.cs.melt.ableC.concretesyntax.TGOTO) (child__G_8 = common.Util.demand(child__G_8));
	}

	private Object child__G_7;
	public final edu.umn.cs.melt.ableC.concretesyntax.TLParen_t getChild__G_7() {
		return (edu.umn.cs.melt.ableC.concretesyntax.TLParen_t) (child__G_7 = common.Util.demand(child__G_7));
	}
	...
	public final edu.umn.cs.melt.ableC.concretesyntax.TColon_t getChild__G_5() {
		return (edu.umn.cs.melt.ableC.concretesyntax.TColon_t) (child__G_5 = common.Util.demand(child__G_5));
	}
	...
	public common.Node evalForward(final common.DecoratedNode context) {
		throw new common.exceptions.SilverInternalError("Production edu:umn:cs:melt:ableC:concretesyntax:gcc_exts:p_edu_umn_cs_melt_ableC_concretesyntax_gcc_exts_Stmts_sv_33_0 erroneously claimed to forward");
	}
	...
	public String getName() {
		return "edu:umn:cs:melt:ableC:concretesyntax:gcc_exts:p_edu_umn_cs_melt_ableC_concretesyntax_gcc_exts_Stmts_sv_33_0";
	}

	static void initProductionAttributeDefinitions() {
		// top.ast = ast:warnStmt([ err(top.location, "Unable to handle computed goto, yet.",) ],)
		edu.umn.cs.melt.ableC.concretesyntax.gcc_exts.Pp_edu_umn_cs_melt_ableC_concretesyntax_gcc_exts_Stmts_sv_33_0.synthesizedAttributes[edu.umn.cs.melt.ableC.concretesyntax.Init.silver_langutil_ast__ON__edu_umn_cs_melt_ableC_concretesyntax_JumpStmt_c] = new common.Lazy() { public final Object eval(final common.DecoratedNode context) { return ((edu.umn.cs.melt.ableC.abstractsyntax.host.NStmt)new edu.umn.cs.melt.ableC.abstractsyntax.host.PwarnStmt(new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((common.ConsCell)core.Pcons.invoke(new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((silver.langutil.NMessage)new silver.langutil.Perr(new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((core.NLocation)((edu.umn.cs.melt.ableC.concretesyntax.NJumpStmt_c)context.undecorate()).getAnno_core_location()); } }, (new common.StringCatter("Unable to handle computed goto, yet.")))); } }, new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((common.ConsCell)core.Pnil.invoke()); } })); } })); } };

	}

	public static final common.NodeFactory<Pp_edu_umn_cs_melt_ableC_concretesyntax_gcc_exts_Stmts_sv_33_0> factory = new Factory();

	public static final class Factory extends common.NodeFactory<Pp_edu_umn_cs_melt_ableC_concretesyntax_gcc_exts_Stmts_sv_33_0> {

		@Override
		public Pp_edu_umn_cs_melt_ableC_concretesyntax_gcc_exts_Stmts_sv_33_0 invoke(final Object[] children, final Object[] annotations) {
			return new Pp_edu_umn_cs_melt_ableC_concretesyntax_gcc_exts_Stmts_sv_33_0(children[0], children[1], children[2], children[3], children[4], children[5], children[6], children[7], children[8], children[9], annotations[0]);
		}
	};
