...
public final class PgetDereferenceOverload extends common.FunctionNode {
	...
	public static final int num_local_attrs = Init.count_local__ON__edu_umn_cs_melt_ableC_abstractsyntax_overloadable_getDereferenceOverload;
	...
	public PgetDereferenceOverload(final Object c_t, final Object c_env) {
		this.child_t = c_t;
	...
	public String getName() {
		return "edu:umn:cs:melt:ableC:abstractsyntax:overloadable:getDereferenceOverload";
	}

	public static core.NMaybe invoke(final Object c_t, final Object c_env) {
		try {
		final common.DecoratedNode context = new PgetDereferenceOverload(c_t, c_env).decorate();
		//do (bindMaybe, returnMaybe) {n::String <- moduleName(env, t,); prod::(Expr ::= Expr Location) <- lookupBy(stringEq, n, overloads,); return prod;}
		return (core.NMaybe)(((core.NMaybe)core.monad.PbindMaybe.invoke(new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((core.NMaybe)edu.umn.cs.melt.ableC.abstractsyntax.host.PmoduleName.invoke(context.childAsIsLazy(edu.umn.cs.melt.ableC.abstractsyntax.overloadable.PgetDereferenceOverload.i_env), common.Thunk.transformUndecorate(context.childDecoratedLazy(edu.umn.cs.melt.ableC.abstractsyntax.overloadable.PgetDereferenceOverload.i_t)))); } }, (new common.NodeFactory<core.NMaybe>() {
  public final core.NMaybe invoke(final Object[] args, final Object[] namedArgs) {
    final Object __SV_LAMBDA_PARAM_888_n = args[0];

    return ((core.NMaybe)core.monad.PbindMaybe.invoke(new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((core.NMaybe)core.PlookupBy.invoke(core.PstringEq.factory, ((common.StringCatter)common.Util.demand(__SV_LAMBDA_PARAM_888_n)), context.localAsIsLazy(edu.umn.cs.melt.ableC.abstractsyntax.overloadable.Init.overloads__ON__edu_umn_cs_melt_ableC_abstractsyntax_overloadable_getDereferenceOverload))); } }, (new common.NodeFactory<core.NMaybe>() {
  public final core.NMaybe invoke(final Object[] args, final Object[] namedArgs) {
    final Object __SV_LAMBDA_PARAM_889_prod = args[0];

    return ((core.NMaybe)core.monad.PreturnMaybe.invoke(((common.NodeFactory<edu.umn.cs.melt.ableC.abstractsyntax.host.NExpr>)common.Util.demand(__SV_LAMBDA_PARAM_889_prod))));
  }
})));
  }
}))));
			...
			throw new common.exceptions.TraceException("Error while evaluating function edu:umn:cs:melt:ableC:abstractsyntax:overloadable:getDereferenceOverload", t);
		}
	}
	...
	public static final class Factory extends common.NodeFactory<core.NMaybe> {
		...
		public core.NMaybe invoke(final Object[] children, final Object[] namedNotApplicable) {
			return PgetDereferenceOverload.invoke(children[0], children[1]);
		}
	};
}