...
public final class PgetBitNegateOpOverload extends common.FunctionNode {
	...
	public static final int num_local_attrs = Init.count_local__ON__edu_umn_cs_melt_ableC_abstractsyntax_overloadable_getBitNegateOpOverload;
	...
	public PgetBitNegateOpOverload(final Object c_t, final Object c_env) {
		this.child_t = c_t;
	...
	public String getName() {
		return "edu:umn:cs:melt:ableC:abstractsyntax:overloadable:getBitNegateOpOverload";
	}

	public static core.NMaybe invoke(final Object c_t, final Object c_env) {
		try {
		final common.DecoratedNode context = new PgetBitNegateOpOverload(c_t, c_env).decorate();
		//getUnaryOverload(t, env, overloads,)
		return (core.NMaybe)(((core.NMaybe)edu.umn.cs.melt.ableC.abstractsyntax.overloadable.PgetUnaryOverload.invoke(common.Thunk.transformUndecorate(context.childDecoratedLazy(edu.umn.cs.melt.ableC.abstractsyntax.overloadable.PgetBitNegateOpOverload.i_t)), context.childAsIsLazy(edu.umn.cs.melt.ableC.abstractsyntax.overloadable.PgetBitNegateOpOverload.i_env), context.localAsIsLazy(edu.umn.cs.melt.ableC.abstractsyntax.overloadable.Init.overloads__ON__edu_umn_cs_melt_ableC_abstractsyntax_overloadable_getBitNegateOpOverload))));

		} catch(Throwable t) {
			throw new common.exceptions.TraceException("Error while evaluating function edu:umn:cs:melt:ableC:abstractsyntax:overloadable:getBitNegateOpOverload", t);
		}
	}
	...
	public static final class Factory extends common.NodeFactory<core.NMaybe> {
		...
		public core.NMaybe invoke(final Object[] children, final Object[] namedNotApplicable) {
			return PgetBitNegateOpOverload.invoke(children[0], children[1]);
		}
	};
}