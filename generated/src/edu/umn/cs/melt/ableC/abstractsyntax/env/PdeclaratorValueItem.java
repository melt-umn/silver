...
public final class PdeclaratorValueItem extends edu.umn.cs.melt.ableC.abstractsyntax.env.NValueItem {
	...
	public static final int num_local_attrs = Init.count_local__ON__edu_umn_cs_melt_ableC_abstractsyntax_env_declaratorValueItem;
	...
	public PdeclaratorValueItem(final Object c_s) {
		super();
		this.child_s = c_s;
	...
	public common.Node evalForward(final common.DecoratedNode context) {
		throw new common.exceptions.SilverInternalError("Production edu:umn:cs:melt:ableC:abstractsyntax:env:declaratorValueItem erroneously claimed to forward");
	}
	...
	static void initProductionAttributeDefinitions() {
		...
		edu.umn.cs.melt.ableC.abstractsyntax.env.PdeclaratorValueItem.synthesizedAttributes[edu.umn.cs.melt.ableC.abstractsyntax.env.Init.edu_umn_cs_melt_ableC_abstractsyntax_env_isItemTypedef__ON__edu_umn_cs_melt_ableC_abstractsyntax_env_ValueItem] = new common.Lazy() { public final Object eval(final common.DecoratedNode context) { return ((Boolean)((common.DecoratedNode)context.childAsIs(edu.umn.cs.melt.ableC.abstractsyntax.env.PdeclaratorValueItem.i_s)).inherited(edu.umn.cs.melt.ableC.abstractsyntax.host.Init.edu_umn_cs_melt_ableC_abstractsyntax_host_isTypedef__ON__edu_umn_cs_melt_ableC_abstractsyntax_host_Declarator)); } };

	}

	public static final common.NodeFactory<PdeclaratorValueItem> factory = new Factory();

	public static final class Factory extends common.NodeFactory<PdeclaratorValueItem> {

		@Override
		public PdeclaratorValueItem invoke(final Object[] children, final Object[] annotations) {
			return new PdeclaratorValueItem(children[0]);
		}
	};
