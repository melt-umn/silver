...
public final class PerrorTypeExpr extends edu.umn.cs.melt.ableC.abstractsyntax.host.NBaseTypeExpr {
	...
	public static final int num_local_attrs = Init.count_local__ON__edu_umn_cs_melt_ableC_abstractsyntax_host_errorTypeExpr;
	...
	public common.Node evalForward(final common.DecoratedNode context) {
		throw new common.exceptions.SilverInternalError("Production edu:umn:cs:melt:ableC:abstractsyntax:host:errorTypeExpr erroneously claimed to forward");
	}
	...
	public String getName() {
		return "edu:umn:cs:melt:ableC:abstractsyntax:host:errorTypeExpr";
	}

	static void initProductionAttributeDefinitions() {
		// top.host = edu:umn:cs:melt:ableC:abstractsyntax:host:errorTypeExpr(, msg,)
		edu.umn.cs.melt.ableC.abstractsyntax.host.PerrorTypeExpr.synthesizedAttributes[edu.umn.cs.melt.ableC.abstractsyntax.host.Init.edu_umn_cs_melt_ableC_abstractsyntax_host_host__ON__edu_umn_cs_melt_ableC_abstractsyntax_host_BaseTypeExpr] = new common.Lazy() { public final Object eval(final common.DecoratedNode context) { return ((edu.umn.cs.melt.ableC.abstractsyntax.host.NBaseTypeExpr)new edu.umn.cs.melt.ableC.abstractsyntax.host.PerrorTypeExpr(context.childAsIsLazy(edu.umn.cs.melt.ableC.abstractsyntax.host.PerrorTypeExpr.i_msg))); } };
		// top.lifted = edu:umn:cs:melt:ableC:abstractsyntax:host:errorTypeExpr(, msg,)
		edu.umn.cs.melt.ableC.abstractsyntax.host.PerrorTypeExpr.synthesizedAttributes[edu.umn.cs.melt.ableC.abstractsyntax.host.Init.edu_umn_cs_melt_ableC_abstractsyntax_host_lifted__ON__edu_umn_cs_melt_ableC_abstractsyntax_host_BaseTypeExpr] = new common.Lazy() { public final Object eval(final common.DecoratedNode context) { return ((edu.umn.cs.melt.ableC.abstractsyntax.host.NBaseTypeExpr)new edu.umn.cs.melt.ableC.abstractsyntax.host.PerrorTypeExpr(context.childAsIsLazy(edu.umn.cs.melt.ableC.abstractsyntax.host.PerrorTypeExpr.i_msg))); } };
		// top.pp = silver:langutil:pp:text("/*err*/",)
		...
		// top.errors := msg
		if(edu.umn.cs.melt.ableC.abstractsyntax.host.PerrorTypeExpr.synthesizedAttributes[edu.umn.cs.melt.ableC.abstractsyntax.host.Init.silver_langutil_errors__ON__edu_umn_cs_melt_ableC_abstractsyntax_host_BaseTypeExpr] == null)
		...
		// top.globalDecls := []
		if(edu.umn.cs.melt.ableC.abstractsyntax.host.PerrorTypeExpr.synthesizedAttributes[edu.umn.cs.melt.ableC.abstractsyntax.host.Init.edu_umn_cs_melt_ableC_abstractsyntax_host_globalDecls__ON__edu_umn_cs_melt_ableC_abstractsyntax_host_BaseTypeExpr] == null)
		...
		// top.defs := []
		if(edu.umn.cs.melt.ableC.abstractsyntax.host.PerrorTypeExpr.synthesizedAttributes[edu.umn.cs.melt.ableC.abstractsyntax.host.Init.edu_umn_cs_melt_ableC_abstractsyntax_env_defs__ON__edu_umn_cs_melt_ableC_abstractsyntax_host_BaseTypeExpr] == null)
	...
	public static final common.NodeFactory<PerrorTypeExpr> factory = new Factory();

	public static final class Factory extends common.NodeFactory<PerrorTypeExpr> {

		@Override
		public PerrorTypeExpr invoke(final Object[] children, final Object[] annotations) {
			return new PerrorTypeExpr(children[0]);
		}
	};
