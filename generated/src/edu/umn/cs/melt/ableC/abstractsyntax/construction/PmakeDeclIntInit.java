...
public final class PmakeDeclIntInit extends common.FunctionNode {
	...
	public static final int num_local_attrs = Init.count_local__ON__edu_umn_cs_melt_ableC_abstractsyntax_construction_makeDeclIntInit;
	...
	public PmakeDeclIntInit(final Object c_n, final Object c_val, final Object c_l) {
		this.child_n = c_n;
	...
	public String getName() {
		return "edu:umn:cs:melt:ableC:abstractsyntax:construction:makeDeclIntInit";
	}

	public static edu.umn.cs.melt.ableC.abstractsyntax.host.NDecl invoke(final Object c_n, final Object c_val, final Object c_l) {
		try {
		final common.DecoratedNode context = new PmakeDeclIntInit(c_n, c_val, c_l).decorate();
		//makeDeclIntGeneral(n, justInitializer(exprInitializer(mkIntExpr(val, l,),),), l,)
		return (edu.umn.cs.melt.ableC.abstractsyntax.host.NDecl)(((edu.umn.cs.melt.ableC.abstractsyntax.host.NDecl)edu.umn.cs.melt.ableC.abstractsyntax.construction.PmakeDeclIntGeneral.invoke(context.childAsIsLazy(edu.umn.cs.melt.ableC.abstractsyntax.construction.PmakeDeclIntInit.i_n), new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((edu.umn.cs.melt.ableC.abstractsyntax.host.NMaybeInitializer)new edu.umn.cs.melt.ableC.abstractsyntax.host.PjustInitializer(new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((edu.umn.cs.melt.ableC.abstractsyntax.host.NInitializer)new edu.umn.cs.melt.ableC.abstractsyntax.host.PexprInitializer(new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((edu.umn.cs.melt.ableC.abstractsyntax.host.NExpr)edu.umn.cs.melt.ableC.abstractsyntax.construction.PmkIntExpr.invoke(context.childAsIsLazy(edu.umn.cs.melt.ableC.abstractsyntax.construction.PmakeDeclIntInit.i_val), common.Thunk.transformUndecorate(context.childDecoratedLazy(edu.umn.cs.melt.ableC.abstractsyntax.construction.PmakeDeclIntInit.i_l)))); } })); } })); } }, common.Thunk.transformUndecorate(context.childDecoratedLazy(edu.umn.cs.melt.ableC.abstractsyntax.construction.PmakeDeclIntInit.i_l)))));

		} catch(Throwable t) {
			throw new common.exceptions.TraceException("Error while evaluating function edu:umn:cs:melt:ableC:abstractsyntax:construction:makeDeclIntInit", t);
		}
	}
	...
	public static final class Factory extends common.NodeFactory<edu.umn.cs.melt.ableC.abstractsyntax.host.NDecl> {
		...
		public edu.umn.cs.melt.ableC.abstractsyntax.host.NDecl invoke(final Object[] children, final Object[] namedNotApplicable) {
			return PmakeDeclIntInit.invoke(children[0], children[1], children[2]);
		}
	};
}