...
public final class PparameterValueItem extends edu.umn.cs.melt.ableC.abstractsyntax.env.NValueItem {
	...
	public static final int num_local_attrs = Init.count_local__ON__edu_umn_cs_melt_ableC_abstractsyntax_env_parameterValueItem;
	...
	public PparameterValueItem(final Object c_s) {
		super();
		this.child_s = c_s;
	...
	public common.Node evalForward(final common.DecoratedNode context) {
		throw new common.exceptions.SilverInternalError("Production edu:umn:cs:melt:ableC:abstractsyntax:env:parameterValueItem erroneously claimed to forward");
	}
	...
	public static final common.NodeFactory<PparameterValueItem> factory = new Factory();

	public static final class Factory extends common.NodeFactory<PparameterValueItem> {

		@Override
		public PparameterValueItem invoke(final Object[] children, final Object[] annotations) {
			return new PparameterValueItem(children[0]);
		}
	};
