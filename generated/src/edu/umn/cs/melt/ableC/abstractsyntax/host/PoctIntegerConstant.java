...
public final class PoctIntegerConstant extends edu.umn.cs.melt.ableC.abstractsyntax.host.NNumericConstant {
	...
	public static final int num_local_attrs = Init.count_local__ON__edu_umn_cs_melt_ableC_abstractsyntax_host_octIntegerConstant;
	...
	public PoctIntegerConstant(final Object c_num, final Object c_unsigned, final Object c_suffix, final Object a_core_location) {
	...
	public common.Node evalForward(final common.DecoratedNode context) {
		throw new common.exceptions.SilverInternalError("Production edu:umn:cs:melt:ableC:abstractsyntax:host:octIntegerConstant erroneously claimed to forward");
	}
	...
	public String getName() {
		return "edu:umn:cs:melt:ableC:abstractsyntax:host:octIntegerConstant";
	}

	static void initProductionAttributeDefinitions() {
		// top.host = edu:umn:cs:melt:ableC:abstractsyntax:host:octIntegerConstant(, num, unsigned, suffix,, location=top.location)
		edu.umn.cs.melt.ableC.abstractsyntax.host.PoctIntegerConstant.synthesizedAttributes[edu.umn.cs.melt.ableC.abstractsyntax.host.Init.edu_umn_cs_melt_ableC_abstractsyntax_host_host__ON__edu_umn_cs_melt_ableC_abstractsyntax_host_NumericConstant] = new common.Lazy() { public final Object eval(final common.DecoratedNode context) { return ((edu.umn.cs.melt.ableC.abstractsyntax.host.NNumericConstant)new edu.umn.cs.melt.ableC.abstractsyntax.host.PoctIntegerConstant(context.childAsIsLazy(edu.umn.cs.melt.ableC.abstractsyntax.host.PoctIntegerConstant.i_num), context.childAsIsLazy(edu.umn.cs.melt.ableC.abstractsyntax.host.PoctIntegerConstant.i_unsigned), common.Thunk.transformUndecorate(context.childDecoratedLazy(edu.umn.cs.melt.ableC.abstractsyntax.host.PoctIntegerConstant.i_suffix)), new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((core.NLocation)((edu.umn.cs.melt.ableC.abstractsyntax.host.NNumericConstant)context.undecorate()).getAnno_core_location()); } })); } };
		// top.lifted = edu:umn:cs:melt:ableC:abstractsyntax:host:octIntegerConstant(, num, unsigned, suffix,, location=top.location)
		...
		// top.pp = text(num,)
		edu.umn.cs.melt.ableC.abstractsyntax.host.PoctIntegerConstant.synthesizedAttributes[edu.umn.cs.melt.ableC.abstractsyntax.host.Init.silver_langutil_pp__ON__edu_umn_cs_melt_ableC_abstractsyntax_host_NumericConstant] = new common.Lazy() { public final Object eval(final common.DecoratedNode context) { return ((silver.langutil.pp.NDocument)new silver.langutil.pp.Ptext(context.childAsIsLazy(edu.umn.cs.melt.ableC.abstractsyntax.host.PoctIntegerConstant.i_num))); } };
		// top.errors := []
		if(edu.umn.cs.melt.ableC.abstractsyntax.host.PoctIntegerConstant.synthesizedAttributes[edu.umn.cs.melt.ableC.abstractsyntax.host.Init.silver_langutil_errors__ON__edu_umn_cs_melt_ableC_abstractsyntax_host_NumericConstant] == null)
