...
public final class PwarnDecl extends edu.umn.cs.melt.ableC.abstractsyntax.host.NDecl {
	...
	public static final int num_local_attrs = Init.count_local__ON__edu_umn_cs_melt_ableC_abstractsyntax_host_warnDecl;
	...
	public PwarnDecl(final Object c_msg) {
		super();
	...
	public common.Node evalForward(final common.DecoratedNode context) {
		throw new common.exceptions.SilverInternalError("Production edu:umn:cs:melt:ableC:abstractsyntax:host:warnDecl erroneously claimed to forward");
	}
	...
	public String getName() {
		return "edu:umn:cs:melt:ableC:abstractsyntax:host:warnDecl";
	}

	static void initProductionAttributeDefinitions() {
		// top.host = edu:umn:cs:melt:ableC:abstractsyntax:host:warnDecl(, msg,)
		edu.umn.cs.melt.ableC.abstractsyntax.host.PwarnDecl.synthesizedAttributes[edu.umn.cs.melt.ableC.abstractsyntax.host.Init.edu_umn_cs_melt_ableC_abstractsyntax_host_host__ON__edu_umn_cs_melt_ableC_abstractsyntax_host_Decl] = new common.Lazy() { public final Object eval(final common.DecoratedNode context) { return ((edu.umn.cs.melt.ableC.abstractsyntax.host.NDecl)new edu.umn.cs.melt.ableC.abstractsyntax.host.PwarnDecl(context.childAsIsLazy(edu.umn.cs.melt.ableC.abstractsyntax.host.PwarnDecl.i_msg))); } };
		// top.lifted = edu:umn:cs:melt:ableC:abstractsyntax:host:warnDecl(, msg,)
		...
		// top.globalDecls := []
		if(edu.umn.cs.melt.ableC.abstractsyntax.host.PwarnDecl.synthesizedAttributes[edu.umn.cs.melt.ableC.abstractsyntax.host.Init.edu_umn_cs_melt_ableC_abstractsyntax_host_globalDecls__ON__edu_umn_cs_melt_ableC_abstractsyntax_host_Decl] == null)
		...
		// top.defs := []
		if(edu.umn.cs.melt.ableC.abstractsyntax.host.PwarnDecl.synthesizedAttributes[edu.umn.cs.melt.ableC.abstractsyntax.host.Init.edu_umn_cs_melt_ableC_abstractsyntax_env_defs__ON__edu_umn_cs_melt_ableC_abstractsyntax_host_Decl] == null)
	...
	public static final common.NodeFactory<PwarnDecl> factory = new Factory();

	public static final class Factory extends common.NodeFactory<PwarnDecl> {

		@Override
		public PwarnDecl invoke(final Object[] children, final Object[] annotations) {
			return new PwarnDecl(children[0]);
		}
	};
