...
// top::Expr ::= s::String 
public final class Pcomment extends edu.umn.cs.melt.ableC.abstractsyntax.host.NExpr {
	...
	public static final int num_local_attrs = Init.count_local__ON__edu_umn_cs_melt_ableC_abstractsyntax_host_comment;
	...
	public Pcomment(final Object c_s, final Object a_core_location) {
	...
	public common.Node evalForward(final common.DecoratedNode context) {
		throw new common.exceptions.SilverInternalError("Production edu:umn:cs:melt:ableC:abstractsyntax:host:comment erroneously claimed to forward");
	}
	...
	public String getName() {
		return "edu:umn:cs:melt:ableC:abstractsyntax:host:comment";
	}

	static void initProductionAttributeDefinitions() {
		// top.host = edu:umn:cs:melt:ableC:abstractsyntax:host:comment(, s,, location=top.location)
		edu.umn.cs.melt.ableC.abstractsyntax.host.Pcomment.synthesizedAttributes[edu.umn.cs.melt.ableC.abstractsyntax.host.Init.edu_umn_cs_melt_ableC_abstractsyntax_host_host__ON__edu_umn_cs_melt_ableC_abstractsyntax_host_Expr] = new common.Lazy() { public final Object eval(final common.DecoratedNode context) { return ((edu.umn.cs.melt.ableC.abstractsyntax.host.NExpr)new edu.umn.cs.melt.ableC.abstractsyntax.host.Pcomment(context.childAsIsLazy(edu.umn.cs.melt.ableC.abstractsyntax.host.Pcomment.i_s), new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((core.NLocation)((edu.umn.cs.melt.ableC.abstractsyntax.host.NExpr)context.undecorate()).getAnno_core_location()); } })); } };
		// top.lifted = edu:umn:cs:melt:ableC:abstractsyntax:host:comment(, s,, location=top.location)
		...
		// top.errors := []
		if(edu.umn.cs.melt.ableC.abstractsyntax.host.Pcomment.synthesizedAttributes[edu.umn.cs.melt.ableC.abstractsyntax.host.Init.silver_langutil_errors__ON__edu_umn_cs_melt_ableC_abstractsyntax_host_Expr] == null)
		...
		// top.globalDecls := []
		if(edu.umn.cs.melt.ableC.abstractsyntax.host.Pcomment.synthesizedAttributes[edu.umn.cs.melt.ableC.abstractsyntax.host.Init.edu_umn_cs_melt_ableC_abstractsyntax_host_globalDecls__ON__edu_umn_cs_melt_ableC_abstractsyntax_host_Expr] == null)
		...
		// top.defs := []
		if(edu.umn.cs.melt.ableC.abstractsyntax.host.Pcomment.synthesizedAttributes[edu.umn.cs.melt.ableC.abstractsyntax.host.Init.edu_umn_cs_melt_ableC_abstractsyntax_env_defs__ON__edu_umn_cs_melt_ableC_abstractsyntax_host_Expr] == null)
	...
	public static final common.NodeFactory<Pcomment> factory = new Factory();

	public static final class Factory extends common.NodeFactory<Pcomment> {

		@Override
		public Pcomment invoke(final Object[] children, final Object[] annotations) {
			return new Pcomment(children[0], annotations[0]);
		}
	};
