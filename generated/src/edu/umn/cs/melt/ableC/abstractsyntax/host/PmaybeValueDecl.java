...
public final class PmaybeValueDecl extends edu.umn.cs.melt.ableC.abstractsyntax.host.NDecl {
	...
	public static final int num_local_attrs = Init.count_local__ON__edu_umn_cs_melt_ableC_abstractsyntax_host_maybeValueDecl;
	...
	public PmaybeValueDecl(final Object c_name, final Object c_decl) {
		super();
  ...
  public final Boolean invoke(final Object[] args, final Object[] namedArgs) {
	...
	public String getName() {
		return "edu:umn:cs:melt:ableC:abstractsyntax:host:maybeValueDecl";
	}

	static void initProductionAttributeDefinitions() {
		// top.pp = cat(silver:langutil:pp:cat(silver:langutil:pp:text("maybeValue (",), silver:langutil:pp:cat(text(name,), silver:langutil:pp:text(") ",),),), braces(decl.pp,),)
		edu.umn.cs.melt.ableC.abstractsyntax.host.PmaybeValueDecl.synthesizedAttributes[edu.umn.cs.melt.ableC.abstractsyntax.host.Init.silver_langutil_pp__ON__edu_umn_cs_melt_ableC_abstractsyntax_host_Decl] = new common.Lazy() { public final Object eval(final common.DecoratedNode context) { return ((silver.langutil.pp.NDocument)new silver.langutil.pp.Pcat(new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((silver.langutil.pp.NDocument)new silver.langutil.pp.Pcat(new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((silver.langutil.pp.NDocument)new silver.langutil.pp.Ptext((new common.StringCatter("maybeValue (")))); } }, new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((silver.langutil.pp.NDocument)new silver.langutil.pp.Pcat(new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((silver.langutil.pp.NDocument)new silver.langutil.pp.Ptext(context.childAsIsLazy(edu.umn.cs.melt.ableC.abstractsyntax.host.PmaybeValueDecl.i_name))); } }, new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((silver.langutil.pp.NDocument)new silver.langutil.pp.Ptext((new common.StringCatter(") ")))); } })); } })); } }, new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((silver.langutil.pp.NDocument)silver.langutil.pp.Pbraces.invoke(context.childDecoratedSynthesizedLazy(edu.umn.cs.melt.ableC.abstractsyntax.host.PmaybeValueDecl.i_decl, edu.umn.cs.melt.ableC.abstractsyntax.host.Init.silver_langutil_pp__ON__edu_umn_cs_melt_ableC_abstractsyntax_host_Decl))); } })); } };

	}

	public static final common.NodeFactory<PmaybeValueDecl> factory = new Factory();

	public static final class Factory extends common.NodeFactory<PmaybeValueDecl> {

		@Override
		public PmaybeValueDecl invoke(final Object[] children, final Object[] annotations) {
			return new PmaybeValueDecl(children[0], children[1]);
		}
	};
