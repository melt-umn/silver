...
public final class PqualifiedExpr extends edu.umn.cs.melt.ableC.abstractsyntax.host.NExpr {

	public static final int i_q = 0;
	public static final int i_e = 1;


	public static final Class<?> childTypes[] = {edu.umn.cs.melt.ableC.abstractsyntax.host.NQualifiers.class,edu.umn.cs.melt.ableC.abstractsyntax.host.NExpr.class};

	public static final int num_local_attrs = Init.count_local__ON__edu_umn_cs_melt_ableC_abstractsyntax_host_qualifiedExpr;
	...
	public PqualifiedExpr(final Object c_q, final Object c_e, final Object a_core_location) {
	...
	public common.Node evalForward(final common.DecoratedNode context) {
		throw new common.exceptions.SilverInternalError("Production edu:umn:cs:melt:ableC:abstractsyntax:host:qualifiedExpr erroneously claimed to forward");
	}
	...
	static void initProductionAttributeDefinitions() {
		...
		if(edu.umn.cs.melt.ableC.abstractsyntax.host.PqualifiedExpr.synthesizedAttributes[edu.umn.cs.melt.ableC.abstractsyntax.host.Init.edu_umn_cs_melt_ableC_abstractsyntax_host_globalDecls__ON__edu_umn_cs_melt_ableC_abstractsyntax_host_Expr] == null)
		...
		// top.defs := e.defs
		if(edu.umn.cs.melt.ableC.abstractsyntax.host.PqualifiedExpr.synthesizedAttributes[edu.umn.cs.melt.ableC.abstractsyntax.host.Init.edu_umn_cs_melt_ableC_abstractsyntax_env_defs__ON__edu_umn_cs_melt_ableC_abstractsyntax_host_Expr] == null)
	...
	public static final common.NodeFactory<PqualifiedExpr> factory = new Factory();

	public static final class Factory extends common.NodeFactory<PqualifiedExpr> {

		@Override
		public PqualifiedExpr invoke(final Object[] children, final Object[] annotations) {
			return new PqualifiedExpr(children[0], children[1], annotations[0]);
		}
	};
