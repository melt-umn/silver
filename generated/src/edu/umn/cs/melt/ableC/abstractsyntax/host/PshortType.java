...
// top::IntegerType ::= 
public final class PshortType extends edu.umn.cs.melt.ableC.abstractsyntax.host.NIntegerType {



	public static final Class<?> childTypes[] = {};

	public static final int num_local_attrs = Init.count_local__ON__edu_umn_cs_melt_ableC_abstractsyntax_host_shortType;
	...
	public common.Node evalForward(final common.DecoratedNode context) {
		throw new common.exceptions.SilverInternalError("Production edu:umn:cs:melt:ableC:abstractsyntax:host:shortType erroneously claimed to forward");
	}
	...
	public static final common.NodeFactory<PshortType> factory = new Factory();

	public static final class Factory extends common.NodeFactory<PshortType> {

		@Override
		public PshortType invoke(final Object[] children, final Object[] annotations) {
			return new PshortType();
		}
	};
