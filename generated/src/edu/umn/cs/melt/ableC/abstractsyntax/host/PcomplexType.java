...
public final class PcomplexType extends edu.umn.cs.melt.ableC.abstractsyntax.host.NBuiltinType {
	...
	public static final int num_local_attrs = Init.count_local__ON__edu_umn_cs_melt_ableC_abstractsyntax_host_complexType;
	...
	public PcomplexType(final Object c_rt) {
		super();
		this.child_rt = c_rt;
	...
	public common.Node evalForward(final common.DecoratedNode context) {
		throw new common.exceptions.SilverInternalError("Production edu:umn:cs:melt:ableC:abstractsyntax:host:complexType erroneously claimed to forward");
	}
	...
	static void initProductionAttributeDefinitions() {
		...
		edu.umn.cs.melt.ableC.abstractsyntax.host.PcomplexType.synthesizedAttributes[edu.umn.cs.melt.ableC.abstractsyntax.host.Init.edu_umn_cs_melt_ableC_abstractsyntax_host_mangledName__ON__edu_umn_cs_melt_ableC_abstractsyntax_host_BuiltinType] = new common.Lazy() { public final Object eval(final common.DecoratedNode context) { return new common.StringCatter((common.StringCatter)(new common.StringCatter("complex_")), (common.StringCatter)((common.StringCatter)context.childDecorated(edu.umn.cs.melt.ableC.abstractsyntax.host.PcomplexType.i_rt).synthesized(edu.umn.cs.melt.ableC.abstractsyntax.host.Init.edu_umn_cs_melt_ableC_abstractsyntax_host_mangledName__ON__edu_umn_cs_melt_ableC_abstractsyntax_host_RealType))); } };
...
return new common.PatternLazy<common.DecoratedNode, edu.umn.cs.melt.ableC.abstractsyntax.host.NRealType>() { public final edu.umn.cs.melt.ableC.abstractsyntax.host.NRealType eval(final common.DecoratedNode context, common.DecoratedNode scrutineeIter) {while(true) {final common.DecoratedNode scrutinee = scrutineeIter; final common.Node scrutineeNode = scrutinee.undecorate(); if(scrutineeNode instanceof edu.umn.cs.melt.ableC.abstractsyntax.host.PfloatType) {  return (edu.umn.cs.melt.ableC.abstractsyntax.host.NRealType)((edu.umn.cs.melt.ableC.abstractsyntax.host.NRealType)new edu.umn.cs.melt.ableC.abstractsyntax.host.PdoubleType()); }if(!scrutineeIter.undecorate().hasForward()) break;scrutineeIter = scrutineeIter.forward();}return ((edu.umn.cs.melt.ableC.abstractsyntax.host.NRealType)(__SV_LOCAL_6303___fail_6304.eval()));}}.eval(context, (common.DecoratedNode)context.childDecorated(edu.umn.cs.melt.ableC.abstractsyntax.host.PcomplexType.i_rt)); } })); } };
	...
	public static final common.NodeFactory<PcomplexType> factory = new Factory();

	public static final class Factory extends common.NodeFactory<PcomplexType> {

		@Override
		public PcomplexType invoke(final Object[] children, final Object[] annotations) {
			return new PcomplexType(children[0]);
		}
	};
