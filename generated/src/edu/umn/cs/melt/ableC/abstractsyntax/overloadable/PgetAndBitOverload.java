...
public final class PgetAndBitOverload extends common.FunctionNode {
	...
	public static final int num_local_attrs = Init.count_local__ON__edu_umn_cs_melt_ableC_abstractsyntax_overloadable_getAndBitOverload;
	...
	public PgetAndBitOverload(final Object c_l, final Object c_r, final Object c_env) {
		this.child_l = c_l;
		this.child_r = c_r;
	...
	public String getName() {
		return "edu:umn:cs:melt:ableC:abstractsyntax:overloadable:getAndBitOverload";
	}

	public static core.NMaybe invoke(final Object c_l, final Object c_r, final Object c_env) {
		try {
		final common.DecoratedNode context = new PgetAndBitOverload(c_l, c_r, c_env).decorate();
		//getBinaryOverload(l, r, env, overloads, lOverloads, rOverloads,)
		return (core.NMaybe)(((core.NMaybe)edu.umn.cs.melt.ableC.abstractsyntax.overloadable.PgetBinaryOverload.invoke(common.Thunk.transformUndecorate(context.childDecoratedLazy(edu.umn.cs.melt.ableC.abstractsyntax.overloadable.PgetAndBitOverload.i_l)), common.Thunk.transformUndecorate(context.childDecoratedLazy(edu.umn.cs.melt.ableC.abstractsyntax.overloadable.PgetAndBitOverload.i_r)), context.childAsIsLazy(edu.umn.cs.melt.ableC.abstractsyntax.overloadable.PgetAndBitOverload.i_env), context.localAsIsLazy(edu.umn.cs.melt.ableC.abstractsyntax.overloadable.Init.overloads__ON__edu_umn_cs_melt_ableC_abstractsyntax_overloadable_getAndBitOverload), context.localAsIsLazy(edu.umn.cs.melt.ableC.abstractsyntax.overloadable.Init.lOverloads__ON__edu_umn_cs_melt_ableC_abstractsyntax_overloadable_getAndBitOverload), context.localAsIsLazy(edu.umn.cs.melt.ableC.abstractsyntax.overloadable.Init.rOverloads__ON__edu_umn_cs_melt_ableC_abstractsyntax_overloadable_getAndBitOverload))));

		} catch(Throwable t) {
			throw new common.exceptions.TraceException("Error while evaluating function edu:umn:cs:melt:ableC:abstractsyntax:overloadable:getAndBitOverload", t);
		}
	}
	...
	public static final class Factory extends common.NodeFactory<core.NMaybe> {
		...
		public core.NMaybe invoke(final Object[] children, final Object[] namedNotApplicable) {
			return PgetAndBitOverload.invoke(children[0], children[1], children[2]);
		}
	};
}