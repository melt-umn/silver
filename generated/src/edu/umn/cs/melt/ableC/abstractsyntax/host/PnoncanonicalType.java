...
public final class PnoncanonicalType extends edu.umn.cs.melt.ableC.abstractsyntax.host.NType {

	public static final int i_sub = 0;


	public static final Class<?> childTypes[] = {edu.umn.cs.melt.ableC.abstractsyntax.host.NNoncanonicalType.class};

	public static final int num_local_attrs = Init.count_local__ON__edu_umn_cs_melt_ableC_abstractsyntax_host_noncanonicalType;
	...
	static {
	childInheritedAttributes[i_sub] = new common.Lazy[edu.umn.cs.melt.ableC.abstractsyntax.host.NNoncanonicalType.num_inh_attrs];
	...
	public final edu.umn.cs.melt.ableC.abstractsyntax.host.NNoncanonicalType getChild_sub() {
		return (edu.umn.cs.melt.ableC.abstractsyntax.host.NNoncanonicalType) (child_sub = common.Util.demand(child_sub));
	}
