...
public final class PlhsRuntimeMod extends edu.umn.cs.melt.ableC.abstractsyntax.injectable.NLhsOrRhsRuntimeMod {
	...
	public static final int num_local_attrs = Init.count_local__ON__edu_umn_cs_melt_ableC_abstractsyntax_injectable_lhsRuntimeMod;
	...
	public PlhsRuntimeMod(final Object c_rm) {
		super();
		this.child_rm = c_rm;
	...
	public common.Node evalForward(final common.DecoratedNode context) {
		throw new common.exceptions.SilverInternalError("Production edu:umn:cs:melt:ableC:abstractsyntax:injectable:lhsRuntimeMod erroneously claimed to forward");
	}
