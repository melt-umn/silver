...
// e::Expr ::= txt::String 
public final class PtxtExpr extends edu.umn.cs.melt.ableC.abstractsyntax.host.NExpr {
	...
	public static final int num_local_attrs = Init.count_local__ON__edu_umn_cs_melt_ableC_abstractsyntax_host_txtExpr;
	...
	public PtxtExpr(final Object c_txt, final Object a_core_location) {
	...
	public common.Node evalForward(final common.DecoratedNode context) {
		throw new common.exceptions.SilverInternalError("Production edu:umn:cs:melt:ableC:abstractsyntax:host:txtExpr erroneously claimed to forward");
	}
	...
	public String getName() {
		return "edu:umn:cs:melt:ableC:abstractsyntax:host:txtExpr";
	}

	static void initProductionAttributeDefinitions() {
		// e.host = edu:umn:cs:melt:ableC:abstractsyntax:host:txtExpr(, txt,, location=e.location)
		edu.umn.cs.melt.ableC.abstractsyntax.host.PtxtExpr.synthesizedAttributes[edu.umn.cs.melt.ableC.abstractsyntax.host.Init.edu_umn_cs_melt_ableC_abstractsyntax_host_host__ON__edu_umn_cs_melt_ableC_abstractsyntax_host_Expr] = new common.Lazy() { public final Object eval(final common.DecoratedNode context) { return ((edu.umn.cs.melt.ableC.abstractsyntax.host.NExpr)new edu.umn.cs.melt.ableC.abstractsyntax.host.PtxtExpr(context.childAsIsLazy(edu.umn.cs.melt.ableC.abstractsyntax.host.PtxtExpr.i_txt), new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((core.NLocation)((edu.umn.cs.melt.ableC.abstractsyntax.host.NExpr)context.undecorate()).getAnno_core_location()); } })); } };
		// e.lifted = edu:umn:cs:melt:ableC:abstractsyntax:host:txtExpr(, txt,, location=e.location)
		...
		// e.errors := []
		if(edu.umn.cs.melt.ableC.abstractsyntax.host.PtxtExpr.synthesizedAttributes[edu.umn.cs.melt.ableC.abstractsyntax.host.Init.silver_langutil_errors__ON__edu_umn_cs_melt_ableC_abstractsyntax_host_Expr] == null)
		...
		// e.globalDecls := []
		if(edu.umn.cs.melt.ableC.abstractsyntax.host.PtxtExpr.synthesizedAttributes[edu.umn.cs.melt.ableC.abstractsyntax.host.Init.edu_umn_cs_melt_ableC_abstractsyntax_host_globalDecls__ON__edu_umn_cs_melt_ableC_abstractsyntax_host_Expr] == null)
		...
		// e.defs := []
		if(edu.umn.cs.melt.ableC.abstractsyntax.host.PtxtExpr.synthesizedAttributes[edu.umn.cs.melt.ableC.abstractsyntax.host.Init.edu_umn_cs_melt_ableC_abstractsyntax_env_defs__ON__edu_umn_cs_melt_ableC_abstractsyntax_host_Expr] == null)
	...
	public static final common.NodeFactory<PtxtExpr> factory = new Factory();

	public static final class Factory extends common.NodeFactory<PtxtExpr> {

		@Override
		public PtxtExpr invoke(final Object[] children, final Object[] annotations) {
			return new PtxtExpr(children[0], annotations[0]);
		}
	};
