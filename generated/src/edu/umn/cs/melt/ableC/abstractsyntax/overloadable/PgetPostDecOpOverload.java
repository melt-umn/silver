...
public final class PgetPostDecOpOverload extends common.FunctionNode {
	...
	public static final int num_local_attrs = Init.count_local__ON__edu_umn_cs_melt_ableC_abstractsyntax_overloadable_getPostDecOpOverload;
	...
	public PgetPostDecOpOverload(final Object c_t, final Object c_env) {
		this.child_t = c_t;
	...
	public static final class Factory extends common.NodeFactory<core.NMaybe> {
		...
		public core.NMaybe invoke(final Object[] children, final Object[] namedNotApplicable) {
			return PgetPostDecOpOverload.invoke(children[0], children[1]);
		}
	};
}