...
public final class PexprParser extends common.FunctionNode {
	...
	public static final int num_local_attrs = Init.count_local__ON__edu_umn_cs_melt_ableC_abstractsyntax_construction_parsing_exprParser;
	...
	public PexprParser(final Object c_stringToParse, final Object c_filenameToReport) {
	...
	public String getName() {
		return "edu:umn:cs:melt:ableC:abstractsyntax:construction:parsing:exprParser";
	}

	public static core.NParseResult invoke(final Object c_stringToParse, final Object c_filenameToReport) {
		try {
		return common.Util.callCopperParser(new edu.umn.cs.melt.ableC.abstractsyntax.construction.parsing.Parser_edu_umn_cs_melt_ableC_abstractsyntax_construction_parsing_exprParser(), c_stringToParse, c_filenameToReport);
		} catch(Throwable t) {
			throw new common.exceptions.TraceException("Error while evaluating function edu:umn:cs:melt:ableC:abstractsyntax:construction:parsing:exprParser", t);
		}
	}
	...
	public static final class Factory extends common.NodeFactory<core.NParseResult> {
		...
		public core.NParseResult invoke(final Object[] children, final Object[] namedNotApplicable) {
			return PexprParser.invoke(children[0], children[1]);
		}
	};
}