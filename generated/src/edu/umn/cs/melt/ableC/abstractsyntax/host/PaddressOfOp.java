...
// top::UnaryOp ::= 
public final class PaddressOfOp extends edu.umn.cs.melt.ableC.abstractsyntax.host.NUnaryOp {



	public static final Class<?> childTypes[] = {};

	public static final int num_local_attrs = Init.count_local__ON__edu_umn_cs_melt_ableC_abstractsyntax_host_addressOfOp;
	...
	public PaddressOfOp(final Object a_core_location) {
	...
	public common.Node evalForward(final common.DecoratedNode context) {
		throw new common.exceptions.SilverInternalError("Production edu:umn:cs:melt:ableC:abstractsyntax:host:addressOfOp erroneously claimed to forward");
	}
	...
	public String getName() {
		return "edu:umn:cs:melt:ableC:abstractsyntax:host:addressOfOp";
	}

	static void initProductionAttributeDefinitions() {
		// top.host = edu:umn:cs:melt:ableC:abstractsyntax:host:addressOfOp(,, location=top.location)
		...
		// top.lifted = edu:umn:cs:melt:ableC:abstractsyntax:host:addressOfOp(,, location=top.location)
