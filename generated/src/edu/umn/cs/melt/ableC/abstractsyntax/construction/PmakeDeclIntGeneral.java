...
public final class PmakeDeclIntGeneral extends common.FunctionNode {
	...
	public static final Class<?> childTypes[] = { common.StringCatter.class,edu.umn.cs.melt.ableC.abstractsyntax.host.NMaybeInitializer.class,core.NLocation.class };

	public static final int num_local_attrs = Init.count_local__ON__edu_umn_cs_melt_ableC_abstractsyntax_construction_makeDeclIntGeneral;
	...
	static{
	childInheritedAttributes[i_init] = new common.Lazy[edu.umn.cs.melt.ableC.abstractsyntax.host.NMaybeInitializer.num_inh_attrs];
	childInheritedAttributes[i_l] = new common.Lazy[core.NLocation.num_inh_attrs];

	}

	public PmakeDeclIntGeneral(final Object c_n, final Object c_init, final Object c_l) {
		this.child_n = c_n;
	...
	public final edu.umn.cs.melt.ableC.abstractsyntax.host.NMaybeInitializer getChild_init() {
		return (edu.umn.cs.melt.ableC.abstractsyntax.host.NMaybeInitializer) (child_init = common.Util.demand(child_init));
	}
	...
	public static final class Factory extends common.NodeFactory<edu.umn.cs.melt.ableC.abstractsyntax.host.NDecl> {
		...
		public edu.umn.cs.melt.ableC.abstractsyntax.host.NDecl invoke(final Object[] children, final Object[] namedNotApplicable) {
			return PmakeDeclIntGeneral.invoke(children[0], children[1], children[2]);
		}
	};
}