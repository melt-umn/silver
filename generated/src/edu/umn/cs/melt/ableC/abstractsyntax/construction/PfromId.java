...
public final class PfromId extends common.FunctionNode {
	...
	public static final int num_local_attrs = Init.count_local__ON__edu_umn_cs_melt_ableC_abstractsyntax_construction_fromId;
	...
	public String getName() {
		return "edu:umn:cs:melt:ableC:abstractsyntax:construction:fromId";
	}
	...
	public static edu.umn.cs.melt.ableC.abstractsyntax.host.NName invoke(final Object c_n) {
		...
		return (edu.umn.cs.melt.ableC.abstractsyntax.host.NName)(((edu.umn.cs.melt.ableC.abstractsyntax.host.NName)new edu.umn.cs.melt.ableC.abstractsyntax.host.Pname(((common.StringCatter)((edu.umn.cs.melt.ableC.concretesyntax.TIdentifier_t)context.childAsIs(edu.umn.cs.melt.ableC.abstractsyntax.construction.PfromId.i_n)).lexeme), ((core.NLocation)((edu.umn.cs.melt.ableC.concretesyntax.TIdentifier_t)context.childAsIs(edu.umn.cs.melt.ableC.abstractsyntax.construction.PfromId.i_n)).location))));

		} catch(Throwable t) {
			throw new common.exceptions.TraceException("Error while evaluating function edu:umn:cs:melt:ableC:abstractsyntax:construction:fromId", t);
		}
	}
