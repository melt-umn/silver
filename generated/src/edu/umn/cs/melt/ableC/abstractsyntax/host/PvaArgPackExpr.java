...
// top::Expr ::= 
public final class PvaArgPackExpr extends edu.umn.cs.melt.ableC.abstractsyntax.host.NExpr {



	public static final Class<?> childTypes[] = {};

	public static final int num_local_attrs = Init.count_local__ON__edu_umn_cs_melt_ableC_abstractsyntax_host_vaArgPackExpr;
	...
	public PvaArgPackExpr(final Object a_core_location) {
	...
	public common.Node evalForward(final common.DecoratedNode context) {
		throw new common.exceptions.SilverInternalError("Production edu:umn:cs:melt:ableC:abstractsyntax:host:vaArgPackExpr erroneously claimed to forward");
	}
	...
	public String getName() {
		return "edu:umn:cs:melt:ableC:abstractsyntax:host:vaArgPackExpr";
	}

	static void initProductionAttributeDefinitions() {
		// top.host = edu:umn:cs:melt:ableC:abstractsyntax:host:vaArgPackExpr(,, location=top.location)
		...
		// top.lifted = edu:umn:cs:melt:ableC:abstractsyntax:host:vaArgPackExpr(,, location=top.location)
		...
		edu.umn.cs.melt.ableC.abstractsyntax.host.PvaArgPackExpr.synthesizedAttributes[edu.umn.cs.melt.ableC.abstractsyntax.host.Init.silver_langutil_pp__ON__edu_umn_cs_melt_ableC_abstractsyntax_host_Expr] = new common.Lazy() { public final Object eval(final common.DecoratedNode context) { return ((silver.langutil.pp.NDocument)new silver.langutil.pp.Ptext((new common.StringCatter("__builtin_va_arg_pack()")))); } };
		// top.errors := []
		if(edu.umn.cs.melt.ableC.abstractsyntax.host.PvaArgPackExpr.synthesizedAttributes[edu.umn.cs.melt.ableC.abstractsyntax.host.Init.silver_langutil_errors__ON__edu_umn_cs_melt_ableC_abstractsyntax_host_Expr] == null)
		...
		// top.globalDecls := []
		if(edu.umn.cs.melt.ableC.abstractsyntax.host.PvaArgPackExpr.synthesizedAttributes[edu.umn.cs.melt.ableC.abstractsyntax.host.Init.edu_umn_cs_melt_ableC_abstractsyntax_host_globalDecls__ON__edu_umn_cs_melt_ableC_abstractsyntax_host_Expr] == null)
		...
		// top.defs := []
		if(edu.umn.cs.melt.ableC.abstractsyntax.host.PvaArgPackExpr.synthesizedAttributes[edu.umn.cs.melt.ableC.abstractsyntax.host.Init.edu_umn_cs_melt_ableC_abstractsyntax_env_defs__ON__edu_umn_cs_melt_ableC_abstractsyntax_host_Expr] == null)
	...
	public static final common.NodeFactory<PvaArgPackExpr> factory = new Factory();

	public static final class Factory extends common.NodeFactory<PvaArgPackExpr> {

		@Override
		public PvaArgPackExpr invoke(final Object[] children, final Object[] annotations) {
			return new PvaArgPackExpr(annotations[0]);
		}
	};
