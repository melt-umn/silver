...
public final class PgetAddressOfOpOverload extends common.FunctionNode {
	...
	public static final int num_local_attrs = Init.count_local__ON__edu_umn_cs_melt_ableC_abstractsyntax_overloadable_getAddressOfOpOverload;
	...
	public PgetAddressOfOpOverload(final Object c_t, final Object c_env) {
		this.child_t = c_t;
	...
	public String getName() {
		return "edu:umn:cs:melt:ableC:abstractsyntax:overloadable:getAddressOfOpOverload";
	}

	public static core.NMaybe invoke(final Object c_t, final Object c_env) {
		try {
		final common.DecoratedNode context = new PgetAddressOfOpOverload(c_t, c_env).decorate();
		//getUnaryOverload(t, env, overloads,)
		return (core.NMaybe)(((core.NMaybe)edu.umn.cs.melt.ableC.abstractsyntax.overloadable.PgetUnaryOverload.invoke(common.Thunk.transformUndecorate(context.childDecoratedLazy(edu.umn.cs.melt.ableC.abstractsyntax.overloadable.PgetAddressOfOpOverload.i_t)), context.childAsIsLazy(edu.umn.cs.melt.ableC.abstractsyntax.overloadable.PgetAddressOfOpOverload.i_env), context.localAsIsLazy(edu.umn.cs.melt.ableC.abstractsyntax.overloadable.Init.overloads__ON__edu_umn_cs_melt_ableC_abstractsyntax_overloadable_getAddressOfOpOverload))));

		} catch(Throwable t) {
			throw new common.exceptions.TraceException("Error while evaluating function edu:umn:cs:melt:ableC:abstractsyntax:overloadable:getAddressOfOpOverload", t);
		}
	}
	...
	public static final class Factory extends common.NodeFactory<core.NMaybe> {
		...
		public core.NMaybe invoke(final Object[] children, final Object[] namedNotApplicable) {
			return PgetAddressOfOpOverload.invoke(children[0], children[1]);
		}
	};
}