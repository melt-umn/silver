...
public final class PlookupMisc extends common.FunctionNode {
	...
	public static final int num_local_attrs = Init.count_local__ON__edu_umn_cs_melt_ableC_abstractsyntax_env_lookupMisc;
	...
	public PlookupMisc(final Object c_n, final Object c_e) {
		this.child_n = c_n;
		this.child_e = c_e;
	...
	public String getName() {
		return "edu:umn:cs:melt:ableC:abstractsyntax:env:lookupMisc";
	}

	public static common.ConsCell invoke(final Object c_n, final Object c_e) {
		try {
		final common.DecoratedNode context = new PlookupMisc(c_n, c_e).decorate();
		//readScope_i(n, e.misc,)
		return (common.ConsCell)(((common.ConsCell)edu.umn.cs.melt.ableC.abstractsyntax.env.PreadScope_i.invoke(context.childAsIsLazy(edu.umn.cs.melt.ableC.abstractsyntax.env.PlookupMisc.i_n), context.childAsIsSynthesizedLazy(edu.umn.cs.melt.ableC.abstractsyntax.env.PlookupMisc.i_e, edu.umn.cs.melt.ableC.abstractsyntax.env.Init.edu_umn_cs_melt_ableC_abstractsyntax_env_misc__ON__edu_umn_cs_melt_ableC_abstractsyntax_env_Env))));

		} catch(Throwable t) {
			throw new common.exceptions.TraceException("Error while evaluating function edu:umn:cs:melt:ableC:abstractsyntax:env:lookupMisc", t);
		}
	}
	...
	public static final class Factory extends common.NodeFactory<common.ConsCell> {
		...
		public common.ConsCell invoke(final Object[] children, final Object[] namedNotApplicable) {
			return PlookupMisc.invoke(children[0], children[1]);
		}
	};
}