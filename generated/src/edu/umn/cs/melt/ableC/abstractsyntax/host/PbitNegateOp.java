...
// top::UnaryOp ::= 
public final class PbitNegateOp extends edu.umn.cs.melt.ableC.abstractsyntax.host.NUnaryOp {



	public static final Class<?> childTypes[] = {};

	public static final int num_local_attrs = Init.count_local__ON__edu_umn_cs_melt_ableC_abstractsyntax_host_bitNegateOp;
	...
	public PbitNegateOp(final Object a_core_location) {
	...
	public common.Node evalForward(final common.DecoratedNode context) {
		throw new common.exceptions.SilverInternalError("Production edu:umn:cs:melt:ableC:abstractsyntax:host:bitNegateOp erroneously claimed to forward");
	}
	...
	public String getName() {
		return "edu:umn:cs:melt:ableC:abstractsyntax:host:bitNegateOp";
	}

	static void initProductionAttributeDefinitions() {
		// top.host = edu:umn:cs:melt:ableC:abstractsyntax:host:bitNegateOp(,, location=top.location)
		edu.umn.cs.melt.ableC.abstractsyntax.host.PbitNegateOp.synthesizedAttributes[edu.umn.cs.melt.ableC.abstractsyntax.host.Init.edu_umn_cs_melt_ableC_abstractsyntax_host_host__ON__edu_umn_cs_melt_ableC_abstractsyntax_host_UnaryOp] = new common.Lazy() { public final Object eval(final common.DecoratedNode context) { return ((edu.umn.cs.melt.ableC.abstractsyntax.host.NUnaryOp)new edu.umn.cs.melt.ableC.abstractsyntax.host.PbitNegateOp(new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((core.NLocation)((edu.umn.cs.melt.ableC.abstractsyntax.host.NUnaryOp)context.undecorate()).getAnno_core_location()); } })); } };
		// top.lifted = edu:umn:cs:melt:ableC:abstractsyntax:host:bitNegateOp(,, location=top.location)
		...
		if(edu.umn.cs.melt.ableC.abstractsyntax.host.PbitNegateOp.synthesizedAttributes[edu.umn.cs.melt.ableC.abstractsyntax.host.Init.edu_umn_cs_melt_ableC_abstractsyntax_host_injectedQualifiers__ON__edu_umn_cs_melt_ableC_abstractsyntax_host_UnaryOp] == null)
		...
		// top.errors := []
		if(edu.umn.cs.melt.ableC.abstractsyntax.host.PbitNegateOp.synthesizedAttributes[edu.umn.cs.melt.ableC.abstractsyntax.host.Init.silver_langutil_errors__ON__edu_umn_cs_melt_ableC_abstractsyntax_host_UnaryOp] == null)
			edu.umn.cs.melt.ableC.abstractsyntax.host.PbitNegateOp.synthesizedAttributes[edu.umn.cs.melt.ableC.abstractsyntax.host.Init.silver_langutil_errors__ON__edu_umn_cs_melt_ableC_abstractsyntax_host_UnaryOp] = new silver.langutil.CAerrors(edu.umn.cs.melt.ableC.abstractsyntax.host.Init.silver_langutil_errors__ON__edu_umn_cs_melt_ableC_abstractsyntax_host_UnaryOp);
		((common.CollectionAttribute)edu.umn.cs.melt.ableC.abstractsyntax.host.PbitNegateOp.synthesizedAttributes[edu.umn.cs.melt.ableC.abstractsyntax.host.Init.silver_langutil_errors__ON__edu_umn_cs_melt_ableC_abstractsyntax_host_UnaryOp]).setBase(new common.Lazy() { public final Object eval(final common.DecoratedNode context) { return ((common.ConsCell)core.Pnil.invoke()); } });

	}

	public static final common.NodeFactory<PbitNegateOp> factory = new Factory();

	public static final class Factory extends common.NodeFactory<PbitNegateOp> {

		@Override
		public PbitNegateOp invoke(final Object[] children, final Object[] annotations) {
			return new PbitNegateOp(annotations[0]);
		}
	};
