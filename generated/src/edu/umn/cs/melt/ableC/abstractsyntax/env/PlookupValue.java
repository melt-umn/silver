...
public final class PlookupValue extends common.FunctionNode {
	...
	public static final int num_local_attrs = Init.count_local__ON__edu_umn_cs_melt_ableC_abstractsyntax_env_lookupValue;
	...
	public PlookupValue(final Object c_n, final Object c_e) {
		this.child_n = c_n;
		this.child_e = c_e;
	...
	public String getName() {
		return "edu:umn:cs:melt:ableC:abstractsyntax:env:lookupValue";
	}

	public static common.ConsCell invoke(final Object c_n, final Object c_e) {
		try {
		final common.DecoratedNode context = new PlookupValue(c_n, c_e).decorate();
		//readScope_i(n, e.values,)
		return (common.ConsCell)(((common.ConsCell)edu.umn.cs.melt.ableC.abstractsyntax.env.PreadScope_i.invoke(context.childAsIsLazy(edu.umn.cs.melt.ableC.abstractsyntax.env.PlookupValue.i_n), context.childAsIsSynthesizedLazy(edu.umn.cs.melt.ableC.abstractsyntax.env.PlookupValue.i_e, edu.umn.cs.melt.ableC.abstractsyntax.env.Init.edu_umn_cs_melt_ableC_abstractsyntax_env_values__ON__edu_umn_cs_melt_ableC_abstractsyntax_env_Env))));

		} catch(Throwable t) {
			throw new common.exceptions.TraceException("Error while evaluating function edu:umn:cs:melt:ableC:abstractsyntax:env:lookupValue", t);
		}
	}
	...
	public static final class Factory extends common.NodeFactory<common.ConsCell> {
		...
		public common.ConsCell invoke(final Object[] children, final Object[] namedNotApplicable) {
			return PlookupValue.invoke(children[0], children[1]);
		}
	};
}