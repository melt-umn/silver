...
public final class PfieldValueItem extends edu.umn.cs.melt.ableC.abstractsyntax.env.NValueItem {
	...
	public static final int num_local_attrs = Init.count_local__ON__edu_umn_cs_melt_ableC_abstractsyntax_env_fieldValueItem;
	...
	public PfieldValueItem(final Object c_s) {
		super();
		this.child_s = c_s;
	...
	public common.Node evalForward(final common.DecoratedNode context) {
		throw new common.exceptions.SilverInternalError("Production edu:umn:cs:melt:ableC:abstractsyntax:env:fieldValueItem erroneously claimed to forward");
	}
	...
	public String getName() {
		return "edu:umn:cs:melt:ableC:abstractsyntax:env:fieldValueItem";
	}
	...
	public static final common.NodeFactory<PfieldValueItem> factory = new Factory();

	public static final class Factory extends common.NodeFactory<PfieldValueItem> {

		@Override
		public PfieldValueItem invoke(final Object[] children, final Object[] annotations) {
			return new PfieldValueItem(children[0]);
		}
	};
