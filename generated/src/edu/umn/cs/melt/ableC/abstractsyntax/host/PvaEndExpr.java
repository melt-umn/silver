...
public final class PvaEndExpr extends edu.umn.cs.melt.ableC.abstractsyntax.host.NExpr {

	public static final int i_valist = 0;


	public static final Class<?> childTypes[] = {edu.umn.cs.melt.ableC.abstractsyntax.host.NName.class};

	public static final int num_local_attrs = Init.count_local__ON__edu_umn_cs_melt_ableC_abstractsyntax_host_vaEndExpr;
	...
	public PvaEndExpr(final Object c_valist, final Object a_core_location) {
	...
	public common.Node evalForward(final common.DecoratedNode context) {
		throw new common.exceptions.SilverInternalError("Production edu:umn:cs:melt:ableC:abstractsyntax:host:vaEndExpr erroneously claimed to forward");
	}
	...
	static void initProductionAttributeDefinitions() {
		...
		// top.globalDecls := []
		if(edu.umn.cs.melt.ableC.abstractsyntax.host.PvaEndExpr.synthesizedAttributes[edu.umn.cs.melt.ableC.abstractsyntax.host.Init.edu_umn_cs_melt_ableC_abstractsyntax_host_globalDecls__ON__edu_umn_cs_melt_ableC_abstractsyntax_host_Expr] == null)
		...
		// top.defs := []
		if(edu.umn.cs.melt.ableC.abstractsyntax.host.PvaEndExpr.synthesizedAttributes[edu.umn.cs.melt.ableC.abstractsyntax.host.Init.edu_umn_cs_melt_ableC_abstractsyntax_env_defs__ON__edu_umn_cs_melt_ableC_abstractsyntax_host_Expr] == null)
	...
	public static final common.NodeFactory<PvaEndExpr> factory = new Factory();

	public static final class Factory extends common.NodeFactory<PvaEndExpr> {

		@Override
		public PvaEndExpr invoke(final Object[] children, final Object[] annotations) {
			return new PvaEndExpr(children[0], annotations[0]);
		}
	};
