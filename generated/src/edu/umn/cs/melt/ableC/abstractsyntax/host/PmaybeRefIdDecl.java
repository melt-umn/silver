...
public final class PmaybeRefIdDecl extends edu.umn.cs.melt.ableC.abstractsyntax.host.NDecl {
	...
	public static final int num_local_attrs = Init.count_local__ON__edu_umn_cs_melt_ableC_abstractsyntax_host_maybeRefIdDecl;
	...
	public PmaybeRefIdDecl(final Object c_name, final Object c_decl) {
		super();
  ...
  public final Boolean invoke(final Object[] args, final Object[] namedArgs) {
    final Object __SV_LAMBDA_PARAM_5282_env = args[0];

    return ((Boolean)core.Pnull.invoke(new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((common.ConsCell)edu.umn.cs.melt.ableC.abstractsyntax.env.PlookupRefId.invoke(context.childAsIsLazy(edu.umn.cs.melt.ableC.abstractsyntax.host.PmaybeRefIdDecl.i_name), context.contextInheritedLazy(edu.umn.cs.melt.ableC.abstractsyntax.host.Init.edu_umn_cs_melt_ableC_abstractsyntax_env_env__ON__edu_umn_cs_melt_ableC_abstractsyntax_host_Decl))); } }));
  }
}), common.Thunk.transformUndecorate(context.childDecoratedLazy(edu.umn.cs.melt.ableC.abstractsyntax.host.PmaybeRefIdDecl.i_decl))));
	}
	...
	public String getName() {
		return "edu:umn:cs:melt:ableC:abstractsyntax:host:maybeRefIdDecl";
	}

	static void initProductionAttributeDefinitions() {
		// top.pp = cat(silver:langutil:pp:cat(silver:langutil:pp:text("maybeRefId (",), silver:langutil:pp:cat(text(name,), silver:langutil:pp:text(") ",),),), braces(decl.pp,),)
		edu.umn.cs.melt.ableC.abstractsyntax.host.PmaybeRefIdDecl.synthesizedAttributes[edu.umn.cs.melt.ableC.abstractsyntax.host.Init.silver_langutil_pp__ON__edu_umn_cs_melt_ableC_abstractsyntax_host_Decl] = new common.Lazy() { public final Object eval(final common.DecoratedNode context) { return ((silver.langutil.pp.NDocument)new silver.langutil.pp.Pcat(new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((silver.langutil.pp.NDocument)new silver.langutil.pp.Pcat(new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((silver.langutil.pp.NDocument)new silver.langutil.pp.Ptext((new common.StringCatter("maybeRefId (")))); } }, new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((silver.langutil.pp.NDocument)new silver.langutil.pp.Pcat(new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((silver.langutil.pp.NDocument)new silver.langutil.pp.Ptext(context.childAsIsLazy(edu.umn.cs.melt.ableC.abstractsyntax.host.PmaybeRefIdDecl.i_name))); } }, new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((silver.langutil.pp.NDocument)new silver.langutil.pp.Ptext((new common.StringCatter(") ")))); } })); } })); } }, new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((silver.langutil.pp.NDocument)silver.langutil.pp.Pbraces.invoke(context.childDecoratedSynthesizedLazy(edu.umn.cs.melt.ableC.abstractsyntax.host.PmaybeRefIdDecl.i_decl, edu.umn.cs.melt.ableC.abstractsyntax.host.Init.silver_langutil_pp__ON__edu_umn_cs_melt_ableC_abstractsyntax_host_Decl))); } })); } };

	}

	public static final common.NodeFactory<PmaybeRefIdDecl> factory = new Factory();

	public static final class Factory extends common.NodeFactory<PmaybeRefIdDecl> {

		@Override
		public PmaybeRefIdDecl invoke(final Object[] children, final Object[] annotations) {
			return new PmaybeRefIdDecl(children[0], children[1]);
		}
	};
