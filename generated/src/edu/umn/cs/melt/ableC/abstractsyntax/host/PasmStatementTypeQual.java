...
public final class PasmStatementTypeQual extends edu.umn.cs.melt.ableC.abstractsyntax.host.NAsmStatement {

	public static final int i_tq = 0;
	public static final int i_arg = 1;


	public static final Class<?> childTypes[] = {edu.umn.cs.melt.ableC.abstractsyntax.host.NQualifier.class,edu.umn.cs.melt.ableC.abstractsyntax.host.NAsmArgument.class};

	public static final int num_local_attrs = Init.count_local__ON__edu_umn_cs_melt_ableC_abstractsyntax_host_asmStatementTypeQual;
	...
	static {
	childInheritedAttributes[i_tq] = new common.Lazy[edu.umn.cs.melt.ableC.abstractsyntax.host.NQualifier.num_inh_attrs];
	childInheritedAttributes[i_arg] = new common.Lazy[edu.umn.cs.melt.ableC.abstractsyntax.host.NAsmArgument.num_inh_attrs];

	}

	public PasmStatementTypeQual(final Object c_tq, final Object c_arg, final Object a_core_location) {
	...
	private Object child_tq;
	public final edu.umn.cs.melt.ableC.abstractsyntax.host.NQualifier getChild_tq() {
		return (edu.umn.cs.melt.ableC.abstractsyntax.host.NQualifier) (child_tq = common.Util.demand(child_tq));
	}
	...
	public common.Node evalForward(final common.DecoratedNode context) {
		throw new common.exceptions.SilverInternalError("Production edu:umn:cs:melt:ableC:abstractsyntax:host:asmStatementTypeQual erroneously claimed to forward");
	}
	...
	public String getName() {
		return "edu:umn:cs:melt:ableC:abstractsyntax:host:asmStatementTypeQual";
	}

	static void initProductionAttributeDefinitions() {
		// a.host = edu:umn:cs:melt:ableC:abstractsyntax:host:asmStatementTypeQual(, tq, arg.host,, location=a.location)
		edu.umn.cs.melt.ableC.abstractsyntax.host.PasmStatementTypeQual.synthesizedAttributes[edu.umn.cs.melt.ableC.abstractsyntax.host.Init.edu_umn_cs_melt_ableC_abstractsyntax_host_host__ON__edu_umn_cs_melt_ableC_abstractsyntax_host_AsmStatement] = new common.Lazy() { public final Object eval(final common.DecoratedNode context) { return ((edu.umn.cs.melt.ableC.abstractsyntax.host.NAsmStatement)new edu.umn.cs.melt.ableC.abstractsyntax.host.PasmStatementTypeQual(common.Thunk.transformUndecorate(context.childDecoratedLazy(edu.umn.cs.melt.ableC.abstractsyntax.host.PasmStatementTypeQual.i_tq)), context.childDecoratedSynthesizedLazy(edu.umn.cs.melt.ableC.abstractsyntax.host.PasmStatementTypeQual.i_arg, edu.umn.cs.melt.ableC.abstractsyntax.host.Init.edu_umn_cs_melt_ableC_abstractsyntax_host_host__ON__edu_umn_cs_melt_ableC_abstractsyntax_host_AsmArgument), new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((core.NLocation)((edu.umn.cs.melt.ableC.abstractsyntax.host.NAsmStatement)context.undecorate()).getAnno_core_location()); } })); } };
		// a.lifted = edu:umn:cs:melt:ableC:abstractsyntax:host:asmStatementTypeQual(, tq, arg.lifted,, location=a.location)
