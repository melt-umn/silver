...
public final class PmkIntDeclExpr extends common.FunctionNode {
	...
	public static final int num_local_attrs = Init.count_local__ON__edu_umn_cs_melt_ableC_abstractsyntax_construction_mkIntDeclExpr;
	...
	static{
	childInheritedAttributes[i_val] = new common.Lazy[edu.umn.cs.melt.ableC.abstractsyntax.host.NExpr.num_inh_attrs];
	childInheritedAttributes[i_l] = new common.Lazy[core.NLocation.num_inh_attrs];

	}

	public PmkIntDeclExpr(final Object c_n, final Object c_val, final Object c_l) {
		this.child_n = c_n;
	...
	public final edu.umn.cs.melt.ableC.abstractsyntax.host.NExpr getChild_val() {
		return (edu.umn.cs.melt.ableC.abstractsyntax.host.NExpr) (child_val = common.Util.demand(child_val));
	}
	...
	public String getName() {
		return "edu:umn:cs:melt:ableC:abstractsyntax:construction:mkIntDeclExpr";
	}
	...
	public static edu.umn.cs.melt.ableC.abstractsyntax.host.NStmt invoke(final Object c_n, final Object c_val, final Object c_l) {
		try {
		final common.DecoratedNode context = new PmkIntDeclExpr(c_n, c_val, c_l).decorate();
		//mkIntDeclGeneral(n, justInitializer(exprInitializer(val,),), l,)
		return (edu.umn.cs.melt.ableC.abstractsyntax.host.NStmt)(((edu.umn.cs.melt.ableC.abstractsyntax.host.NStmt)edu.umn.cs.melt.ableC.abstractsyntax.construction.PmkIntDeclGeneral.invoke(context.childAsIsLazy(edu.umn.cs.melt.ableC.abstractsyntax.construction.PmkIntDeclExpr.i_n), new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((edu.umn.cs.melt.ableC.abstractsyntax.host.NMaybeInitializer)new edu.umn.cs.melt.ableC.abstractsyntax.host.PjustInitializer(new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((edu.umn.cs.melt.ableC.abstractsyntax.host.NInitializer)new edu.umn.cs.melt.ableC.abstractsyntax.host.PexprInitializer(common.Thunk.transformUndecorate(context.childDecoratedLazy(edu.umn.cs.melt.ableC.abstractsyntax.construction.PmkIntDeclExpr.i_val)))); } })); } }, common.Thunk.transformUndecorate(context.childDecoratedLazy(edu.umn.cs.melt.ableC.abstractsyntax.construction.PmkIntDeclExpr.i_l)))));

		} catch(Throwable t) {
			throw new common.exceptions.TraceException("Error while evaluating function edu:umn:cs:melt:ableC:abstractsyntax:construction:mkIntDeclExpr", t);
		}
	}
	...
	public static final class Factory extends common.NodeFactory<edu.umn.cs.melt.ableC.abstractsyntax.host.NStmt> {
		...
		public edu.umn.cs.melt.ableC.abstractsyntax.host.NStmt invoke(final Object[] children, final Object[] namedNotApplicable) {
			return PmkIntDeclExpr.invoke(children[0], children[1], children[2]);
		}
	};
}