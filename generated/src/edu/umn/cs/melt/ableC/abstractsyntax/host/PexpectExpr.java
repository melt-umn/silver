...
public final class PexpectExpr extends edu.umn.cs.melt.ableC.abstractsyntax.host.NExpr {

	public static final int i_eval = 0;
	public static final int i_expected = 1;
	...
	public static final int num_local_attrs = Init.count_local__ON__edu_umn_cs_melt_ableC_abstractsyntax_host_expectExpr;
	...
	static {
	childInheritedAttributes[i_eval] = new common.Lazy[edu.umn.cs.melt.ableC.abstractsyntax.host.NExpr.num_inh_attrs];
	childInheritedAttributes[i_expected] = new common.Lazy[edu.umn.cs.melt.ableC.abstractsyntax.host.NExpr.num_inh_attrs];

	}

	public PexpectExpr(final Object c_eval, final Object c_expected, final Object a_core_location) {
		super(a_core_location);
		this.child_eval = c_eval;
		this.child_expected = c_expected;

	}

	private Object child_eval;
	public final edu.umn.cs.melt.ableC.abstractsyntax.host.NExpr getChild_eval() {
		return (edu.umn.cs.melt.ableC.abstractsyntax.host.NExpr) (child_eval = common.Util.demand(child_eval));
	}

	private Object child_expected;
	public final edu.umn.cs.melt.ableC.abstractsyntax.host.NExpr getChild_expected() {
		return (edu.umn.cs.melt.ableC.abstractsyntax.host.NExpr) (child_expected = common.Util.demand(child_expected));
	}
	...
	public Object getChild(final int index) {
		switch(index) {
			case i_eval: return getChild_eval();
			case i_expected: return getChild_expected();
	...
	public Object getChildLazy(final int index) {
		switch(index) {
			case i_eval: return child_eval;
			case i_expected: return child_expected;
	...
	public common.Node evalForward(final common.DecoratedNode context) {
		throw new common.exceptions.SilverInternalError("Production edu:umn:cs:melt:ableC:abstractsyntax:host:expectExpr erroneously claimed to forward");
	}
	...
	public String getName() {
		return "edu:umn:cs:melt:ableC:abstractsyntax:host:expectExpr";
	}

	static void initProductionAttributeDefinitions() {
		// top.host = edu:umn:cs:melt:ableC:abstractsyntax:host:expectExpr(, eval.host, expected.host,, location=top.location)
		edu.umn.cs.melt.ableC.abstractsyntax.host.PexpectExpr.synthesizedAttributes[edu.umn.cs.melt.ableC.abstractsyntax.host.Init.edu_umn_cs_melt_ableC_abstractsyntax_host_host__ON__edu_umn_cs_melt_ableC_abstractsyntax_host_Expr] = new common.Lazy() { public final Object eval(final common.DecoratedNode context) { return ((edu.umn.cs.melt.ableC.abstractsyntax.host.NExpr)new edu.umn.cs.melt.ableC.abstractsyntax.host.PexpectExpr(context.childDecoratedSynthesizedLazy(edu.umn.cs.melt.ableC.abstractsyntax.host.PexpectExpr.i_eval, edu.umn.cs.melt.ableC.abstractsyntax.host.Init.edu_umn_cs_melt_ableC_abstractsyntax_host_host__ON__edu_umn_cs_melt_ableC_abstractsyntax_host_Expr), context.childDecoratedSynthesizedLazy(edu.umn.cs.melt.ableC.abstractsyntax.host.PexpectExpr.i_expected, edu.umn.cs.melt.ableC.abstractsyntax.host.Init.edu_umn_cs_melt_ableC_abstractsyntax_host_host__ON__edu_umn_cs_melt_ableC_abstractsyntax_host_Expr), new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((core.NLocation)((edu.umn.cs.melt.ableC.abstractsyntax.host.NExpr)context.undecorate()).getAnno_core_location()); } })); } };
		// top.lifted = edu:umn:cs:melt:ableC:abstractsyntax:host:expectExpr(, eval.lifted, expected.lifted,, location=top.location)
		...
		if(edu.umn.cs.melt.ableC.abstractsyntax.host.PexpectExpr.synthesizedAttributes[edu.umn.cs.melt.ableC.abstractsyntax.host.Init.edu_umn_cs_melt_ableC_abstractsyntax_host_globalDecls__ON__edu_umn_cs_melt_ableC_abstractsyntax_host_Expr] == null)
		...
		if(edu.umn.cs.melt.ableC.abstractsyntax.host.PexpectExpr.synthesizedAttributes[edu.umn.cs.melt.ableC.abstractsyntax.host.Init.edu_umn_cs_melt_ableC_abstractsyntax_env_defs__ON__edu_umn_cs_melt_ableC_abstractsyntax_host_Expr] == null)
	...
	public static final common.NodeFactory<PexpectExpr> factory = new Factory();

	public static final class Factory extends common.NodeFactory<PexpectExpr> {

		@Override
		public PexpectExpr invoke(final Object[] children, final Object[] annotations) {
			return new PexpectExpr(children[0], children[1], annotations[0]);
		}
	};
