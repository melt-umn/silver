...
public final class PgetRshEqOverload extends common.FunctionNode {
	...
	public static final int num_local_attrs = Init.count_local__ON__edu_umn_cs_melt_ableC_abstractsyntax_overloadable_getRshEqOverload;
	...
	public PgetRshEqOverload(final Object c_l, final Object c_r, final Object c_env) {
		this.child_l = c_l;
		this.child_r = c_r;
	...
	public static final class Factory extends common.NodeFactory<core.NMaybe> {
		...
		public core.NMaybe invoke(final Object[] children, final Object[] namedNotApplicable) {
			return PgetRshEqOverload.invoke(children[0], children[1], children[2]);
		}
	};
}