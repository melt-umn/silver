...
public final class PmkDecl extends common.FunctionNode {

	public static final int i_n = 0;
	public static final int i_typ = 1;
	public static final int i_v = 2;
	public static final int i_l = 3;


	public static final Class<?> childTypes[] = { common.StringCatter.class,edu.umn.cs.melt.ableC.abstractsyntax.host.NType.class,edu.umn.cs.melt.ableC.abstractsyntax.host.NExpr.class,core.NLocation.class };

	public static final int num_local_attrs = Init.count_local__ON__edu_umn_cs_melt_ableC_abstractsyntax_construction_mkDecl;
	...
	public PmkDecl(final Object c_n, final Object c_typ, final Object c_v, final Object c_l) {
		this.child_n = c_n;
	...
	public static final class Factory extends common.NodeFactory<edu.umn.cs.melt.ableC.abstractsyntax.host.NStmt> {
		...
		public edu.umn.cs.melt.ableC.abstractsyntax.host.NStmt invoke(final Object[] children, final Object[] namedNotApplicable) {
			return PmkDecl.invoke(children[0], children[1], children[2], children[3]);
		}
	};
}