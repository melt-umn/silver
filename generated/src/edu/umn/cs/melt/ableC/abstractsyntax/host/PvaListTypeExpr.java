...
// top::BaseTypeExpr ::= 
public final class PvaListTypeExpr extends edu.umn.cs.melt.ableC.abstractsyntax.host.NBaseTypeExpr {



	public static final Class<?> childTypes[] = {};

	public static final int num_local_attrs = Init.count_local__ON__edu_umn_cs_melt_ableC_abstractsyntax_host_vaListTypeExpr;
	...
	public common.Node evalForward(final common.DecoratedNode context) {
		throw new common.exceptions.SilverInternalError("Production edu:umn:cs:melt:ableC:abstractsyntax:host:vaListTypeExpr erroneously claimed to forward");
	}
	...
	public String getName() {
		return "edu:umn:cs:melt:ableC:abstractsyntax:host:vaListTypeExpr";
	}

	static void initProductionAttributeDefinitions() {
		// top.typerep = pointerType(nilQualifier(,), builtinType(nilQualifier(,), voidType(,),),)
		...
		// top.host = edu:umn:cs:melt:ableC:abstractsyntax:host:vaListTypeExpr(,)
		...
		// top.lifted = edu:umn:cs:melt:ableC:abstractsyntax:host:vaListTypeExpr(,)
		...
		// top.errors := []
		if(edu.umn.cs.melt.ableC.abstractsyntax.host.PvaListTypeExpr.synthesizedAttributes[edu.umn.cs.melt.ableC.abstractsyntax.host.Init.silver_langutil_errors__ON__edu_umn_cs_melt_ableC_abstractsyntax_host_BaseTypeExpr] == null)
		...
		// top.globalDecls := []
		if(edu.umn.cs.melt.ableC.abstractsyntax.host.PvaListTypeExpr.synthesizedAttributes[edu.umn.cs.melt.ableC.abstractsyntax.host.Init.edu_umn_cs_melt_ableC_abstractsyntax_host_globalDecls__ON__edu_umn_cs_melt_ableC_abstractsyntax_host_BaseTypeExpr] == null)
		...
		// top.defs := []
		if(edu.umn.cs.melt.ableC.abstractsyntax.host.PvaListTypeExpr.synthesizedAttributes[edu.umn.cs.melt.ableC.abstractsyntax.host.Init.edu_umn_cs_melt_ableC_abstractsyntax_env_defs__ON__edu_umn_cs_melt_ableC_abstractsyntax_host_BaseTypeExpr] == null)
