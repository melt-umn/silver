...
public final class PincludeFlag extends silver.util.cmdargs.NCmdArgs {
	...
	public static final int num_local_attrs = Init.count_local__ON__silver_driver_includeFlag;
	...
	public PincludeFlag(final Object c_s, final Object c_rest) {
		super();
		this.child_s = c_s;
	...
	public common.Node evalForward(final common.DecoratedNode context) {
		return context.childDecorated(silver.driver.PincludeFlag.i_rest).undecorate();
	}
	...
	public String getName() {
		return "silver:driver:includeFlag";
	}

	static void initProductionAttributeDefinitions() {
		// top.searchPath = (s :: forward.searchPath)
		silver.driver.PincludeFlag.synthesizedAttributes[silver.driver.Init.silver_driver_searchPath__ON__silver_util_cmdargs_CmdArgs] = new common.Lazy() { public final Object eval(final common.DecoratedNode context) { return ((common.ConsCell)core.Pcons.invoke(context.childAsIsLazy(silver.driver.PincludeFlag.i_s), new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((common.ConsCell)context.forward().synthesized(silver.driver.Init.silver_driver_searchPath__ON__silver_util_cmdargs_CmdArgs)); } })); } };
