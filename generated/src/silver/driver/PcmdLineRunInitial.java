...
public final class PcmdLineRunInitial extends common.FunctionNode {
	...
	public static final int num_local_attrs = Init.count_local__ON__silver_driver_cmdLineRunInitial;
	...
	public PcmdLineRunInitial(final Object c_args, final Object c_svParser, final Object c_sviParser, final Object c_ioin) {
	...
	public String getName() {
		return "silver:driver:cmdLineRunInitial";
	}
	...
	public static core.NIOVal invoke(final Object c_args, final Object c_svParser, final Object c_sviParser, final Object c_ioin) {
		try {
		final common.DecoratedNode context = new PcmdLineRunInitial(c_args, c_svParser, c_sviParser, c_ioin).decorate();
		//runChainArg(computeEnv, setupBuildRun(svParser, sviParser, _, _), args, ioin)
		return (core.NIOVal)(((core.NIOVal)silver.driver.PrunChainArg.invoke(silver.driver.PcomputeEnv.factory, new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return silver.driver.PsetupBuildRun.factory.invokePartial(new int[]{0, 1}, new Object[]{context.childAsIsLazy(silver.driver.PcmdLineRunInitial.i_svParser), context.childAsIsLazy(silver.driver.PcmdLineRunInitial.i_sviParser)}); } }, context.childAsIsLazy(silver.driver.PcmdLineRunInitial.i_args), context.childAsIsLazy(silver.driver.PcmdLineRunInitial.i_ioin))));

		} catch(Throwable t) {
			throw new common.exceptions.TraceException("Error while evaluating function silver:driver:cmdLineRunInitial", t);
		}
	}
	...
	public static final class Factory extends common.NodeFactory<core.NIOVal> {
		...
		public core.NIOVal invoke(final Object[] children, final Object[] namedNotApplicable) {
			return PcmdLineRunInitial.invoke(children[0], children[1], children[2], children[3]);
		}
	};
}