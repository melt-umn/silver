...
public final class Pgroupnest extends common.FunctionNode {
	...
	public static silver.langutil.pp.NDocument invoke(final Object c_n, final Object c_inner) {
		try {
		final common.DecoratedNode context = new Pgroupnest(c_n, c_inner).decorate();
		//group(nest(n, inner))
		return (silver.langutil.pp.NDocument)(((silver.langutil.pp.NDocument)new silver.langutil.pp.Pgroup(new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((silver.langutil.pp.NDocument)new silver.langutil.pp.Pnest(context.childAsIsLazy(silver.langutil.pp.Pgroupnest.i_n), common.Thunk.transformUndecorate(context.childDecoratedLazy(silver.langutil.pp.Pgroupnest.i_inner)))); } })));
			...
			throw new common.exceptions.TraceException("Error while evaluating function silver:langutil:pp:groupnest", t);
		}
	}
	...
	public static final class Factory extends common.NodeFactory<silver.langutil.pp.NDocument> {
		...
		public silver.langutil.pp.NDocument invoke(final Object[] children, final Object[] namedNotApplicable) {
			return Pgroupnest.invoke(children[0], children[1]);
		}
	};
}