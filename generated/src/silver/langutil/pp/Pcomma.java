...
public final class Pcomma extends common.FunctionNode {
	...
	public static silver.langutil.pp.NDocument invoke() {
		try {
		final common.DecoratedNode context = new Pcomma().decorate();
		//text(",")
		return (silver.langutil.pp.NDocument)(((silver.langutil.pp.NDocument)new silver.langutil.pp.Ptext((new common.StringCatter(",")))));

		} catch(Throwable t) {
			throw new common.exceptions.TraceException("Error while evaluating function silver:langutil:pp:comma", t);
		}
	}
