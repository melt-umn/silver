...
public final class PcheckDecorated extends silver.analysis.typechecking.core.NTypeCheck {
	...
	public static final int num_local_attrs = Init.count_local__ON__silver_analysis_typechecking_core_checkDecorated;
	...
	public PcheckDecorated(final Object c_l) {
		super();
		this.child_l = c_l;
	...
	public common.Node evalForward(final common.DecoratedNode context) {
		throw new common.exceptions.SilverInternalError("Production silver:analysis:typechecking:core:checkDecorated erroneously claimed to forward");
	}
	...
	static void initProductionAttributeDefinitions() {
		...
		silver.analysis.typechecking.core.PcheckDecorated.synthesizedAttributes[silver.analysis.typechecking.core.Init.silver_analysis_typechecking_core_leftpp__ON__silver_analysis_typechecking_core_TypeCheck] = new common.Lazy() { public final Object eval(final common.DecoratedNode context) { return ((common.StringCatter)silver.definition.type.PprettyType.invoke(new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((silver.definition.type.NType)silver.definition.type.PperformSubstitution.invoke(common.Thunk.transformUndecorate(context.childDecoratedLazy(silver.analysis.typechecking.core.PcheckDecorated.i_l)), context.contextInheritedLazy(silver.analysis.typechecking.core.Init.silver_analysis_typechecking_core_finalSubst__ON__silver_analysis_typechecking_core_TypeCheck))); } })); } };
		// top.rightpp = "a decorated nonterminal"
		silver.analysis.typechecking.core.PcheckDecorated.synthesizedAttributes[silver.analysis.typechecking.core.Init.silver_analysis_typechecking_core_rightpp__ON__silver_analysis_typechecking_core_TypeCheck] = new common.Lazy() { public final Object eval(final common.DecoratedNode context) { return (new common.StringCatter("a decorated nonterminal")); } };

	}

	public static final common.NodeFactory<PcheckDecorated> factory = new Factory();

	public static final class Factory extends common.NodeFactory<PcheckDecorated> {

		@Override
		public PcheckDecorated invoke(final Object[] children, final Object[] annotations) {
			return new PcheckDecorated(children[0]);
		}
	};
