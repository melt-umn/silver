...
public final class Padd extends common.FunctionNode {
	...
	public static final int num_local_attrs = Init.count_local__ON__silver_util_raw_graph_add;
	...
	public Padd(final Object c_lst, final Object c_graph) {
	...
	public String getName() {
		return "silver:util:raw:graph:add";
	}

	public static Object invoke(final Object c_lst, final Object c_graph) {
		try {
		return (Object)common.rawlib.RawGraph.add(((common.ConsCell)common.Util.demand(c_lst)), (java.util.TreeMap<Object,java.util.TreeSet<Object>>)((Object)common.Util.demand(c_graph)));

		} catch(Throwable t) {
			throw new common.exceptions.TraceException("Error while evaluating function silver:util:raw:graph:add", t);
		}
	}
