...
public final class PremoveAll extends common.FunctionNode {
	...
	public static final int num_local_attrs = Init.count_local__ON__silver_util_raw_treeset_removeAll;
	...
	public PremoveAll(final Object c_lst, final Object c_set) {
	...
	public String getName() {
		return "silver:util:raw:treeset:removeAll";
	}

	public static Object invoke(final Object c_lst, final Object c_set) {
		try {
		return (Object)common.rawlib.RawTreeSet.removeAll(((common.ConsCell)common.Util.demand(c_lst)), (java.util.TreeSet<Object>)((Object)common.Util.demand(c_set)));

		} catch(Throwable t) {
			throw new common.exceptions.TraceException("Error while evaluating function silver:util:raw:treeset:removeAll", t);
		}
	}
	...
	public static final class Factory extends common.NodeFactory<Object> {
		...
		public Object invoke(final Object[] children, final Object[] namedNotApplicable) {
			return PremoveAll.invoke(children[0], children[1]);
		}
	};
}