...
public final class PcontainsAll extends common.FunctionNode {
	...
	public static final int num_local_attrs = Init.count_local__ON__silver_util_raw_treeset_containsAll;
	...
	public PcontainsAll(final Object c_e, final Object c_set) {
		this.child_e = c_e;
	...
	public String getName() {
		return "silver:util:raw:treeset:containsAll";
	}

	public static Boolean invoke(final Object c_e, final Object c_set) {
		try {
		return (Boolean)common.rawlib.RawTreeSet.containsAll(((common.ConsCell)common.Util.demand(c_e)),(java.util.TreeSet<Object>)((Object)common.Util.demand(c_set)));

		} catch(Throwable t) {
			throw new common.exceptions.TraceException("Error while evaluating function silver:util:raw:treeset:containsAll", t);
		}
	}
