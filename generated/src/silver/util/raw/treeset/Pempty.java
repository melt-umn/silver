...
public final class Pempty extends common.FunctionNode {
	...
	public static final int num_local_attrs = Init.count_local__ON__silver_util_raw_treeset_empty;
	...
	public String getName() {
		return "silver:util:raw:treeset:empty";
	}

	public static Object invoke(final Object c_comparator) {
		try {
		return (Object)common.rawlib.RawTreeSet.empty(((common.NodeFactory<Integer>)common.Util.demand(c_comparator)));

		} catch(Throwable t) {
			throw new common.exceptions.TraceException("Error while evaluating function silver:util:raw:treeset:empty", t);
		}
	}
