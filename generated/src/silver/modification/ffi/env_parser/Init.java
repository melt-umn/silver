...
public class Init{
	...
	public static void postInit(){
		...
		common.Decorator.applyDecorators(silver.definition.env.env_parser.NITypeRep.decorators, PaTypeRepForeign.class);
	}
	...
	private static void initProductionAttributeDefinitions(){
		silver.modification.ffi.env_parser.PaTypeRepForeign.initProductionAttributeDefinitions();
	}

	public static int count_local__ON__silver_modification_ffi_env_parser_aTypeRepForeign = 0;
}
