...
public final class PdefaultLhsDef extends common.FunctionNode {
	...
	public static final int num_local_attrs = Init.count_local__ON__silver_modification_defaultattr_defaultLhsDef;
	...
	public PdefaultLhsDef(final Object c_sg, final Object c_sl, final Object c_fn, final Object c_ty) {
		this.child_sg = c_sg;
		this.child_sl = c_sl;
		this.child_fn = c_fn;
		this.child_ty = c_ty;
	...
	public static final class Factory extends common.NodeFactory<silver.definition.env.NDef> {
		...
		public silver.definition.env.NDef invoke(final Object[] children, final Object[] namedNotApplicable) {
			return PdefaultLhsDef.invoke(children[0], children[1], children[2], children[3]);
		}
	};
}