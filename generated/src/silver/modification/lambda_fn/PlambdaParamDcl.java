...
public final class PlambdaParamDcl extends silver.definition.env.NDclInfo {
	...
	public static final int num_local_attrs = Init.count_local__ON__silver_modification_lambda_fn_lambdaParamDcl;
	...
	public PlambdaParamDcl(final Object c_sg, final Object c_sl, final Object c_fn, final Object c_ty) {
		super();
		this.child_sg = c_sg;
		this.child_sl = c_sl;
		this.child_fn = c_fn;
	...
	public common.Node evalForward(final common.DecoratedNode context) {
		throw new common.exceptions.SilverInternalError("Production silver:modification:lambda_fn:lambdaParamDcl erroneously claimed to forward");
	}
	...
	public String getName() {
		return "silver:modification:lambda_fn:lambdaParamDcl";
	}

	static void initProductionAttributeDefinitions() {
		// top.sourceGrammar = sg
		silver.modification.lambda_fn.PlambdaParamDcl.synthesizedAttributes[silver.definition.env.Init.silver_definition_env_sourceGrammar__ON__silver_definition_env_DclInfo] = new common.Lazy() { public final Object eval(final common.DecoratedNode context) { return ((common.StringCatter)context.childAsIs(silver.modification.lambda_fn.PlambdaParamDcl.i_sg)); } };
		// top.sourceLocation = sl
		silver.modification.lambda_fn.PlambdaParamDcl.synthesizedAttributes[silver.definition.env.Init.silver_definition_env_sourceLocation__ON__silver_definition_env_DclInfo] = new common.Lazy() { public final Object eval(final common.DecoratedNode context) { return context.childDecorated(silver.modification.lambda_fn.PlambdaParamDcl.i_sl).undecorate(); } };
		// top.fullName = fn
		silver.modification.lambda_fn.PlambdaParamDcl.synthesizedAttributes[silver.definition.env.Init.silver_definition_env_fullName__ON__silver_definition_env_DclInfo] = new common.Lazy() { public final Object eval(final common.DecoratedNode context) { return ((common.StringCatter)context.childAsIs(silver.modification.lambda_fn.PlambdaParamDcl.i_fn)); } };
		...
		// top.typerep = ty
		silver.modification.lambda_fn.PlambdaParamDcl.synthesizedAttributes[silver.definition.env.Init.silver_definition_env_typerep__ON__silver_definition_env_DclInfo] = new common.Lazy() { public final Object eval(final common.DecoratedNode context) { return context.childDecorated(silver.modification.lambda_fn.PlambdaParamDcl.i_ty).undecorate(); } };
		// top.refDispatcher = lambdaParamReference(_,location=_)
		silver.modification.lambda_fn.PlambdaParamDcl.synthesizedAttributes[silver.definition.core.Init.silver_definition_core_refDispatcher__ON__silver_definition_env_DclInfo] = new common.Lazy() { public final Object eval(final common.DecoratedNode context) { return silver.modification.lambda_fn.PlambdaParamReference.factory.invokeNamedPartial(new int[]{0}, null, null); } };
	...
	public static final common.NodeFactory<PlambdaParamDcl> factory = new Factory();

	public static final class Factory extends common.NodeFactory<PlambdaParamDcl> {

		@Override
		public PlambdaParamDcl invoke(final Object[] children, final Object[] annotations) {
			return new PlambdaParamDcl(children[0], children[1], children[2], children[3]);
		}
	};
