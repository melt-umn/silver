...
public final class PaDclInfoFont extends silver.definition.env.env_parser.NIDclInfo {
	...
	public static final Class<?> childTypes[] = {silver.modification.impide.env_parser.TFontTerm.class,silver.definition.env.env_parser.TLParent_t.class,silver.definition.env.env_parser.NILocation.class,silver.definition.env.env_parser.TComma_t.class,silver.definition.env.env_parser.NIName.class,silver.definition.env.env_parser.TRParent_t.class};

	public static final int num_local_attrs = Init.count_local__ON__silver_modification_impide_env_parser_aDclInfoFont;
	...
	public PaDclInfoFont(final Object c__G_5, final Object c__G_4, final Object c_l, final Object c__G_2, final Object c_fn, final Object c__G_0) {
		super();
	...
	public final silver.modification.impide.env_parser.TFontTerm getChild__G_5() {
		return (silver.modification.impide.env_parser.TFontTerm) (child__G_5 = common.Util.demand(child__G_5));
	}
	...
	public common.Node evalForward(final common.DecoratedNode context) {
		throw new common.exceptions.SilverInternalError("Production silver:modification:impide:env_parser:aDclInfoFont erroneously claimed to forward");
	}
	...
	public String getName() {
		return "silver:modification:impide:env_parser:aDclInfoFont";
	}

	static void initProductionAttributeDefinitions() {
		// top.defs = [ fontDef(top.grammarName, l.alocation, fn.aname) ]
		silver.modification.impide.env_parser.PaDclInfoFont.synthesizedAttributes[silver.definition.env.env_parser.Init.silver_definition_env_defs__ON__silver_definition_env_env_parser_IDclInfo] = new common.Lazy() { public final Object eval(final common.DecoratedNode context) { return ((common.ConsCell)core.Pcons.invoke(new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((silver.definition.env.NDef)silver.modification.impide.PfontDef.invoke(context.contextInheritedLazy(silver.definition.env.env_parser.Init.silver_definition_core_grammarName__ON__silver_definition_env_env_parser_IDclInfo), context.childDecoratedSynthesizedLazy(silver.modification.impide.env_parser.PaDclInfoFont.i_l, silver.definition.env.env_parser.Init.silver_definition_env_env_parser_alocation__ON__silver_definition_env_env_parser_ILocation), context.childDecoratedSynthesizedLazy(silver.modification.impide.env_parser.PaDclInfoFont.i_fn, silver.definition.env.env_parser.Init.silver_definition_env_env_parser_aname__ON__silver_definition_env_env_parser_IName))); } }, new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((common.ConsCell)core.Pnil.invoke()); } })); } };

	}

	public static final common.NodeFactory<PaDclInfoFont> factory = new Factory();

	public static final class Factory extends common.NodeFactory<PaDclInfoFont> {

		@Override
		public PaDclInfoFont invoke(final Object[] children, final Object[] annotations) {
			return new PaDclInfoFont(children[0], children[1], children[2], children[3], children[4], children[5]);
		}
	};
