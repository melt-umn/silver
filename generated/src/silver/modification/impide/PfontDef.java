...
public final class PfontDef extends common.FunctionNode {
	...
	public static final int num_local_attrs = Init.count_local__ON__silver_modification_impide_fontDef;
	...
	public PfontDef(final Object c_sg, final Object c_sl, final Object c_fn) {
		this.child_sg = c_sg;
		this.child_sl = c_sl;
		this.child_fn = c_fn;
	...
	public String getName() {
		return "silver:modification:impide:fontDef";
	}

	public static silver.definition.env.NDef invoke(final Object c_sg, final Object c_sl, final Object c_fn) {
		try {
		final common.DecoratedNode context = new PfontDef(c_sg, c_sl, c_fn).decorate();
		//fontStyleDef(defaultEnvItem(fontDcl(sg, sl, fn)))
		return (silver.definition.env.NDef)(((silver.definition.env.NDef)new silver.modification.impide.PfontStyleDef(new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((silver.definition.env.NEnvItem)silver.definition.env.PdefaultEnvItem.invoke(new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((silver.definition.env.NDclInfo)new silver.modification.impide.PfontDcl(context.childAsIsLazy(silver.modification.impide.PfontDef.i_sg), common.Thunk.transformUndecorate(context.childDecoratedLazy(silver.modification.impide.PfontDef.i_sl)), context.childAsIsLazy(silver.modification.impide.PfontDef.i_fn))); } })); } })));

		} catch(Throwable t) {
			throw new common.exceptions.TraceException("Error while evaluating function silver:modification:impide:fontDef", t);
		}
	}
	...
	public static final class Factory extends common.NodeFactory<silver.definition.env.NDef> {
		...
		public silver.definition.env.NDef invoke(final Object[] children, final Object[] namedNotApplicable) {
			return PfontDef.invoke(children[0], children[1], children[2]);
		}
	};
}