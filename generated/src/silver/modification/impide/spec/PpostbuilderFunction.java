...
public final class PpostbuilderFunction extends silver.modification.impide.spec.NIdeFunction {
	...
	public static final int num_local_attrs = Init.count_local__ON__silver_modification_impide_spec_postbuilderFunction;
	...
	public PpostbuilderFunction(final Object c_fName) {
		super();
	...
	public common.Node evalForward(final common.DecoratedNode context) {
		throw new common.exceptions.SilverInternalError("Production silver:modification:impide:spec:postbuilderFunction erroneously claimed to forward");
	}
	...
	public String getName() {
		return "silver:modification:impide:spec:postbuilderFunction";
	}
