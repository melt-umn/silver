...
public class Init{
	...
	public static void postInit(){
		...
		common.Decorator.applyDecorators(silver.definition.env.env_parser.NIDclInfo.decorators, PaDclInfoAutoCopy.class);
	}
	...
	private static void initProductionAttributeDefinitions(){
		silver.modification.autocopyattr.env_parser.PaDclInfoAutoCopy.initProductionAttributeDefinitions();
	}

	public static int count_local__ON__silver_modification_autocopyattr_env_parser_aDclInfoAutoCopy = 0;
}
