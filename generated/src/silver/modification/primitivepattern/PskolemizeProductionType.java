...
public final class PskolemizeProductionType extends common.FunctionNode {
	...
	public static final int num_local_attrs = Init.count_local__ON__silver_modification_primitivepattern_skolemizeProductionType;
	...
	public PskolemizeProductionType(final Object c_te) {
		this.child_te = c_te;
	...
	public String getName() {
		return "silver:modification:primitivepattern:skolemizeProductionType";
	}

	public static silver.definition.type.NType invoke(final Object c_te) {
		try {
		final common.DecoratedNode context = new PskolemizeProductionType(c_te).decorate();
		//performSubstitution(te, skolemize)
		return (silver.definition.type.NType)(((silver.definition.type.NType)silver.definition.type.PperformSubstitution.invoke(common.Thunk.transformUndecorate(context.childDecoratedLazy(silver.modification.primitivepattern.PskolemizeProductionType.i_te)), common.Thunk.transformUndecorate(context.localDecoratedLazy(silver.modification.primitivepattern.Init.skolemize__ON__silver_modification_primitivepattern_skolemizeProductionType)))));

		} catch(Throwable t) {
			throw new common.exceptions.TraceException("Error while evaluating function silver:modification:primitivepattern:skolemizeProductionType", t);
		}
	}
	...
	public static final class Factory extends common.NodeFactory<silver.definition.type.NType> {
		...
		public silver.definition.type.NType invoke(final Object[] children, final Object[] namedNotApplicable) {
			return PskolemizeProductionType.invoke(children[0]);
		}
	};
}