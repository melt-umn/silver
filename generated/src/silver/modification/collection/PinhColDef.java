...
public final class PinhColDef extends common.FunctionNode {
	...
	public static final int num_local_attrs = Init.count_local__ON__silver_modification_collection_inhColDef;
	...
	public PinhColDef(final Object c_sg, final Object c_sl, final Object c_fn, final Object c_bound, final Object c_ty, final Object c_o) {
		this.child_sg = c_sg;
		this.child_sl = c_sl;
		this.child_fn = c_fn;
	...
	public String getName() {
		return "silver:modification:collection:inhColDef";
	}
	...
	public static silver.definition.env.NDef invoke(final Object c_sg, final Object c_sl, final Object c_fn, final Object c_bound, final Object c_ty, final Object c_o) {
		try {
		final common.DecoratedNode context = new PinhColDef(c_sg, c_sl, c_fn, c_bound, c_ty, c_o).decorate();
		//attrDef(defaultEnvItem(inhCollectionDcl(sg, sl, fn, bound, ty, o)))
		return (silver.definition.env.NDef)(((silver.definition.env.NDef)new silver.definition.env.PattrDef(new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((silver.definition.env.NEnvItem)silver.definition.env.PdefaultEnvItem.invoke(new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((silver.definition.env.NDclInfo)new silver.modification.collection.PinhCollectionDcl(context.childAsIsLazy(silver.modification.collection.PinhColDef.i_sg), common.Thunk.transformUndecorate(context.childDecoratedLazy(silver.modification.collection.PinhColDef.i_sl)), context.childAsIsLazy(silver.modification.collection.PinhColDef.i_fn), context.childAsIsLazy(silver.modification.collection.PinhColDef.i_bound), common.Thunk.transformUndecorate(context.childDecoratedLazy(silver.modification.collection.PinhColDef.i_ty)), common.Thunk.transformUndecorate(context.childDecoratedLazy(silver.modification.collection.PinhColDef.i_o)))); } })); } })));

		} catch(Throwable t) {
			throw new common.exceptions.TraceException("Error while evaluating function silver:modification:collection:inhColDef", t);
		}
	}
	...
	public static final class Factory extends common.NodeFactory<silver.definition.env.NDef> {
		...
		public silver.definition.env.NDef invoke(final Object[] children, final Object[] namedNotApplicable) {
			return PinhColDef.invoke(children[0], children[1], children[2], children[3], children[4], children[5]);
		}
	};
}