...
public final class PinhCollectionDcl extends silver.definition.env.NDclInfo {
  ...
  public final silver.definition.core.NProductionStmt invoke(final Object[] args, final Object[] namedArgs) {
    final Object __SV_LAMBDA_PARAM_7118_dl = args[0];
final Object __SV_LAMBDA_PARAM_7119_attr = args[1];
final Object __SV_LAMBDA_PARAM_7120_e = args[2];
final Object __SV_LAMBDA_PARAM_7121_l = args[3];

    return ((silver.definition.core.NProductionStmt)new silver.definition.core.PerrorAttributeDef(new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((common.ConsCell)core.Pcons.invoke(new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((silver.definition.core.NMessage)new silver.definition.core.Perr(((core.NLocation)common.Util.demand(__SV_LAMBDA_PARAM_7121_l)), new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return new common.StringCatter((common.StringCatter)((common.StringCatter)((common.DecoratedNode)common.Util.demand(__SV_LAMBDA_PARAM_7119_attr)).synthesized(silver.definition.core.Init.silver_definition_env_pp__ON__silver_definition_core_QNameAttrOccur)), (common.StringCatter)(new common.StringCatter(" is a collection attribute, and you must use ':=' or '<-', not '='."))); } })); } }, new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((common.ConsCell)core.Pnil.invoke()); } })); } }, ((common.DecoratedNode)common.Util.demand(__SV_LAMBDA_PARAM_7118_dl)), ((common.DecoratedNode)common.Util.demand(__SV_LAMBDA_PARAM_7119_attr)), ((silver.definition.core.NExpr)common.Util.demand(__SV_LAMBDA_PARAM_7120_e)), ((core.NLocation)common.Util.demand(__SV_LAMBDA_PARAM_7121_l))));
  }
}); } };
