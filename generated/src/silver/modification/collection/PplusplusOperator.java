...
else if(scrutineeNode instanceof silver.extension.list.PlistType) { final common.Thunk<Object> __SV_LOCAL___pv6889___sv_tmp_pv_6890 = new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return (common.DecoratedNode)scrutinee.childDecorated(0); } };
 return (silver.modification.collection.NOperation)((silver.modification.collection.NOperation)new silver.modification.collection.PplusPlusOperationList()); }if(!scrutineeIter.undecorate().hasForward()) break;scrutineeIter = scrutineeIter.forward();}return ((silver.modification.collection.NOperation)(__SV_LOCAL_6884___fail_6885.eval()));}}.eval(context, (common.DecoratedNode)((silver.definition.type.NType)context.inherited(silver.modification.collection.Init.silver_modification_collection_operatorForType__ON__silver_modification_collection_NameOrBOperator)).decorate(context, (common.Lazy[])null)); } }).eval()); } };
...
else if(scrutineeNode instanceof silver.extension.list.PlistType) { final common.Thunk<Object> __SV_LOCAL___pv6898___sv_tmp_pv_6899 = new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return (common.DecoratedNode)scrutinee.childDecorated(0); } };
 return (common.ConsCell)((common.ConsCell)core.Pnil.invoke()); }if(!scrutineeIter.undecorate().hasForward()) break;scrutineeIter = scrutineeIter.forward();}return ((common.ConsCell)(__SV_LOCAL_6891___fail_6892.eval()));}}.eval(context, (common.DecoratedNode)((silver.definition.type.NType)context.inherited(silver.modification.collection.Init.silver_modification_collection_operatorForType__ON__silver_modification_collection_NameOrBOperator)).decorate(context, (common.Lazy[])null)); } }).eval()); } });
