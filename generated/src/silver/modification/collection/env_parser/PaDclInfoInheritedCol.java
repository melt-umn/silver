...
public final class PaDclInfoInheritedCol extends silver.definition.env.env_parser.NIDclInfo {
	...
	public static final Class<?> childTypes[] = {silver.modification.collection.env_parser.TInhColTerm.class,silver.definition.env.env_parser.TLParent_t.class,silver.definition.env.env_parser.NILocation.class,silver.definition.env.env_parser.TComma_t.class,silver.definition.env.env_parser.NIName.class,silver.definition.env.env_parser.TComma_t.class,silver.definition.env.env_parser.NITyVarDcls.class,silver.definition.env.env_parser.TComma_t.class,silver.definition.env.env_parser.NITypeRep.class,silver.definition.env.env_parser.TComma_t.class,silver.modification.collection.env_parser.NIOperation.class,silver.definition.env.env_parser.TRParent_t.class};

	public static final int num_local_attrs = Init.count_local__ON__silver_modification_collection_env_parser_aDclInfoInheritedCol;
	...
	public PaDclInfoInheritedCol(final Object c__G_11, final Object c__G_10, final Object c_l, final Object c__G_8, final Object c_fn, final Object c__G_6, final Object c_td, final Object c__G_4, final Object c_t, final Object c__G_2, final Object c_o, final Object c__G_0) {
		super();
	...
	public final silver.modification.collection.env_parser.TInhColTerm getChild__G_11() {
		return (silver.modification.collection.env_parser.TInhColTerm) (child__G_11 = common.Util.demand(child__G_11));
	}
	...
	public common.Node evalForward(final common.DecoratedNode context) {
		throw new common.exceptions.SilverInternalError("Production silver:modification:collection:env_parser:aDclInfoInheritedCol erroneously claimed to forward");
	}
