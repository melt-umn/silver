...
public final class PtypeAliasDef extends common.FunctionNode {
	...
	public static final int num_local_attrs = Init.count_local__ON__silver_modification_typedecl_typeAliasDef;
	...
	public PtypeAliasDef(final Object c_sg, final Object c_sl, final Object c_fn, final Object c_bound, final Object c_ty) {
		this.child_sg = c_sg;
		this.child_sl = c_sl;
		this.child_fn = c_fn;
	...
	public String getName() {
		return "silver:modification:typedecl:typeAliasDef";
	}
	...
	public static silver.definition.env.NDef invoke(final Object c_sg, final Object c_sl, final Object c_fn, final Object c_bound, final Object c_ty) {
		try {
		final common.DecoratedNode context = new PtypeAliasDef(c_sg, c_sl, c_fn, c_bound, c_ty).decorate();
		//typeDef(defaultEnvItem(typeDcl(sg, sl, fn, bound, ty)))
		return (silver.definition.env.NDef)(((silver.definition.env.NDef)new silver.definition.env.PtypeDef(new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((silver.definition.env.NEnvItem)silver.definition.env.PdefaultEnvItem.invoke(new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((silver.definition.env.NDclInfo)new silver.modification.typedecl.PtypeDcl(context.childAsIsLazy(silver.modification.typedecl.PtypeAliasDef.i_sg), common.Thunk.transformUndecorate(context.childDecoratedLazy(silver.modification.typedecl.PtypeAliasDef.i_sl)), context.childAsIsLazy(silver.modification.typedecl.PtypeAliasDef.i_fn), context.childAsIsLazy(silver.modification.typedecl.PtypeAliasDef.i_bound), common.Thunk.transformUndecorate(context.childDecoratedLazy(silver.modification.typedecl.PtypeAliasDef.i_ty)))); } })); } })));

		} catch(Throwable t) {
			throw new common.exceptions.TraceException("Error while evaluating function silver:modification:typedecl:typeAliasDef", t);
		}
	}
	...
	public static final class Factory extends common.NodeFactory<silver.definition.env.NDef> {
		...
		public silver.definition.env.NDef invoke(final Object[] children, final Object[] namedNotApplicable) {
			return PtypeAliasDef.invoke(children[0], children[1], children[2], children[3], children[4]);
		}
	};
}