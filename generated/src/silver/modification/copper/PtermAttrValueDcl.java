...
public final class PtermAttrValueDcl extends silver.definition.env.NDclInfo {
	...
	public static final int num_local_attrs = Init.count_local__ON__silver_modification_copper_termAttrValueDcl;
	...
	public PtermAttrValueDcl(final Object c_sg, final Object c_sl, final Object c_fn, final Object c_ty) {
		super();
		this.child_sg = c_sg;
		this.child_sl = c_sl;
		this.child_fn = c_fn;
	...
	public common.Node evalForward(final common.DecoratedNode context) {
		throw new common.exceptions.SilverInternalError("Production silver:modification:copper:termAttrValueDcl erroneously claimed to forward");
	}
	...
	public String getName() {
		return "silver:modification:copper:termAttrValueDcl";
	}

	static void initProductionAttributeDefinitions() {
		// top.sourceGrammar = sg
		silver.modification.copper.PtermAttrValueDcl.synthesizedAttributes[silver.definition.env.Init.silver_definition_env_sourceGrammar__ON__silver_definition_env_DclInfo] = new common.Lazy() { public final Object eval(final common.DecoratedNode context) { return ((common.StringCatter)context.childAsIs(silver.modification.copper.PtermAttrValueDcl.i_sg)); } };
		// top.sourceLocation = sl
		silver.modification.copper.PtermAttrValueDcl.synthesizedAttributes[silver.definition.env.Init.silver_definition_env_sourceLocation__ON__silver_definition_env_DclInfo] = new common.Lazy() { public final Object eval(final common.DecoratedNode context) { return context.childDecorated(silver.modification.copper.PtermAttrValueDcl.i_sl).undecorate(); } };
		// top.fullName = fn
		silver.modification.copper.PtermAttrValueDcl.synthesizedAttributes[silver.definition.env.Init.silver_definition_env_fullName__ON__silver_definition_env_DclInfo] = new common.Lazy() { public final Object eval(final common.DecoratedNode context) { return ((common.StringCatter)context.childAsIs(silver.modification.copper.PtermAttrValueDcl.i_fn)); } };
		...
		// top.typerep = ty
		silver.modification.copper.PtermAttrValueDcl.synthesizedAttributes[silver.definition.env.Init.silver_definition_env_typerep__ON__silver_definition_env_DclInfo] = new common.Lazy() { public final Object eval(final common.DecoratedNode context) { return context.childDecorated(silver.modification.copper.PtermAttrValueDcl.i_ty).undecorate(); } };
		// top.refDispatcher = termAttrValueReference(_,location=_)
		silver.modification.copper.PtermAttrValueDcl.synthesizedAttributes[silver.definition.core.Init.silver_definition_core_refDispatcher__ON__silver_definition_env_DclInfo] = new common.Lazy() { public final Object eval(final common.DecoratedNode context) { return silver.modification.copper.PtermAttrValueReference.factory.invokeNamedPartial(new int[]{0}, null, null); } };
		// top.defDispatcher = termAttrValueValueDef(_, _,location=_)
		silver.modification.copper.PtermAttrValueDcl.synthesizedAttributes[silver.definition.core.Init.silver_definition_core_defDispatcher__ON__silver_definition_env_DclInfo] = new common.Lazy() { public final Object eval(final common.DecoratedNode context) { return silver.modification.copper.PtermAttrValueValueDef.factory.invokeNamedPartial(new int[]{0}, null, null); } };
	...
	public static final common.NodeFactory<PtermAttrValueDcl> factory = new Factory();

	public static final class Factory extends common.NodeFactory<PtermAttrValueDcl> {

		@Override
		public PtermAttrValueDcl invoke(final Object[] children, final Object[] annotations) {
			return new PtermAttrValueDcl(children[0], children[1], children[2], children[3]);
		}
	};
