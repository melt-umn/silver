...
public final class PlexerClassDef extends common.FunctionNode {
	...
	public static final int num_local_attrs = Init.count_local__ON__silver_modification_copper_lexerClassDef;
	...
	public PlexerClassDef(final Object c_sg, final Object c_sl, final Object c_fn) {
		this.child_sg = c_sg;
		this.child_sl = c_sl;
		this.child_fn = c_fn;
	...
	public String getName() {
		return "silver:modification:copper:lexerClassDef";
	}

	public static silver.definition.env.NDef invoke(final Object c_sg, final Object c_sl, final Object c_fn) {
		try {
		final common.DecoratedNode context = new PlexerClassDef(c_sg, c_sl, c_fn).decorate();
		//lxrClsDef(defaultEnvItem(lexerClassDcl(sg, sl, fn)))
		return (silver.definition.env.NDef)(((silver.definition.env.NDef)new silver.modification.copper.PlxrClsDef(new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((silver.definition.env.NEnvItem)silver.definition.env.PdefaultEnvItem.invoke(new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((silver.definition.env.NDclInfo)new silver.modification.copper.PlexerClassDcl(context.childAsIsLazy(silver.modification.copper.PlexerClassDef.i_sg), common.Thunk.transformUndecorate(context.childDecoratedLazy(silver.modification.copper.PlexerClassDef.i_sl)), context.childAsIsLazy(silver.modification.copper.PlexerClassDef.i_fn))); } })); } })));

		} catch(Throwable t) {
			throw new common.exceptions.TraceException("Error while evaluating function silver:modification:copper:lexerClassDef", t);
		}
	}
	...
	public static final class Factory extends common.NodeFactory<silver.definition.env.NDef> {
		...
		public silver.definition.env.NDef invoke(final Object[] children, final Object[] namedNotApplicable) {
			return PlexerClassDef.invoke(children[0], children[1], children[2]);
		}
	};
}