...
public final class PactionChildDef extends common.FunctionNode {
	...
	public static final int num_local_attrs = Init.count_local__ON__silver_modification_copper_actionChildDef;
	...
	public PactionChildDef(final Object c_sg, final Object c_sl, final Object c_fn, final Object c_ty) {
		this.child_sg = c_sg;
		this.child_sl = c_sl;
		this.child_fn = c_fn;
		this.child_ty = c_ty;
	...
	public String getName() {
		return "silver:modification:copper:actionChildDef";
	}

	public static silver.definition.env.NDef invoke(final Object c_sg, final Object c_sl, final Object c_fn, final Object c_ty) {
		try {
		final common.DecoratedNode context = new PactionChildDef(c_sg, c_sl, c_fn, c_ty).decorate();
		//valueDef(defaultEnvItem(actionChildDcl(sg, sl, fn, ty)))
		return (silver.definition.env.NDef)(((silver.definition.env.NDef)new silver.definition.env.PvalueDef(new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((silver.definition.env.NEnvItem)silver.definition.env.PdefaultEnvItem.invoke(new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((silver.definition.env.NDclInfo)new silver.modification.copper.PactionChildDcl(context.childAsIsLazy(silver.modification.copper.PactionChildDef.i_sg), common.Thunk.transformUndecorate(context.childDecoratedLazy(silver.modification.copper.PactionChildDef.i_sl)), context.childAsIsLazy(silver.modification.copper.PactionChildDef.i_fn), common.Thunk.transformUndecorate(context.childDecoratedLazy(silver.modification.copper.PactionChildDef.i_ty)))); } })); } })));

		} catch(Throwable t) {
			throw new common.exceptions.TraceException("Error while evaluating function silver:modification:copper:actionChildDef", t);
		}
	}
	...
	public static final class Factory extends common.NodeFactory<silver.definition.env.NDef> {
		...
		public silver.definition.env.NDef invoke(final Object[] children, final Object[] namedNotApplicable) {
			return PactionChildDef.invoke(children[0], children[1], children[2], children[3]);
		}
	};
}