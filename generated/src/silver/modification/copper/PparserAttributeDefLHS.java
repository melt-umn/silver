...
public final class PparserAttributeDefLHS extends silver.definition.core.NDefLHS {
	...
	static void initProductionAttributeDefinitions() {
		...
		// top.translation = error("Internal compiler error: translation not defined in the presence of errors: " ++ foldl(\ s::String m::Message  -> s ++ "\n" ++ m.msg, "", top.errors))
		silver.modification.copper.PparserAttributeDefLHS.synthesizedAttributes[silver.translation.java.core.Init.silver_translation_java_core_translation__ON__silver_definition_core_DefLHS] = new common.Lazy() { public final Object eval(final common.DecoratedNode context) { return ((common.StringCatter)core.Perror.invoke(new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return new common.StringCatter((common.StringCatter)(new common.StringCatter("Internal compiler error: translation not defined in the presence of errors: ")), (common.StringCatter)((common.StringCatter)core.Pfoldl.invoke((new common.NodeFactory<common.StringCatter>() {
  public final common.StringCatter invoke(final Object[] args, final Object[] namedArgs) {
    final Object __SV_LAMBDA_PARAM_6699_s = args[0];
final Object __SV_LAMBDA_PARAM_6700_m = args[1];

    return new common.StringCatter((common.StringCatter)((common.StringCatter)common.Util.demand(__SV_LAMBDA_PARAM_6699_s)), (common.StringCatter)new common.StringCatter((common.StringCatter)(new common.StringCatter("\n")), (common.StringCatter)((common.StringCatter)((silver.definition.core.NMessage)common.Util.demand(__SV_LAMBDA_PARAM_6700_m)).decorate(context, (common.Lazy[])null).synthesized(silver.definition.core.Init.silver_definition_core_msg__ON__silver_definition_core_Message))));
  }
}), (new common.StringCatter("")), context.contextSynthesizedLazy(silver.definition.core.Init.silver_definition_core_errors__ON__silver_definition_core_DefLHS)))); } })); } };
