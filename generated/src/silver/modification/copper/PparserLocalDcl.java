...
public final class PparserLocalDcl extends silver.definition.env.NDclInfo {
	...
	public static final int num_local_attrs = Init.count_local__ON__silver_modification_copper_parserLocalDcl;
	...
	public PparserLocalDcl(final Object c_sg, final Object c_sl, final Object c_fn, final Object c_ty) {
		super();
		this.child_sg = c_sg;
		this.child_sl = c_sl;
		this.child_fn = c_fn;
	...
	public common.Node evalForward(final common.DecoratedNode context) {
		throw new common.exceptions.SilverInternalError("Production silver:modification:copper:parserLocalDcl erroneously claimed to forward");
	}
	...
	public String getName() {
		return "silver:modification:copper:parserLocalDcl";
	}

	static void initProductionAttributeDefinitions() {
		// top.sourceGrammar = sg
		silver.modification.copper.PparserLocalDcl.synthesizedAttributes[silver.definition.env.Init.silver_definition_env_sourceGrammar__ON__silver_definition_env_DclInfo] = new common.Lazy() { public final Object eval(final common.DecoratedNode context) { return ((common.StringCatter)context.childAsIs(silver.modification.copper.PparserLocalDcl.i_sg)); } };
		// top.sourceLocation = sl
		silver.modification.copper.PparserLocalDcl.synthesizedAttributes[silver.definition.env.Init.silver_definition_env_sourceLocation__ON__silver_definition_env_DclInfo] = new common.Lazy() { public final Object eval(final common.DecoratedNode context) { return context.childDecorated(silver.modification.copper.PparserLocalDcl.i_sl).undecorate(); } };
		// top.fullName = fn
		silver.modification.copper.PparserLocalDcl.synthesizedAttributes[silver.definition.env.Init.silver_definition_env_fullName__ON__silver_definition_env_DclInfo] = new common.Lazy() { public final Object eval(final common.DecoratedNode context) { return ((common.StringCatter)context.childAsIs(silver.modification.copper.PparserLocalDcl.i_fn)); } };
		...
		// top.typerep = ty
		silver.modification.copper.PparserLocalDcl.synthesizedAttributes[silver.definition.env.Init.silver_definition_env_typerep__ON__silver_definition_env_DclInfo] = new common.Lazy() { public final Object eval(final common.DecoratedNode context) { return context.childDecorated(silver.modification.copper.PparserLocalDcl.i_ty).undecorate(); } };
	...
	public static final common.NodeFactory<PparserLocalDcl> factory = new Factory();

	public static final class Factory extends common.NodeFactory<PparserLocalDcl> {

		@Override
		public PparserLocalDcl invoke(final Object[] children, final Object[] annotations) {
			return new PparserLocalDcl(children[0], children[1], children[2], children[3]);
		}
	};
