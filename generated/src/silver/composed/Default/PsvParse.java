...
public final class PsvParse extends common.FunctionNode {
	...
	public static final int num_local_attrs = Init.count_local__ON__silver_composed_Default_svParse;
	...
	public PsvParse(final Object c_stringToParse, final Object c_filenameToReport) {
	...
	public String getName() {
		return "silver:composed:Default:svParse";
	}

	public static core.NParseResult invoke(final Object c_stringToParse, final Object c_filenameToReport) {
		try {
		return common.Util.callCopperParser(new silver.composed.Default.Parser_silver_composed_Default_svParse(), c_stringToParse, c_filenameToReport);
		} catch(Throwable t) {
			throw new common.exceptions.TraceException("Error while evaluating function silver:composed:Default:svParse", t);
		}
	}
	...
	public static final class Factory extends common.NodeFactory<core.NParseResult> {
		...
		public core.NParseResult invoke(final Object[] children, final Object[] namedNotApplicable) {
			return PsvParse.invoke(children[0], children[1]);
		}
	};
}