...
public final class PaspectProductionContext extends silver.definition.core.NBlockContext {
	...
	public static final int num_local_attrs = Init.count_local__ON__silver_definition_core_aspectProductionContext;
	...
	public PaspectProductionContext(final Object c_sig, final Object c_g) {
		super();
	...
	public common.Node evalForward(final common.DecoratedNode context) {
		return ((silver.definition.core.NBlockContext)new silver.definition.core.PproductionContext(common.Thunk.transformUndecorate(context.childDecoratedLazy(silver.definition.core.PaspectProductionContext.i_sig)), common.Thunk.transformUndecorate(context.childDecoratedLazy(silver.definition.core.PaspectProductionContext.i_g))));
	}
	...
	public String getName() {
		return "silver:definition:core:aspectProductionContext";
	}

	static void initProductionAttributeDefinitions() {
		// top.permitForward = false
		silver.definition.core.PaspectProductionContext.synthesizedAttributes[silver.definition.core.Init.silver_definition_core_permitForward__ON__silver_definition_core_BlockContext] = new common.Lazy() { public final Object eval(final common.DecoratedNode context) { return false; } };

	}

	public static final common.NodeFactory<PaspectProductionContext> factory = new Factory();

	public static final class Factory extends common.NodeFactory<PaspectProductionContext> {

		@Override
		public PaspectProductionContext invoke(final Object[] children, final Object[] annotations) {
			return new PaspectProductionContext(children[0], children[1]);
		}
	};
