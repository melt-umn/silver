...
else if(scrutineeNode instanceof silver.definition.core.PoneAnnoAppExprs) { final common.Thunk<Object> __SV_LOCAL___pv3064___sv_pv_3063_x = new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return (common.DecoratedNode)scrutinee.childDecorated(0); } };
 return (Boolean)((Boolean)(new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { final common.Thunk<Object> __SV_LOCAL_3065_x = new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((common.DecoratedNode)(__SV_LOCAL___pv3064___sv_pv_3063_x.eval())); } };
return ((Boolean)silver.definition.core.PannoExprContainsAnno.invoke(common.Thunk.transformUndecorate(__SV_LOCAL_3065_x), context.childAsIsLazy(silver.definition.core.PannoAppExprsContainsAnno.i_anno))); } }).eval()); }
else if(scrutineeNode instanceof silver.definition.core.PsnocAnnoAppExprs) { final common.Thunk<Object> __SV_LOCAL___pv3067___sv_pv_3068_xs = new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return (common.DecoratedNode)scrutinee.childDecorated(0); } };
final common.Thunk<Object> __SV_LOCAL___pv3069___sv_tmp_pv_3070 = new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return (silver.definition.core.TComma_t)scrutinee.childAsIs(1); } };
final common.Thunk<Object> __SV_LOCAL___pv3071___sv_pv_3066_x = new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return (common.DecoratedNode)scrutinee.childDecorated(2); } };
 return (Boolean)((Boolean)(new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { final common.Thunk<Object> __SV_LOCAL_3072_x = new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((common.DecoratedNode)(__SV_LOCAL___pv3071___sv_pv_3066_x.eval())); } };
return ((Boolean)(new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { final common.Thunk<Object> __SV_LOCAL_3073_xs = new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((common.DecoratedNode)(__SV_LOCAL___pv3067___sv_pv_3068_xs.eval())); } };
return (((Boolean)silver.definition.core.PannoExprContainsAnno.invoke(common.Thunk.transformUndecorate(__SV_LOCAL_3072_x), context.childAsIsLazy(silver.definition.core.PannoAppExprsContainsAnno.i_anno))) || ((Boolean)silver.definition.core.PannoAppExprsContainsAnno.invoke(common.Thunk.transformUndecorate(__SV_LOCAL_3073_xs), context.childAsIsLazy(silver.definition.core.PannoAppExprsContainsAnno.i_anno)))); } }).eval()); } }).eval()); }if(!scrutineeIter.undecorate().hasForward()) break;scrutineeIter = scrutineeIter.forward();}return ((Boolean)core.Perror.invoke((new common.StringCatter("Error: pattern match failed at silver:definition:core 'DefaultAnnotations.sv', 113, 11, 117, 7, 3572, 3802\n"))));}}.eval(context, (common.DecoratedNode)context.childDecorated(silver.definition.core.PannoAppExprsContainsAnno.i_toFill)));
