...
public final class PannotateDcl extends silver.definition.core.NAGDcl {
	...
	public static final int num_local_attrs = Init.count_local__ON__silver_definition_core_annotateDcl;
	...
	public PannotateDcl(final Object c__G_7, final Object c_at, final Object c_attl, final Object c__G_4, final Object c__G_3, final Object c_nt, final Object c_nttl, final Object c__G_0, final Object a_core_location) {
	...
	public final silver.definition.core.TAnnotation_kwd getChild__G_7() {
		return (silver.definition.core.TAnnotation_kwd) (child__G_7 = common.Util.demand(child__G_7));
	}
	...
	public common.Node evalForward(final common.DecoratedNode context) {
		return ((silver.definition.core.NAGDcl)new silver.definition.core.PattributionDcl(new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return new silver.definition.core.TAttribute_kwd((new common.StringCatter("attribute")), (core.NLocation)((core.NLocation)new core.Ploc((new common.StringCatter("??")), Integer.valueOf((int)-1), Integer.valueOf((int)-1), Integer.valueOf((int)-1), Integer.valueOf((int)-1), Integer.valueOf((int)-1), Integer.valueOf((int)-1)))); } }, common.Thunk.transformUndecorate(context.childDecoratedLazy(silver.definition.core.PannotateDcl.i_at)), common.Thunk.transformUndecorate(context.childDecoratedLazy(silver.definition.core.PannotateDcl.i_attl)), context.childAsIsLazy(silver.definition.core.PannotateDcl.i__G_4), context.childAsIsLazy(silver.definition.core.PannotateDcl.i__G_3), common.Thunk.transformUndecorate(context.childDecoratedLazy(silver.definition.core.PannotateDcl.i_nt)), common.Thunk.transformUndecorate(context.childDecoratedLazy(silver.definition.core.PannotateDcl.i_nttl)), context.childAsIsLazy(silver.definition.core.PannotateDcl.i__G_0), new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((core.NLocation)((silver.definition.core.NAGDcl)context.undecorate()).getAnno_core_location()); } }));
	}
	...
	public String getName() {
		return "silver:definition:core:annotateDcl";
	}
	...
	public static final common.NodeFactory<PannotateDcl> factory = new Factory();

	public static final class Factory extends common.NodeFactory<PannotateDcl> {

		@Override
		public PannotateDcl invoke(final Object[] children, final Object[] annotations) {
			return new PannotateDcl(children[0], children[1], children[2], children[3], children[4], children[5], children[6], children[7], annotations[0]);
		}
	};
