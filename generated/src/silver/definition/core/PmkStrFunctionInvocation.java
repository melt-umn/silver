...
public final class PmkStrFunctionInvocation extends common.FunctionNode {
	...
	public static final int num_local_attrs = Init.count_local__ON__silver_definition_core_mkStrFunctionInvocation;
	...
	public PmkStrFunctionInvocation(final Object c_l, final Object c_e, final Object c_es) {
		this.child_l = c_l;
		this.child_e = c_e;
		this.child_es = c_es;
	...
	public String getName() {
		return "silver:definition:core:mkStrFunctionInvocation";
	}

	public static silver.definition.core.NExpr invoke(final Object c_l, final Object c_e, final Object c_es) {
		try {
		final common.DecoratedNode context = new PmkStrFunctionInvocation(c_l, c_e, c_es).decorate();
		//mkFunctionInvocation(l, baseExpr(qName(l, e),location=l), es)
		return (silver.definition.core.NExpr)(((silver.definition.core.NExpr)silver.definition.core.PmkFunctionInvocation.invoke(common.Thunk.transformUndecorate(context.childDecoratedLazy(silver.definition.core.PmkStrFunctionInvocation.i_l)), new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((silver.definition.core.NExpr)new silver.definition.core.PbaseExpr(new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((silver.definition.core.NQName)silver.definition.core.PqName.invoke(common.Thunk.transformUndecorate(context.childDecoratedLazy(silver.definition.core.PmkStrFunctionInvocation.i_l)), context.childAsIsLazy(silver.definition.core.PmkStrFunctionInvocation.i_e))); } }, common.Thunk.transformUndecorate(context.childDecoratedLazy(silver.definition.core.PmkStrFunctionInvocation.i_l)))); } }, context.childAsIsLazy(silver.definition.core.PmkStrFunctionInvocation.i_es))));

		} catch(Throwable t) {
			throw new common.exceptions.TraceException("Error while evaluating function silver:definition:core:mkStrFunctionInvocation", t);
		}
	}
	...
	public static final class Factory extends common.NodeFactory<silver.definition.core.NExpr> {
		...
		public silver.definition.core.NExpr invoke(final Object[] children, final Object[] namedNotApplicable) {
			return PmkStrFunctionInvocation.invoke(children[0], children[1], children[2]);
		}
	};
}