...
public final class PmapDefOnEnvItem extends common.FunctionNode {
	...
	public static silver.definition.env.NDef invoke(final Object c_fn, final Object c_d) {
		...
		return (silver.definition.env.NDef)(((silver.definition.env.NDef)(new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { final common.Thunk<Object> __SV_LOCAL_4028___fail_4029 = new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return context.childDecorated(silver.definition.env.PmapDefOnEnvItem.i_d).undecorate(); } };
return new common.PatternLazy<common.DecoratedNode, silver.definition.env.NDef>() { public final silver.definition.env.NDef eval(final common.DecoratedNode context, common.DecoratedNode scrutineeIter) {while(true) {final common.DecoratedNode scrutinee = scrutineeIter; final common.Node scrutineeNode = scrutinee.undecorate(); if(scrutineeNode instanceof silver.definition.env.PattrDef) { final common.Thunk<Object> __SV_LOCAL___pv4033___sv_pv_4032_ei = new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return (common.DecoratedNode)scrutinee.childDecorated(0); } };
 return (silver.definition.env.NDef)((silver.definition.env.NDef)(new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { final common.Thunk<Object> __SV_LOCAL_4034_ei = new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((common.DecoratedNode)(__SV_LOCAL___pv4033___sv_pv_4032_ei.eval())); } };
return ((silver.definition.env.NDef)new silver.definition.env.PattrDef(new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((silver.definition.env.NEnvItem)((common.NodeFactory<silver.definition.env.NEnvItem>)context.childAsIs(silver.definition.env.PmapDefOnEnvItem.i_fn)).invoke(new Object[]{common.Thunk.transformUndecorate(__SV_LOCAL_4034_ei)}, null)); } })); } }).eval()); }
else if(scrutineeNode instanceof silver.definition.env.PprodDclDef) { final common.Thunk<Object> __SV_LOCAL___pv4036___sv_pv_4035_ei = new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return (common.DecoratedNode)scrutinee.childDecorated(0); } };
 return (silver.definition.env.NDef)((silver.definition.env.NDef)(new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { final common.Thunk<Object> __SV_LOCAL_4037_ei = new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((common.DecoratedNode)(__SV_LOCAL___pv4036___sv_pv_4035_ei.eval())); } };
return ((silver.definition.env.NDef)new silver.definition.env.PprodDclDef(new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((silver.definition.env.NEnvItem)((common.NodeFactory<silver.definition.env.NEnvItem>)context.childAsIs(silver.definition.env.PmapDefOnEnvItem.i_fn)).invoke(new Object[]{common.Thunk.transformUndecorate(__SV_LOCAL_4037_ei)}, null)); } })); } }).eval()); }
else if(scrutineeNode instanceof silver.definition.env.PtypeDef) { final common.Thunk<Object> __SV_LOCAL___pv4039___sv_pv_4038_ei = new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return (common.DecoratedNode)scrutinee.childDecorated(0); } };
 return (silver.definition.env.NDef)((silver.definition.env.NDef)(new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { final common.Thunk<Object> __SV_LOCAL_4040_ei = new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((common.DecoratedNode)(__SV_LOCAL___pv4039___sv_pv_4038_ei.eval())); } };
return ((silver.definition.env.NDef)new silver.definition.env.PtypeDef(new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((silver.definition.env.NEnvItem)((common.NodeFactory<silver.definition.env.NEnvItem>)context.childAsIs(silver.definition.env.PmapDefOnEnvItem.i_fn)).invoke(new Object[]{common.Thunk.transformUndecorate(__SV_LOCAL_4040_ei)}, null)); } })); } }).eval()); }
else if(scrutineeNode instanceof silver.definition.env.PvalueDef) { final common.Thunk<Object> __SV_LOCAL___pv4042___sv_pv_4041_ei = new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return (common.DecoratedNode)scrutinee.childDecorated(0); } };
 return (silver.definition.env.NDef)((silver.definition.env.NDef)(new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { final common.Thunk<Object> __SV_LOCAL_4043_ei = new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((common.DecoratedNode)(__SV_LOCAL___pv4042___sv_pv_4041_ei.eval())); } };
return ((silver.definition.env.NDef)new silver.definition.env.PvalueDef(new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((silver.definition.env.NEnvItem)((common.NodeFactory<silver.definition.env.NEnvItem>)context.childAsIs(silver.definition.env.PmapDefOnEnvItem.i_fn)).invoke(new Object[]{common.Thunk.transformUndecorate(__SV_LOCAL_4043_ei)}, null)); } })); } }).eval()); }if(!scrutineeIter.undecorate().hasForward()) break;scrutineeIter = scrutineeIter.forward();}return ((silver.definition.env.NDef)(__SV_LOCAL_4028___fail_4029.eval()));}}.eval(context, (common.DecoratedNode)context.childDecorated(silver.definition.env.PmapDefOnEnvItem.i_d)); } }).eval()));
