...
public final class PmapDefOnEnvItem extends common.FunctionNode {
	...
	public static silver.definition.env.NDef invoke(final Object c_fn, final Object c_d) {
		...
		return (silver.definition.env.NDef)(((silver.definition.env.NDef)(new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { final common.Thunk<Object> __SV_LOCAL_4022___fail_4023 = new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return context.childDecorated(silver.definition.env.PmapDefOnEnvItem.i_d).undecorate(); } };
return new common.PatternLazy<common.DecoratedNode, silver.definition.env.NDef>() { public final silver.definition.env.NDef eval(final common.DecoratedNode context, common.DecoratedNode scrutineeIter) {while(true) {final common.DecoratedNode scrutinee = scrutineeIter; final common.Node scrutineeNode = scrutinee.undecorate(); if(scrutineeNode instanceof silver.definition.env.PattrDef) { final common.Thunk<Object> __SV_LOCAL___pv4027___sv_pv_4026_ei = new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return (common.DecoratedNode)scrutinee.childDecorated(0); } };
 return (silver.definition.env.NDef)((silver.definition.env.NDef)(new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { final common.Thunk<Object> __SV_LOCAL_4028_ei = new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((common.DecoratedNode)(__SV_LOCAL___pv4027___sv_pv_4026_ei.eval())); } };
return ((silver.definition.env.NDef)new silver.definition.env.PattrDef(new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((silver.definition.env.NEnvItem)((common.NodeFactory<silver.definition.env.NEnvItem>)context.childAsIs(silver.definition.env.PmapDefOnEnvItem.i_fn)).invoke(new Object[]{common.Thunk.transformUndecorate(__SV_LOCAL_4028_ei)}, null)); } })); } }).eval()); }
else if(scrutineeNode instanceof silver.definition.env.PprodDclDef) { final common.Thunk<Object> __SV_LOCAL___pv4030___sv_pv_4029_ei = new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return (common.DecoratedNode)scrutinee.childDecorated(0); } };
 return (silver.definition.env.NDef)((silver.definition.env.NDef)(new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { final common.Thunk<Object> __SV_LOCAL_4031_ei = new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((common.DecoratedNode)(__SV_LOCAL___pv4030___sv_pv_4029_ei.eval())); } };
return ((silver.definition.env.NDef)new silver.definition.env.PprodDclDef(new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((silver.definition.env.NEnvItem)((common.NodeFactory<silver.definition.env.NEnvItem>)context.childAsIs(silver.definition.env.PmapDefOnEnvItem.i_fn)).invoke(new Object[]{common.Thunk.transformUndecorate(__SV_LOCAL_4031_ei)}, null)); } })); } }).eval()); }
else if(scrutineeNode instanceof silver.definition.env.PtypeDef) { final common.Thunk<Object> __SV_LOCAL___pv4033___sv_pv_4032_ei = new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return (common.DecoratedNode)scrutinee.childDecorated(0); } };
...
else if(scrutineeNode instanceof silver.definition.env.PvalueDef) { final common.Thunk<Object> __SV_LOCAL___pv4036___sv_pv_4035_ei = new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return (common.DecoratedNode)scrutinee.childDecorated(0); } };
