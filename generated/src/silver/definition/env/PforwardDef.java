...
public final class PforwardDef extends common.FunctionNode {
	...
	public static final int num_local_attrs = Init.count_local__ON__silver_definition_env_forwardDef;
	...
	public PforwardDef(final Object c_sg, final Object c_sl, final Object c_ty) {
		this.child_sg = c_sg;
		this.child_sl = c_sl;
		this.child_ty = c_ty;
	...
	public String getName() {
		return "silver:definition:env:forwardDef";
	}

	public static silver.definition.env.NDef invoke(final Object c_sg, final Object c_sl, final Object c_ty) {
		try {
		final common.DecoratedNode context = new PforwardDef(c_sg, c_sl, c_ty).decorate();
		//valueDef(defaultEnvItem(forwardDcl(sg, sl, ty)))
		return (silver.definition.env.NDef)(((silver.definition.env.NDef)new silver.definition.env.PvalueDef(new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((silver.definition.env.NEnvItem)silver.definition.env.PdefaultEnvItem.invoke(new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((silver.definition.env.NDclInfo)new silver.definition.env.PforwardDcl(context.childAsIsLazy(silver.definition.env.PforwardDef.i_sg), common.Thunk.transformUndecorate(context.childDecoratedLazy(silver.definition.env.PforwardDef.i_sl)), common.Thunk.transformUndecorate(context.childDecoratedLazy(silver.definition.env.PforwardDef.i_ty)))); } })); } })));

		} catch(Throwable t) {
			throw new common.exceptions.TraceException("Error while evaluating function silver:definition:env:forwardDef", t);
		}
	}
	...
	public static final class Factory extends common.NodeFactory<silver.definition.env.NDef> {
		...
		public silver.definition.env.NDef invoke(final Object[] children, final Object[] namedNotApplicable) {
			return PforwardDef.invoke(children[0], children[1], children[2]);
		}
	};
}