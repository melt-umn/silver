...
public final class PaTypeRepNonterminal extends silver.definition.env.env_parser.NITypeRep {
	...
	public static final Class<?> childTypes[] = {silver.definition.env.env_parser.TNonterminalTerm.class,silver.definition.env.env_parser.TLParent_t.class,silver.definition.env.env_parser.NIName.class,silver.definition.env.env_parser.TComma_t.class,silver.definition.env.env_parser.NITypeReps.class,silver.definition.env.env_parser.TRParent_t.class};

	public static final int num_local_attrs = Init.count_local__ON__silver_definition_env_env_parser_aTypeRepNonterminal;
	...
	public PaTypeRepNonterminal(final Object c__G_5, final Object c__G_4, final Object c_n, final Object c__G_2, final Object c_ty, final Object c__G_0) {
		super();
	...
	public common.Node evalForward(final common.DecoratedNode context) {
		throw new common.exceptions.SilverInternalError("Production silver:definition:env:env_parser:aTypeRepNonterminal erroneously claimed to forward");
	}
	...
	public String getName() {
		return "silver:definition:env:env_parser:aTypeRepNonterminal";
	}

	static void initProductionAttributeDefinitions() {
		// top.typerep = nonterminalType(n.aname, ty.typereps)
		silver.definition.env.env_parser.PaTypeRepNonterminal.synthesizedAttributes[silver.definition.env.env_parser.Init.silver_definition_env_typerep__ON__silver_definition_env_env_parser_ITypeRep] = new common.Lazy() { public final Object eval(final common.DecoratedNode context) { return ((silver.definition.type.NType)new silver.definition.type.PnonterminalType(context.childDecoratedSynthesizedLazy(silver.definition.env.env_parser.PaTypeRepNonterminal.i_n, silver.definition.env.env_parser.Init.silver_definition_env_env_parser_aname__ON__silver_definition_env_env_parser_IName), context.childDecoratedSynthesizedLazy(silver.definition.env.env_parser.PaTypeRepNonterminal.i_ty, silver.definition.env.env_parser.Init.silver_definition_env_env_parser_typereps__ON__silver_definition_env_env_parser_ITypeReps))); } };

	}

	public static final common.NodeFactory<PaTypeRepNonterminal> factory = new Factory();

	public static final class Factory extends common.NodeFactory<PaTypeRepNonterminal> {

		@Override
		public PaTypeRepNonterminal invoke(final Object[] children, final Object[] annotations) {
			return new PaTypeRepNonterminal(children[0], children[1], children[2], children[3], children[4], children[5]);
		}
	};
