...
public final class PaNamedSignatureElementsNone extends silver.definition.env.env_parser.NINamedSignatureElements {
	...
	public static final int num_local_attrs = Init.count_local__ON__silver_definition_env_env_parser_aNamedSignatureElementsNone;
	...
	public PaNamedSignatureElementsNone(final Object c__G_1, final Object c__G_0) {
		super();
	...
	public common.Node evalForward(final common.DecoratedNode context) {
		throw new common.exceptions.SilverInternalError("Production silver:definition:env:env_parser:aNamedSignatureElementsNone erroneously claimed to forward");
	}
	...
	public String getName() {
		return "silver:definition:env:env_parser:aNamedSignatureElementsNone";
	}

	static void initProductionAttributeDefinitions() {
		// top.elements = []
		silver.definition.env.env_parser.PaNamedSignatureElementsNone.synthesizedAttributes[silver.definition.env.env_parser.Init.silver_definition_env_env_parser_elements__ON__silver_definition_env_env_parser_INamedSignatureElements] = new common.Lazy() { public final Object eval(final common.DecoratedNode context) { return ((common.ConsCell)core.Pnil.invoke()); } };

	}

	public static final common.NodeFactory<PaNamedSignatureElementsNone> factory = new Factory();

	public static final class Factory extends common.NodeFactory<PaNamedSignatureElementsNone> {

		@Override
		public PaNamedSignatureElementsNone invoke(final Object[] children, final Object[] annotations) {
			return new PaNamedSignatureElementsNone(children[0], children[1]);
		}
	};
