...
// top::Def ::= d::EnvItem 
public final class PvalueDef extends silver.definition.env.NDef {
	...
	public static final int num_local_attrs = Init.count_local__ON__silver_definition_env_valueDef;
	...
	public PvalueDef(final Object c_d) {
		super();
		this.child_d = c_d;
	...
	public common.Node evalForward(final common.DecoratedNode context) {
		throw new common.exceptions.SilverInternalError("Production silver:definition:env:valueDef erroneously claimed to forward");
	}
	...
	public String getName() {
		return "silver:definition:env:valueDef";
	}

	static void initProductionAttributeDefinitions() {
		// top.dcl = d.dcl
		silver.definition.env.PvalueDef.synthesizedAttributes[silver.definition.env.Init.silver_definition_env_dcl__ON__silver_definition_env_Def] = new common.Lazy() { public final Object eval(final common.DecoratedNode context) { return ((silver.definition.env.NDclInfo)context.childDecorated(silver.definition.env.PvalueDef.i_d).synthesized(silver.definition.env.Init.silver_definition_env_dcl__ON__silver_definition_env_EnvItem)); } };
		// top.valueList = [ d ]
		silver.definition.env.PvalueDef.synthesizedAttributes[silver.definition.env.Init.silver_definition_env_valueList__ON__silver_definition_env_Def] = new common.Lazy() { public final Object eval(final common.DecoratedNode context) { return ((common.ConsCell)core.Pcons.invoke(common.Thunk.transformUndecorate(context.childDecoratedLazy(silver.definition.env.PvalueDef.i_d)), new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((common.ConsCell)core.Pnil.invoke()); } })); } };
	...
	public static final class Factory extends common.NodeFactory<PvalueDef> {
		...
		public PvalueDef invoke(final Object[] children, final Object[] annotations) {
			return new PvalueDef(children[0]);
		}
	};
