...
public final class PntDef extends common.FunctionNode {
	...
	public static final int num_local_attrs = Init.count_local__ON__silver_definition_env_ntDef;
	...
	public PntDef(final Object c_sg, final Object c_sl, final Object c_fn, final Object c_bound, final Object c_ty) {
		this.child_sg = c_sg;
		this.child_sl = c_sl;
		this.child_fn = c_fn;
	...
	public String getName() {
		return "silver:definition:env:ntDef";
	}
	...
	public static silver.definition.env.NDef invoke(final Object c_sg, final Object c_sl, final Object c_fn, final Object c_bound, final Object c_ty) {
		try {
		final common.DecoratedNode context = new PntDef(c_sg, c_sl, c_fn, c_bound, c_ty).decorate();
		//typeDef(defaultEnvItem(ntDcl(sg, sl, fn, bound, ty, false)))
		return (silver.definition.env.NDef)(((silver.definition.env.NDef)new silver.definition.env.PtypeDef(new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((silver.definition.env.NEnvItem)silver.definition.env.PdefaultEnvItem.invoke(new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((silver.definition.env.NDclInfo)new silver.definition.env.PntDcl(context.childAsIsLazy(silver.definition.env.PntDef.i_sg), common.Thunk.transformUndecorate(context.childDecoratedLazy(silver.definition.env.PntDef.i_sl)), context.childAsIsLazy(silver.definition.env.PntDef.i_fn), context.childAsIsLazy(silver.definition.env.PntDef.i_bound), common.Thunk.transformUndecorate(context.childDecoratedLazy(silver.definition.env.PntDef.i_ty)), false)); } })); } })));

		} catch(Throwable t) {
			throw new common.exceptions.TraceException("Error while evaluating function silver:definition:env:ntDef", t);
		}
	}
	...
	public static final class Factory extends common.NodeFactory<silver.definition.env.NDef> {
		...
		public silver.definition.env.NDef invoke(final Object[] children, final Object[] namedNotApplicable) {
			return PntDef.invoke(children[0], children[1], children[2], children[3], children[4]);
		}
	};
}