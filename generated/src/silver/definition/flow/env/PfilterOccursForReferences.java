...
public final class PfilterOccursForReferences extends common.FunctionNode {
	...
	public static common.ConsCell invoke(final Object c_occ, final Object c_e, final Object c_authority) {
		...
		return (common.ConsCell)(((common.ConsCell)(new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { final common.Thunk<Object> __SV_LOCAL_4909___fail_4910 = new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((common.ConsCell)core.Pnil.invoke()); } };
return new common.PatternLazy<common.ConsCell, common.ConsCell>() { public final common.ConsCell eval(final common.DecoratedNode context, common.ConsCell scrutineeIter) {final common.ConsCell scrutinee = scrutineeIter; if(!scrutineeIter.nil()) {final common.Thunk<Object> __SV_LOCAL_4915___sv_pv_4914_at = new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return scrutinee.head(); } };
final common.Thunk<Object> __SV_LOCAL_4916___sv_tmp_pv_4917 = new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return scrutinee.tail(); } };
return ((common.ConsCell)(new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { final common.Thunk<Object> __SV_LOCAL_4918_at = new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((silver.definition.env.NDclInfo)(__SV_LOCAL_4915___sv_pv_4914_at.eval())); } };
return ((((Boolean)((silver.definition.env.NDclInfo)(__SV_LOCAL_4918_at.eval())).decorate(context, (common.Lazy[])null).synthesized(silver.definition.env.Init.silver_definition_env_isInherited__ON__silver_definition_env_DclInfo)) && ((Boolean)((common.NodeFactory<Boolean>)context.childAsIs(silver.definition.flow.env.PfilterOccursForReferences.i_authority)).invoke(new Object[]{context.childDecoratedSynthesizedLazy(silver.definition.flow.env.PfilterOccursForReferences.i_occ, silver.definition.env.Init.silver_definition_env_sourceGrammar__ON__silver_definition_env_DclInfo)}, null))) ? ((common.ConsCell)core.Pcons.invoke(context.childDecoratedSynthesizedLazy(silver.definition.flow.env.PfilterOccursForReferences.i_occ, silver.definition.env.Init.silver_definition_env_attrOccurring__ON__silver_definition_env_DclInfo), new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((common.ConsCell)core.Pnil.invoke()); } })) : ((common.ConsCell)core.Pnil.invoke())); } }).eval()); }return ((common.ConsCell)(__SV_LOCAL_4909___fail_4910.eval()));}}.eval(context, (common.ConsCell)((common.ConsCell)silver.definition.env.PgetAttrDcl.invoke(context.childDecoratedSynthesizedLazy(silver.definition.flow.env.PfilterOccursForReferences.i_occ, silver.definition.env.Init.silver_definition_env_attrOccurring__ON__silver_definition_env_DclInfo), context.childAsIsLazy(silver.definition.flow.env.PfilterOccursForReferences.i_e)))); } }).eval()));
