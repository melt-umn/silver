...
public final class PaFlowLocalInhEq extends silver.definition.flow.env_parser.NIFlow {
	...
	public static final Class<?> childTypes[] = {silver.definition.flow.env_parser.TLocalInhTerm.class,silver.definition.env.env_parser.TLParent_t.class,silver.definition.env.env_parser.NIName.class,silver.definition.env.env_parser.TComma_t.class,silver.definition.env.env_parser.NIName.class,silver.definition.env.env_parser.TComma_t.class,silver.definition.env.env_parser.NIName.class,silver.definition.env.env_parser.TComma_t.class,silver.definition.flow.env_parser.NIFlowVertexes.class,silver.definition.env.env_parser.TRParent_t.class};

	public static final int num_local_attrs = Init.count_local__ON__silver_definition_flow_env_parser_aFlowLocalInhEq;
	...
	public PaFlowLocalInhEq(final Object c__G_9, final Object c__G_8, final Object c_prod, final Object c__G_6, final Object c_fname, final Object c__G_4, final Object c_attr, final Object c__G_2, final Object c_fv, final Object c__G_0) {
		super();
	...
	public final silver.definition.flow.env_parser.TLocalInhTerm getChild__G_9() {
		return (silver.definition.flow.env_parser.TLocalInhTerm) (child__G_9 = common.Util.demand(child__G_9));
	}
	...
	public common.Node evalForward(final common.DecoratedNode context) {
		throw new common.exceptions.SilverInternalError("Production silver:definition:flow:env_parser:aFlowLocalInhEq erroneously claimed to forward");
	}
