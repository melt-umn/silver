...
public final class PaFlowProd extends silver.definition.flow.env_parser.NIFlow {
	...
	public static final Class<?> childTypes[] = {silver.definition.env.env_parser.TProductionTerm.class,silver.definition.env.env_parser.TLParent_t.class,silver.definition.env.env_parser.NIName.class,silver.definition.env.env_parser.TComma_t.class,silver.definition.env.env_parser.NIName.class,silver.definition.env.env_parser.TRParent_t.class};

	public static final int num_local_attrs = Init.count_local__ON__silver_definition_flow_env_parser_aFlowProd;
	...
	public PaFlowProd(final Object c__G_5, final Object c__G_4, final Object c_nt, final Object c__G_2, final Object c_prod, final Object c__G_0) {
		super();
	...
	public final silver.definition.env.env_parser.TProductionTerm getChild__G_5() {
		return (silver.definition.env.env_parser.TProductionTerm) (child__G_5 = common.Util.demand(child__G_5));
	}
	...
	public common.Node evalForward(final common.DecoratedNode context) {
		throw new common.exceptions.SilverInternalError("Production silver:definition:flow:env_parser:aFlowProd erroneously claimed to forward");
	}
	...
	public String getName() {
		return "silver:definition:flow:env_parser:aFlowProd";
	}

	static void initProductionAttributeDefinitions() {
		// top.flowDefs = [ prodFlowDef(nt.aname, prod.aname) ]
		silver.definition.flow.env_parser.PaFlowProd.synthesizedAttributes[silver.definition.flow.env_parser.Init.silver_definition_flow_env_flowDefs__ON__silver_definition_flow_env_parser_IFlow] = new common.Lazy() { public final Object eval(final common.DecoratedNode context) { return ((common.ConsCell)core.Pcons.invoke(new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((silver.definition.flow.ast.NFlowDef)new silver.definition.flow.ast.PprodFlowDef(context.childDecoratedSynthesizedLazy(silver.definition.flow.env_parser.PaFlowProd.i_nt, silver.definition.env.env_parser.Init.silver_definition_env_env_parser_aname__ON__silver_definition_env_env_parser_IName), context.childDecoratedSynthesizedLazy(silver.definition.flow.env_parser.PaFlowProd.i_prod, silver.definition.env.env_parser.Init.silver_definition_env_env_parser_aname__ON__silver_definition_env_env_parser_IName))); } }, new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((common.ConsCell)core.Pnil.invoke()); } })); } };

	}

	public static final common.NodeFactory<PaFlowProd> factory = new Factory();

	public static final class Factory extends common.NodeFactory<PaFlowProd> {

		@Override
		public PaFlowProd invoke(final Object[] children, final Object[] annotations) {
			return new PaFlowProd(children[0], children[1], children[2], children[3], children[4], children[5]);
		}
	};
