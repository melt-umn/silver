...
public final class PaFlowDef extends silver.definition.flow.env_parser.NIFlow {
	...
	public static final Class<?> childTypes[] = {silver.definition.flow.env_parser.TDefTerm.class,silver.definition.env.env_parser.TLParent_t.class,silver.definition.env.env_parser.NIName.class,silver.definition.env.env_parser.TComma_t.class,silver.definition.env.env_parser.NIName.class,silver.definition.env.env_parser.TComma_t.class,silver.definition.flow.env_parser.NIFlowVertexes.class,silver.definition.env.env_parser.TRParent_t.class};

	public static final int num_local_attrs = Init.count_local__ON__silver_definition_flow_env_parser_aFlowDef;
	...
	public PaFlowDef(final Object c__G_7, final Object c__G_6, final Object c_nt, final Object c__G_4, final Object c_attr, final Object c__G_2, final Object c_fv, final Object c__G_0) {
		super();
	...
	public final silver.definition.flow.env_parser.TDefTerm getChild__G_7() {
		return (silver.definition.flow.env_parser.TDefTerm) (child__G_7 = common.Util.demand(child__G_7));
	}
	...
	public common.Node evalForward(final common.DecoratedNode context) {
		throw new common.exceptions.SilverInternalError("Production silver:definition:flow:env_parser:aFlowDef erroneously claimed to forward");
	}
	...
	public String getName() {
		return "silver:definition:flow:env_parser:aFlowDef";
	}

	static void initProductionAttributeDefinitions() {
		// top.flowDefs = [ defaultSynEq(nt.aname, attr.aname, fv.flowDeps) ]
		silver.definition.flow.env_parser.PaFlowDef.synthesizedAttributes[silver.definition.flow.env_parser.Init.silver_definition_flow_env_flowDefs__ON__silver_definition_flow_env_parser_IFlow] = new common.Lazy() { public final Object eval(final common.DecoratedNode context) { return ((common.ConsCell)core.Pcons.invoke(new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((silver.definition.flow.ast.NFlowDef)new silver.definition.flow.ast.PdefaultSynEq(context.childDecoratedSynthesizedLazy(silver.definition.flow.env_parser.PaFlowDef.i_nt, silver.definition.env.env_parser.Init.silver_definition_env_env_parser_aname__ON__silver_definition_env_env_parser_IName), context.childDecoratedSynthesizedLazy(silver.definition.flow.env_parser.PaFlowDef.i_attr, silver.definition.env.env_parser.Init.silver_definition_env_env_parser_aname__ON__silver_definition_env_env_parser_IName), context.childDecoratedSynthesizedLazy(silver.definition.flow.env_parser.PaFlowDef.i_fv, silver.definition.flow.env_parser.Init.silver_definition_flow_env_flowDeps__ON__silver_definition_flow_env_parser_IFlowVertexes))); } }, new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((common.ConsCell)core.Pnil.invoke()); } })); } };

	}

	public static final common.NodeFactory<PaFlowDef> factory = new Factory();

	public static final class Factory extends common.NodeFactory<PaFlowDef> {

		@Override
		public PaFlowDef invoke(final Object[] children, final Object[] annotations) {
			return new PaFlowDef(children[0], children[1], children[2], children[3], children[4], children[5], children[6], children[7]);
		}
	};
