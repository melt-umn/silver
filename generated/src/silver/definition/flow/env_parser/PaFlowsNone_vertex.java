...
// top::IFlowVertexes ::= '[' ']' 
public final class PaFlowsNone_vertex extends silver.definition.flow.env_parser.NIFlowVertexes {
	...
	public static final int num_local_attrs = Init.count_local__ON__silver_definition_flow_env_parser_aFlowsNone_vertex;
	...
	public PaFlowsNone_vertex(final Object c__G_1, final Object c__G_0) {
		super();
	...
	public common.Node evalForward(final common.DecoratedNode context) {
		throw new common.exceptions.SilverInternalError("Production silver:definition:flow:env_parser:aFlowsNone_vertex erroneously claimed to forward");
	}
	...
	public String getName() {
		return "silver:definition:flow:env_parser:aFlowsNone_vertex";
	}

	static void initProductionAttributeDefinitions() {
		// top.flowDeps = []
		silver.definition.flow.env_parser.PaFlowsNone_vertex.synthesizedAttributes[silver.definition.flow.env_parser.Init.silver_definition_flow_env_flowDeps__ON__silver_definition_flow_env_parser_IFlowVertexes] = new common.Lazy() { public final Object eval(final common.DecoratedNode context) { return ((common.ConsCell)core.Pnil.invoke()); } };

	}

	public static final common.NodeFactory<PaFlowsNone_vertex> factory = new Factory();

	public static final class Factory extends common.NodeFactory<PaFlowsNone_vertex> {

		@Override
		public PaFlowsNone_vertex invoke(final Object[] children, final Object[] annotations) {
			return new PaFlowsNone_vertex(children[0], children[1]);
		}
	};
