...
public final class PaFlowsNone_proj extends silver.definition.flow.env_parser.NIPatternVarProjections {
	...
	public static final int num_local_attrs = Init.count_local__ON__silver_definition_flow_env_parser_aFlowsNone_proj;
	...
	public PaFlowsNone_proj(final Object c__G_1, final Object c__G_0) {
		super();
	...
	public common.Node evalForward(final common.DecoratedNode context) {
		throw new common.exceptions.SilverInternalError("Production silver:definition:flow:env_parser:aFlowsNone_proj erroneously claimed to forward");
	}
	...
	public String getName() {
		return "silver:definition:flow:env_parser:aFlowsNone_proj";
	}

	static void initProductionAttributeDefinitions() {
		// top.aPatternVarProjection = []
		silver.definition.flow.env_parser.PaFlowsNone_proj.synthesizedAttributes[silver.definition.flow.env_parser.Init.silver_definition_flow_env_parser_aPatternVarProjection__ON__silver_definition_flow_env_parser_IPatternVarProjections] = new common.Lazy() { public final Object eval(final common.DecoratedNode context) { return ((common.ConsCell)core.Pnil.invoke()); } };

	}

	public static final common.NodeFactory<PaFlowsNone_proj> factory = new Factory();

	public static final class Factory extends common.NodeFactory<PaFlowsNone_proj> {

		@Override
		public PaFlowsNone_proj invoke(final Object[] children, final Object[] annotations) {
			return new PaFlowsNone_proj(children[0], children[1]);
		}
	};
