...
public final class PaFlowanonV_vertex extends silver.definition.flow.env_parser.NIFlowVertex {
	...
	public static final Class<?> childTypes[] = {silver.definition.flow.env_parser.TAnonVTerm.class,silver.definition.env.env_parser.TLParent_t.class,silver.definition.env.env_parser.NIName.class,silver.definition.env.env_parser.TComma_t.class,silver.definition.env.env_parser.NIName.class,silver.definition.env.env_parser.TRParent_t.class};

	public static final int num_local_attrs = Init.count_local__ON__silver_definition_flow_env_parser_aFlowanonV_vertex;
	...
	public PaFlowanonV_vertex(final Object c__G_5, final Object c__G_4, final Object c_fname, final Object c__G_2, final Object c_attr, final Object c__G_0) {
		super();
	...
	public final silver.definition.flow.env_parser.TAnonVTerm getChild__G_5() {
		return (silver.definition.flow.env_parser.TAnonVTerm) (child__G_5 = common.Util.demand(child__G_5));
	}
	...
	public common.Node evalForward(final common.DecoratedNode context) {
		throw new common.exceptions.SilverInternalError("Production silver:definition:flow:env_parser:aFlowanonV_vertex erroneously claimed to forward");
	}
	...
	public String getName() {
		return "silver:definition:flow:env_parser:aFlowanonV_vertex";
	}

	static void initProductionAttributeDefinitions() {
		// top.flowDeps = [ anonVertex(fname.aname, attr.aname) ]
		silver.definition.flow.env_parser.PaFlowanonV_vertex.synthesizedAttributes[silver.definition.flow.env_parser.Init.silver_definition_flow_env_flowDeps__ON__silver_definition_flow_env_parser_IFlowVertex] = new common.Lazy() { public final Object eval(final common.DecoratedNode context) { return ((common.ConsCell)core.Pcons.invoke(new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((silver.definition.flow.ast.NFlowVertex)new silver.definition.flow.ast.PanonVertex(context.childDecoratedSynthesizedLazy(silver.definition.flow.env_parser.PaFlowanonV_vertex.i_fname, silver.definition.env.env_parser.Init.silver_definition_env_env_parser_aname__ON__silver_definition_env_env_parser_IName), context.childDecoratedSynthesizedLazy(silver.definition.flow.env_parser.PaFlowanonV_vertex.i_attr, silver.definition.env.env_parser.Init.silver_definition_env_env_parser_aname__ON__silver_definition_env_env_parser_IName))); } }, new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((common.ConsCell)core.Pnil.invoke()); } })); } };

	}

	public static final common.NodeFactory<PaFlowanonV_vertex> factory = new Factory();

	public static final class Factory extends common.NodeFactory<PaFlowanonV_vertex> {

		@Override
		public PaFlowanonV_vertex invoke(final Object[] children, final Object[] annotations) {
			return new PaFlowanonV_vertex(children[0], children[1], children[2], children[3], children[4], children[5]);
		}
	};
