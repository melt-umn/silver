...
public final class PisOccursInherited extends common.FunctionNode {
	...
	public static Boolean invoke(final Object c_occs, final Object c_e) {
		...
		return (Boolean)(((Boolean)(new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { final common.Thunk<Object> __SV_LOCAL_6063___fail_6064 = new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return false; } };
return new common.PatternLazy<common.ConsCell, Boolean>() { public final Boolean eval(final common.DecoratedNode context, common.ConsCell scrutineeIter) {final common.ConsCell scrutinee = scrutineeIter; if(!scrutineeIter.nil()) {final common.Thunk<Object> __SV_LOCAL_6068___sv_pv_6067_at = new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return scrutinee.head(); } };
final common.Thunk<Object> __SV_LOCAL_6069___sv_tmp_pv_6070 = new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return scrutinee.tail(); } };
return ((Boolean)(new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { final common.Thunk<Object> __SV_LOCAL_6071_at = new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((silver.definition.env.NDclInfo)(__SV_LOCAL_6068___sv_pv_6067_at.eval())); } };
return ((Boolean)((silver.definition.env.NDclInfo)(__SV_LOCAL_6071_at.eval())).decorate(context, (common.Lazy[])null).synthesized(silver.definition.env.Init.silver_definition_env_isInherited__ON__silver_definition_env_DclInfo)); } }).eval()); }return ((Boolean)(__SV_LOCAL_6063___fail_6064.eval()));}}.eval(context, (common.ConsCell)((common.ConsCell)silver.definition.env.PgetAttrDcl.invoke(context.childDecoratedSynthesizedLazy(silver.definition.flow.driver.PisOccursInherited.i_occs, silver.definition.env.Init.silver_definition_env_attrOccurring__ON__silver_definition_env_DclInfo), context.childAsIsLazy(silver.definition.flow.driver.PisOccursInherited.i_e)))); } }).eval()));
