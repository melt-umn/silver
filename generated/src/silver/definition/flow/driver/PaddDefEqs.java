...
public final class PaddDefEqs extends common.FunctionNode {
	...
	public static common.ConsCell invoke(final Object c_prod, final Object c_nt, final Object c_syns, final Object c_flowEnv) {
		...
		return (common.ConsCell)((((Boolean)core.Pnull.invoke(context.childAsIsLazy(silver.definition.flow.driver.PaddDefEqs.i_syns))) ? ((common.ConsCell)core.Pnil.invoke()) : ((common.ConsCell)core.Pappend.invoke(new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return (((Boolean)core.Pnull.invoke(new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((common.ConsCell)silver.definition.flow.env.PlookupSyn.invoke(context.childAsIsLazy(silver.definition.flow.driver.PaddDefEqs.i_prod), new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((common.StringCatter)core.Phead.invoke(context.childAsIsLazy(silver.definition.flow.driver.PaddDefEqs.i_syns))); } }, context.childAsIsLazy(silver.definition.flow.driver.PaddDefEqs.i_flowEnv))); } })) ? ((common.ConsCell)(new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { final common.Thunk<Object> __SV_LOCAL_5958_x = new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((common.ConsCell)silver.definition.flow.env.PlookupDef.invoke(context.childAsIsLazy(silver.definition.flow.driver.PaddDefEqs.i_nt), new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((common.StringCatter)core.Phead.invoke(context.childAsIsLazy(silver.definition.flow.driver.PaddDefEqs.i_syns))); } }, context.childAsIsLazy(silver.definition.flow.driver.PaddDefEqs.i_flowEnv))); } };
return (((Boolean)core.Pnull.invoke(__SV_LOCAL_5958_x)) ? ((common.ConsCell)core.Pnil.invoke()) : ((common.ConsCell)((silver.definition.flow.ast.NFlowDef)core.Phead.invoke(__SV_LOCAL_5958_x)).decorate(context, (common.Lazy[])null).synthesized(silver.definition.flow.ast.Init.silver_definition_flow_ast_flowEdges__ON__silver_definition_flow_ast_FlowDef))); } }).eval()) : ((common.ConsCell)core.Pnil.invoke())); } }, new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((common.ConsCell)silver.definition.flow.driver.PaddDefEqs.invoke(context.childAsIsLazy(silver.definition.flow.driver.PaddDefEqs.i_prod), context.childAsIsLazy(silver.definition.flow.driver.PaddDefEqs.i_nt), new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((common.ConsCell)core.Ptail.invoke(context.childAsIsLazy(silver.definition.flow.driver.PaddDefEqs.i_syns))); } }, context.childAsIsLazy(silver.definition.flow.driver.PaddDefEqs.i_flowEnv))); } }))));
