...
// top::Type ::= tv::TyVar 
public final class PvarType extends silver.definition.type.NType {
	...
	public static final int num_local_attrs = Init.count_local__ON__silver_definition_type_varType;
	...
	public PvarType(final Object c_tv) {
		super();
		this.child_tv = c_tv;
	...
	public common.Node evalForward(final common.DecoratedNode context) {
		throw new common.exceptions.SilverInternalError("Production silver:definition:type:varType erroneously claimed to forward");
	}
