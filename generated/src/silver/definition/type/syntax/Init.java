...
public class Init{
	...
	private static void setupInheritedAttributes(){
		...
		silver.definition.core.PproductionDcl.occurs_local[silver.definition.type.syntax.Init.allLexicalTyVars__ON__silver_definition_core_productionDcl] = "silver:definition:core:productionDcl:local:allLexicalTyVars";
	...
	private static void initProductionAttributeDefinitions(){
		...
		// allLexicalTyVars = makeSet(ns.lexicalTypeVariables)
		silver.definition.core.PproductionDcl.localAttributes[silver.definition.type.syntax.Init.allLexicalTyVars__ON__silver_definition_core_productionDcl] = new common.Lazy() { public final Object eval(final common.DecoratedNode context) { return ((common.ConsCell)silver.util.PmakeSet.invoke(context.childDecoratedSynthesizedLazy(silver.definition.core.PproductionDcl.i_ns, silver.definition.type.syntax.Init.silver_definition_type_syntax_lexicalTypeVariables__ON__silver_definition_core_ProductionSignature))); } };
		// sigDefs <- addNewLexicalTyVars(top.grammarName, top.location, allLexicalTyVars)
		((common.CollectionAttribute)silver.definition.core.PproductionDcl.localAttributes[silver.definition.core.Init.sigDefs__ON__silver_definition_core_productionDcl]).addPiece(new common.Lazy() { public final Object eval(final common.DecoratedNode context) { return ((common.ConsCell)silver.definition.type.syntax.PaddNewLexicalTyVars.invoke(context.contextInheritedLazy(silver.definition.core.Init.silver_definition_core_grammarName__ON__silver_definition_core_AGDcl), new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((core.NLocation)((silver.definition.core.NAGDcl)context.undecorate()).getAnno_core_location()); } }, context.localAsIsLazy(silver.definition.type.syntax.Init.allLexicalTyVars__ON__silver_definition_core_productionDcl))); } });
...
public static final int allLexicalTyVars__ON__silver_definition_core_productionDcl = silver.definition.core.Init.count_local__ON__silver_definition_core_productionDcl++;
