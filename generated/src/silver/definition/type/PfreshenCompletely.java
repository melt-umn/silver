...
public final class PfreshenCompletely extends common.FunctionNode {
	...
	public static final int num_local_attrs = Init.count_local__ON__silver_definition_type_freshenCompletely;
	...
	public PfreshenCompletely(final Object c_te) {
		this.child_te = c_te;
	...
	public String getName() {
		return "silver:definition:type:freshenCompletely";
	}

	public static silver.definition.type.NType invoke(final Object c_te) {
		try {
		final common.DecoratedNode context = new PfreshenCompletely(c_te).decorate();
		//freshenType(te, te.freeVariables)
		return (silver.definition.type.NType)(((silver.definition.type.NType)silver.definition.type.PfreshenType.invoke(common.Thunk.transformUndecorate(context.childDecoratedLazy(silver.definition.type.PfreshenCompletely.i_te)), context.childDecoratedSynthesizedLazy(silver.definition.type.PfreshenCompletely.i_te, silver.definition.type.Init.silver_definition_type_freeVariables__ON__silver_definition_type_Type))));

		} catch(Throwable t) {
			throw new common.exceptions.TraceException("Error while evaluating function silver:definition:type:freshenCompletely", t);
		}
	}
	...
	public static final class Factory extends common.NodeFactory<silver.definition.type.NType> {
		...
		public silver.definition.type.NType invoke(final Object[] children, final Object[] namedNotApplicable) {
			return PfreshenCompletely.invoke(children[0]);
		}
	};
}