...
public final class PignoreFailure extends common.FunctionNode {
	...
	public static silver.definition.type.NSubstitution invoke(final Object c_s) {
		...
		return (silver.definition.type.NSubstitution)(new common.PatternLazy<common.DecoratedNode, silver.definition.type.NSubstitution>() { public final silver.definition.type.NSubstitution eval(final common.DecoratedNode context, common.DecoratedNode scrutineeIter) {while(true) {final common.DecoratedNode scrutinee = scrutineeIter; final common.Node scrutineeNode = scrutinee.undecorate(); if(scrutineeNode instanceof silver.definition.type.PbadSubst) { final common.Thunk<Object> __SV_LOCAL___pv5765___sv_pv_5764_sl = new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return (common.ConsCell)scrutinee.childAsIs(0); } };
final common.Thunk<Object> __SV_LOCAL___pv5766___sv_tmp_pv_5767 = new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return (common.ConsCell)scrutinee.childAsIs(1); } };
 return (silver.definition.type.NSubstitution)((silver.definition.type.NSubstitution)(new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { final common.Thunk<Object> __SV_LOCAL_5768_sl = new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((common.ConsCell)(__SV_LOCAL___pv5765___sv_pv_5764_sl.eval())); } };
return ((silver.definition.type.NSubstitution)new silver.definition.type.PgoodSubst(__SV_LOCAL_5768_sl)); } }).eval()); }
else if(scrutineeNode instanceof silver.definition.type.PgoodSubst) { final common.Thunk<Object> __SV_LOCAL___pv5769___sv_tmp_pv_5770 = new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return (common.ConsCell)scrutinee.childAsIs(0); } };
