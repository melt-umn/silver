...
public final class PaTerminalModifierPrec extends silver.definition.concrete_syntax.ast.env_parser.NITerminalModifier {
	...
	public static final int num_local_attrs = Init.count_local__ON__silver_definition_concrete_syntax_ast_env_parser_aTerminalModifierPrec;
	...
	public PaTerminalModifierPrec(final Object c__G_3, final Object c__G_2, final Object c_n, final Object c__G_0) {
		super();
	...
	public common.Node evalForward(final common.DecoratedNode context) {
		throw new common.exceptions.SilverInternalError("Production silver:definition:concrete_syntax:ast:env_parser:aTerminalModifierPrec erroneously claimed to forward");
	}
	...
	public String getName() {
		return "silver:definition:concrete_syntax:ast:env_parser:aTerminalModifierPrec";
	}

	static void initProductionAttributeDefinitions() {
		// top.terminalModifiers = [ termPrecedence(toInt(n.lexeme)) ]
		silver.definition.concrete_syntax.ast.env_parser.PaTerminalModifierPrec.synthesizedAttributes[silver.definition.concrete_syntax.ast.env_parser.Init.silver_definition_concrete_syntax_ast_env_parser_terminalModifiers__ON__silver_definition_concrete_syntax_ast_env_parser_ITerminalModifier] = new common.Lazy() { public final Object eval(final common.DecoratedNode context) { return ((common.ConsCell)core.Pcons.invoke(new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((silver.definition.concrete_syntax.ast.NSyntaxTerminalModifier)new silver.definition.concrete_syntax.ast.PtermPrecedence(new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return Integer.valueOf(((common.StringCatter)((silver.definition.env.env_parser.TNum_t)context.childAsIs(silver.definition.concrete_syntax.ast.env_parser.PaTerminalModifierPrec.i_n)).lexeme).toString()); } })); } }, new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((common.ConsCell)core.Pnil.invoke()); } })); } };

	}

	public static final common.NodeFactory<PaTerminalModifierPrec> factory = new Factory();

	public static final class Factory extends common.NodeFactory<PaTerminalModifierPrec> {

		@Override
		public PaTerminalModifierPrec invoke(final Object[] children, final Object[] annotations) {
			return new PaTerminalModifierPrec(children[0], children[1], children[2], children[3]);
		}
	};
