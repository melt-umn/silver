...
// top::ISyntax ::= '[' ']' 
public final class PaSyntaxNone extends silver.definition.concrete_syntax.ast.env_parser.NISyntax {
	...
	public static final int num_local_attrs = Init.count_local__ON__silver_definition_concrete_syntax_ast_env_parser_aSyntaxNone;
	...
	public PaSyntaxNone(final Object c__G_1, final Object c__G_0) {
		super();
	...
	public common.Node evalForward(final common.DecoratedNode context) {
		throw new common.exceptions.SilverInternalError("Production silver:definition:concrete_syntax:ast:env_parser:aSyntaxNone erroneously claimed to forward");
	}
	...
	public String getName() {
		return "silver:definition:concrete_syntax:ast:env_parser:aSyntaxNone";
	}

	static void initProductionAttributeDefinitions() {
		// top.syntaxAst = []
		silver.definition.concrete_syntax.ast.env_parser.PaSyntaxNone.synthesizedAttributes[silver.definition.concrete_syntax.ast.env_parser.Init.silver_definition_concrete_syntax_syntaxAst__ON__silver_definition_concrete_syntax_ast_env_parser_ISyntax] = new common.Lazy() { public final Object eval(final common.DecoratedNode context) { return ((common.ConsCell)core.Pnil.invoke()); } };

	}

	public static final common.NodeFactory<PaSyntaxNone> factory = new Factory();

	public static final class Factory extends common.NodeFactory<PaSyntaxNone> {

		@Override
		public PaSyntaxNone invoke(final Object[] children, final Object[] annotations) {
			return new PaSyntaxNone(children[0], children[1]);
		}
	};
