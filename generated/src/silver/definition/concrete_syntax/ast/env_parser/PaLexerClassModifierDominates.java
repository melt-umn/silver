...
public final class PaLexerClassModifierDominates extends silver.definition.concrete_syntax.ast.env_parser.NILexerClassModifier {
	...
	public static final int num_local_attrs = Init.count_local__ON__silver_definition_concrete_syntax_ast_env_parser_aLexerClassModifierDominates;
	...
	public PaLexerClassModifierDominates(final Object c__G_3, final Object c__G_2, final Object c_n, final Object c__G_0) {
		super();
	...
	public common.Node evalForward(final common.DecoratedNode context) {
		throw new common.exceptions.SilverInternalError("Production silver:definition:concrete_syntax:ast:env_parser:aLexerClassModifierDominates erroneously claimed to forward");
	}
	...
	public String getName() {
		return "silver:definition:concrete_syntax:ast:env_parser:aLexerClassModifierDominates";
	}

	static void initProductionAttributeDefinitions() {
		// top.lexerClassModifiers = [ lexerClassDominates(n.names) ]
		silver.definition.concrete_syntax.ast.env_parser.PaLexerClassModifierDominates.synthesizedAttributes[silver.definition.concrete_syntax.ast.env_parser.Init.silver_definition_concrete_syntax_ast_env_parser_lexerClassModifiers__ON__silver_definition_concrete_syntax_ast_env_parser_ILexerClassModifier] = new common.Lazy() { public final Object eval(final common.DecoratedNode context) { return ((common.ConsCell)core.Pcons.invoke(new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((silver.definition.concrete_syntax.ast.NSyntaxLexerClassModifier)new silver.definition.concrete_syntax.ast.PlexerClassDominates(context.childDecoratedSynthesizedLazy(silver.definition.concrete_syntax.ast.env_parser.PaLexerClassModifierDominates.i_n, silver.definition.env.env_parser.Init.silver_definition_env_env_parser_names__ON__silver_definition_env_env_parser_INames))); } }, new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((common.ConsCell)core.Pnil.invoke()); } })); } };

	}

	public static final common.NodeFactory<PaLexerClassModifierDominates> factory = new Factory();

	public static final class Factory extends common.NodeFactory<PaLexerClassModifierDominates> {

		@Override
		public PaLexerClassModifierDominates invoke(final Object[] children, final Object[] annotations) {
			return new PaLexerClassModifierDominates(children[0], children[1], children[2], children[3]);
		}
	};
