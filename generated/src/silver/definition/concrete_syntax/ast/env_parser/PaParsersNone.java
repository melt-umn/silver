...
// top::IParsers ::= '[' ']' 
public final class PaParsersNone extends silver.definition.concrete_syntax.ast.env_parser.NIParsers {
	...
	public static final int num_local_attrs = Init.count_local__ON__silver_definition_concrete_syntax_ast_env_parser_aParsersNone;
	...
	public PaParsersNone(final Object c__G_1, final Object c__G_0) {
		super();
	...
	public common.Node evalForward(final common.DecoratedNode context) {
		throw new common.exceptions.SilverInternalError("Production silver:definition:concrete_syntax:ast:env_parser:aParsersNone erroneously claimed to forward");
	}
	...
	public String getName() {
		return "silver:definition:concrete_syntax:ast:env_parser:aParsersNone";
	}

	static void initProductionAttributeDefinitions() {
		// top.parserSpecs = []
		silver.definition.concrete_syntax.ast.env_parser.PaParsersNone.synthesizedAttributes[silver.definition.concrete_syntax.ast.env_parser.Init.silver_definition_concrete_syntax_parserSpecs__ON__silver_definition_concrete_syntax_ast_env_parser_IParsers] = new common.Lazy() { public final Object eval(final common.DecoratedNode context) { return ((common.ConsCell)core.Pnil.invoke()); } };

	}

	public static final common.NodeFactory<PaParsersNone> factory = new Factory();

	public static final class Factory extends common.NodeFactory<PaParsersNone> {

		@Override
		public PaParsersNone invoke(final Object[] children, final Object[] annotations) {
			return new PaParsersNone(children[0], children[1]);
		}
	};
