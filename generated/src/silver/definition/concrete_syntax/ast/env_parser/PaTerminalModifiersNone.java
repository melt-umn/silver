...
public final class PaTerminalModifiersNone extends silver.definition.concrete_syntax.ast.env_parser.NITerminalModifiers {
	...
	public static final int num_local_attrs = Init.count_local__ON__silver_definition_concrete_syntax_ast_env_parser_aTerminalModifiersNone;
	...
	public PaTerminalModifiersNone(final Object c__G_1, final Object c__G_0) {
		super();
	...
	public common.Node evalForward(final common.DecoratedNode context) {
		throw new common.exceptions.SilverInternalError("Production silver:definition:concrete_syntax:ast:env_parser:aTerminalModifiersNone erroneously claimed to forward");
	}
	...
	public String getName() {
		return "silver:definition:concrete_syntax:ast:env_parser:aTerminalModifiersNone";
	}

	static void initProductionAttributeDefinitions() {
		// top.terminalModifiers = []
		silver.definition.concrete_syntax.ast.env_parser.PaTerminalModifiersNone.synthesizedAttributes[silver.definition.concrete_syntax.ast.env_parser.Init.silver_definition_concrete_syntax_ast_env_parser_terminalModifiers__ON__silver_definition_concrete_syntax_ast_env_parser_ITerminalModifiers] = new common.Lazy() { public final Object eval(final common.DecoratedNode context) { return ((common.ConsCell)core.Pnil.invoke()); } };

	}

	public static final common.NodeFactory<PaTerminalModifiersNone> factory = new Factory();

	public static final class Factory extends common.NodeFactory<PaTerminalModifiersNone> {

		@Override
		public PaTerminalModifiersNone invoke(final Object[] children, final Object[] annotations) {
			return new PaTerminalModifiersNone(children[0], children[1]);
		}
	};
