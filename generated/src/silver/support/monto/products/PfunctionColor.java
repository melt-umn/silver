...
// top::Color ::= 
public final class PfunctionColor extends silver.support.monto.products.NColor {



	public static final Class<?> childTypes[] = {};

	public static final int num_local_attrs = Init.count_local__ON__silver_support_monto_products_functionColor;
	...
	public common.Node evalForward(final common.DecoratedNode context) {
		throw new common.exceptions.SilverInternalError("Production silver:support:monto:products:functionColor erroneously claimed to forward");
	}
