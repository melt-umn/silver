...
public final class Pparse extends common.FunctionNode {
	...
	public static final int num_local_attrs = Init.count_local__ON__silver_testing_bin_parse;
	...
	public String getName() {
		return "silver:testing:bin:parse";
	}

	public static core.NParseResult invoke(final Object c_stringToParse, final Object c_filenameToReport) {
		try {
		return common.Util.callCopperParser(new silver.testing.bin.Parser_silver_testing_bin_parse(), c_stringToParse, c_filenameToReport);
		} catch(Throwable t) {
			throw new common.exceptions.TraceException("Error while evaluating function silver:testing:bin:parse", t);
		}
	}
