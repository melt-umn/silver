...
public final class PfunctionNameForBaseTypesCS extends common.FunctionNode {
	...
	public static core.NMaybe invoke(final Object c_valueType, final Object c_prefixS) {
		...
		return (core.NMaybe)(((core.NMaybe)(new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { final common.Thunk<Object> __SV_LOCAL_8578___fail_8579 = new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((core.NMaybe)new core.Pnothing()); } };
return new common.PatternLazy<common.DecoratedNode, core.NMaybe>() { public final core.NMaybe eval(final common.DecoratedNode context, common.DecoratedNode scrutineeIter) {while(true) {final common.DecoratedNode scrutinee = scrutineeIter; final common.Node scrutineeNode = scrutinee.undecorate(); if(scrutineeNode instanceof silver.definition.type.syntax.PbooleanTypeExpr) { final common.Thunk<Object> __SV_LOCAL___pv8583___sv_tmp_pv_8584 = new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return (silver.definition.type.syntax.TBoolean_tkwd)scrutinee.childAsIs(0); } };
