...
public final class PfunctionNameForBaseTypesCS extends common.FunctionNode {
	...
	public static core.NMaybe invoke(final Object c_valueType, final Object c_prefixS) {
		...
		return (core.NMaybe)(((core.NMaybe)(new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { final common.Thunk<Object> __SV_LOCAL_8562___fail_8563 = new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((core.NMaybe)new core.Pnothing()); } };
return new common.PatternLazy<common.DecoratedNode, core.NMaybe>() { public final core.NMaybe eval(final common.DecoratedNode context, common.DecoratedNode scrutineeIter) {while(true) {final common.DecoratedNode scrutinee = scrutineeIter; final common.Node scrutineeNode = scrutinee.undecorate(); if(scrutineeNode instanceof silver.definition.type.syntax.PbooleanTypeExpr) { final common.Thunk<Object> __SV_LOCAL___pv8567___sv_tmp_pv_8568 = new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return (silver.definition.type.syntax.TBoolean_tkwd)scrutinee.childAsIs(0); } };
...
else if(scrutineeNode instanceof silver.definition.type.syntax.PfloatTypeExpr) { final common.Thunk<Object> __SV_LOCAL___pv8569___sv_tmp_pv_8570 = new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return (silver.definition.type.syntax.TFloat_tkwd)scrutinee.childAsIs(0); } };
 return (core.NMaybe)((core.NMaybe)new core.Pjust(new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return new common.StringCatter((common.StringCatter)((common.StringCatter)context.childAsIs(silver.extension.testing.PfunctionNameForBaseTypesCS.i_prefixS)), (common.StringCatter)(new common.StringCatter("Float"))); } })); }
else if(scrutineeNode instanceof silver.definition.type.syntax.PintegerTypeExpr) { final common.Thunk<Object> __SV_LOCAL___pv8571___sv_tmp_pv_8572 = new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return (silver.definition.type.syntax.TInteger_tkwd)scrutinee.childAsIs(0); } };
 return (core.NMaybe)((core.NMaybe)new core.Pjust(new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return new common.StringCatter((common.StringCatter)((common.StringCatter)context.childAsIs(silver.extension.testing.PfunctionNameForBaseTypesCS.i_prefixS)), (common.StringCatter)(new common.StringCatter("Integer"))); } })); }
else if(scrutineeNode instanceof silver.definition.type.syntax.PstringTypeExpr) { final common.Thunk<Object> __SV_LOCAL___pv8573___sv_tmp_pv_8574 = new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return (silver.definition.type.syntax.TString_tkwd)scrutinee.childAsIs(0); } };
 return (core.NMaybe)((core.NMaybe)new core.Pjust(new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return new common.StringCatter((common.StringCatter)((common.StringCatter)context.childAsIs(silver.extension.testing.PfunctionNameForBaseTypesCS.i_prefixS)), (common.StringCatter)(new common.StringCatter("String"))); } })); }if(!scrutineeIter.undecorate().hasForward()) break;scrutineeIter = scrutineeIter.forward();}return ((core.NMaybe)(__SV_LOCAL_8562___fail_8563.eval()));}}.eval(context, (common.DecoratedNode)context.childDecorated(silver.extension.testing.PfunctionNameForBaseTypesCS.i_valueType)); } }).eval()));
