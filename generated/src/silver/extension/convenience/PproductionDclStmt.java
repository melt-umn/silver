...
public final class PproductionDclStmt extends silver.extension.convenience.NProductionDclStmt {
	...
	static void initProductionAttributeDefinitions() {
		...
		silver.extension.convenience.PproductionDclStmt.localAttributes[silver.extension.convenience.Init.nme__ON__silver_extension_convenience_productionDclStmt] = new common.Lazy() { public final Object eval(final common.DecoratedNode context) { return new common.PatternLazy<common.DecoratedNode, silver.definition.core.NName>() { public final silver.definition.core.NName eval(final common.DecoratedNode context, common.DecoratedNode scrutineeIter) {while(true) {final common.DecoratedNode scrutinee = scrutineeIter; final common.Node scrutineeNode = scrutinee.undecorate(); if(scrutineeNode instanceof silver.extension.convenience.PanOptionalName) { final common.Thunk<Object> __SV_LOCAL___pv9399___sv_tmp_pv_9400 = new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return (silver.definition.core.TLParen_t)scrutinee.childAsIs(0); } };
final common.Thunk<Object> __SV_LOCAL___pv9401___sv_pv_9398_n = new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return (common.DecoratedNode)scrutinee.childDecorated(1); } };
final common.Thunk<Object> __SV_LOCAL___pv9402___sv_tmp_pv_9403 = new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return (silver.definition.core.TRParen_t)scrutinee.childAsIs(2); } };
 return (silver.definition.core.NName)((silver.definition.core.NName)(new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { final common.Thunk<Object> __SV_LOCAL_9404_n = new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((common.DecoratedNode)(__SV_LOCAL___pv9401___sv_pv_9398_n.eval())); } };
return ((silver.definition.core.NName)((common.DecoratedNode)__SV_LOCAL_9404_n.eval()).undecorate()); } }).eval()); }
