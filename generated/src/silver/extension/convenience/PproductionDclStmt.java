...
public final class PproductionDclStmt extends silver.extension.convenience.NProductionDclStmt {
	...
	static void initProductionAttributeDefinitions() {
		...
		silver.extension.convenience.PproductionDclStmt.localAttributes[silver.extension.convenience.Init.nme__ON__silver_extension_convenience_productionDclStmt] = new common.Lazy() { public final Object eval(final common.DecoratedNode context) { return new common.PatternLazy<common.DecoratedNode, silver.definition.core.NName>() { public final silver.definition.core.NName eval(final common.DecoratedNode context, common.DecoratedNode scrutineeIter) {while(true) {final common.DecoratedNode scrutinee = scrutineeIter; final common.Node scrutineeNode = scrutinee.undecorate(); if(scrutineeNode instanceof silver.extension.convenience.PanOptionalName) { final common.Thunk<Object> __SV_LOCAL___pv9401___sv_tmp_pv_9402 = new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return (silver.definition.core.TLParen_t)scrutinee.childAsIs(0); } };
final common.Thunk<Object> __SV_LOCAL___pv9403___sv_pv_9400_n = new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return (common.DecoratedNode)scrutinee.childDecorated(1); } };
final common.Thunk<Object> __SV_LOCAL___pv9404___sv_tmp_pv_9405 = new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return (silver.definition.core.TRParen_t)scrutinee.childAsIs(2); } };
 return (silver.definition.core.NName)((silver.definition.core.NName)(new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { final common.Thunk<Object> __SV_LOCAL_9406_n = new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((common.DecoratedNode)(__SV_LOCAL___pv9403___sv_pv_9400_n.eval())); } };
return ((silver.definition.core.NName)((common.DecoratedNode)__SV_LOCAL_9406_n.eval()).undecorate()); } }).eval()); }
		...
		silver.extension.convenience.PproductionDclStmt.synthesizedAttributes[silver.extension.convenience.Init.silver_extension_convenience_proddcls__ON__silver_extension_convenience_ProductionDclStmt] = new common.Lazy() { public final Object eval(final common.DecoratedNode context) { return new common.PatternLazy<common.DecoratedNode, silver.definition.core.NAGDcl>() { public final silver.definition.core.NAGDcl eval(final common.DecoratedNode context, common.DecoratedNode scrutineeIter) {while(true) {final common.DecoratedNode scrutinee = scrutineeIter; final common.Node scrutineeNode = scrutinee.undecorate(); if(scrutineeNode instanceof silver.extension.convenience.PanOptionalAction) { final common.Thunk<Object> __SV_LOCAL___pv9419___sv_pv_9420_a = new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return (silver.modification.copper.TAction_kwd)scrutinee.childAsIs(0); } };
final common.Thunk<Object> __SV_LOCAL___pv9421___sv_pv_9418_c = new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return (common.DecoratedNode)scrutinee.childDecorated(1); } };
 return (silver.definition.core.NAGDcl)((silver.definition.core.NAGDcl)(new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { final common.Thunk<Object> __SV_LOCAL_9422_c = new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((common.DecoratedNode)(__SV_LOCAL___pv9421___sv_pv_9418_c.eval())); } };
return ((silver.definition.core.NAGDcl)(new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { final common.Thunk<Object> __SV_LOCAL_9423_a = new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((silver.modification.copper.TAction_kwd)(__SV_LOCAL___pv9419___sv_pv_9420_a.eval())); } };
return ((silver.definition.core.NAGDcl)new silver.modification.copper.PconcreteProductionDclAction(new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return new silver.definition.core.TConcrete_kwd((new common.StringCatter("concrete")), (core.NLocation)((core.NLocation)new core.Ploc((new common.StringCatter("??")), Integer.valueOf((int)-1), Integer.valueOf((int)-1), Integer.valueOf((int)-1), Integer.valueOf((int)-1), Integer.valueOf((int)-1), Integer.valueOf((int)-1)))); } }, new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return new silver.definition.core.TProduction_kwd((new common.StringCatter("production")), (core.NLocation)((core.NLocation)new core.Ploc((new common.StringCatter("??")), Integer.valueOf((int)-1), Integer.valueOf((int)-1), Integer.valueOf((int)-1), Integer.valueOf((int)-1), Integer.valueOf((int)-1), Integer.valueOf((int)-1)))); } }, common.Thunk.transformUndecorate(context.localDecoratedLazy(silver.extension.convenience.Init.nme__ON__silver_extension_convenience_productionDclStmt)), common.Thunk.transformUndecorate(context.localDecoratedLazy(silver.extension.convenience.Init.newSig__ON__silver_extension_convenience_productionDclStmt)), common.Thunk.transformUndecorate(context.childDecoratedLazy(silver.extension.convenience.PproductionDclStmt.i_mods)), common.Thunk.transformUndecorate(context.childDecoratedLazy(silver.extension.convenience.PproductionDclStmt.i_body)), __SV_LOCAL_9423_a, common.Thunk.transformUndecorate(__SV_LOCAL_9422_c), new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((core.NLocation)((silver.extension.convenience.NProductionDclStmt)context.undecorate()).getAnno_core_location()); } })); } }).eval()); } }).eval()); }
