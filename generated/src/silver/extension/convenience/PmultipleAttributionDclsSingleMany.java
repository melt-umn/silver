...
public final class PmultipleAttributionDclsSingleMany extends silver.definition.core.NAGDcl {
	...
	public static final int num_local_attrs = Init.count_local__ON__silver_extension_convenience_multipleAttributionDclsSingleMany;
	...
	public PmultipleAttributionDclsSingleMany(final Object c__G_6, final Object c_a, final Object c_tl, final Object c__G_3, final Object c__G_2, final Object c_nts, final Object c__G_0, final Object a_core_location) {
	...
	public String getName() {
		return "silver:extension:convenience:multipleAttributionDclsSingleMany";
	}

	static void initProductionAttributeDefinitions() {
		// top.pp = "attribute " ++ a.pp ++ " occurs on " ++ nts.pp ++ " ;"
		silver.extension.convenience.PmultipleAttributionDclsSingleMany.synthesizedAttributes[silver.definition.core.Init.silver_definition_env_pp__ON__silver_definition_core_AGDcl] = new common.Lazy() { public final Object eval(final common.DecoratedNode context) { return new common.StringCatter((common.StringCatter)(new common.StringCatter("attribute ")), (common.StringCatter)new common.StringCatter((common.StringCatter)((common.StringCatter)context.childDecorated(silver.extension.convenience.PmultipleAttributionDclsSingleMany.i_a).synthesized(silver.definition.core.Init.silver_definition_env_pp__ON__silver_definition_core_QName)), (common.StringCatter)new common.StringCatter((common.StringCatter)(new common.StringCatter(" occurs on ")), (common.StringCatter)new common.StringCatter((common.StringCatter)((common.StringCatter)context.childDecorated(silver.extension.convenience.PmultipleAttributionDclsSingleMany.i_nts).synthesized(silver.extension.convenience.Init.silver_definition_env_pp__ON__silver_extension_convenience_QNames2)), (common.StringCatter)(new common.StringCatter(" ;")))))); } };

	}

	public static final common.NodeFactory<PmultipleAttributionDclsSingleMany> factory = new Factory();

	public static final class Factory extends common.NodeFactory<PmultipleAttributionDclsSingleMany> {

		@Override
		public PmultipleAttributionDclsSingleMany invoke(final Object[] children, final Object[] annotations) {
			return new PmultipleAttributionDclsSingleMany(children[0], children[1], children[2], children[3], children[4], children[5], children[6], annotations[0]);
		}
	};
