...
public final class PattributeDclSynMultiple extends silver.definition.core.NAGDcl {
	...
	public static final int num_local_attrs = Init.count_local__ON__silver_extension_convenience_attributeDclSynMultiple;
	...
	public PattributeDclSynMultiple(final Object c__G_9, final Object c__G_8, final Object c_a, final Object c_tl, final Object c__G_5, final Object c_te, final Object c__G_3, final Object c__G_2, final Object c_qs, final Object c__G_0, final Object a_core_location) {
	...
	public final silver.definition.core.TSynthesized_kwd getChild__G_9() {
		return (silver.definition.core.TSynthesized_kwd) (child__G_9 = common.Util.demand(child__G_9));
	}
	...
	public String getName() {
		return "silver:extension:convenience:attributeDclSynMultiple";
	}

	static void initProductionAttributeDefinitions() {
		// top.pp = "synthesized attribute " ++ a.name ++ tl.pp ++ " :: " ++ te.pp ++ " occurs on " ++ qs.pp ++ ";"
		silver.extension.convenience.PattributeDclSynMultiple.synthesizedAttributes[silver.definition.core.Init.silver_definition_env_pp__ON__silver_definition_core_AGDcl] = new common.Lazy() { public final Object eval(final common.DecoratedNode context) { return new common.StringCatter((common.StringCatter)(new common.StringCatter("synthesized attribute ")), (common.StringCatter)new common.StringCatter((common.StringCatter)((common.StringCatter)context.childDecorated(silver.extension.convenience.PattributeDclSynMultiple.i_a).synthesized(silver.definition.core.Init.silver_definition_core_name__ON__silver_definition_core_Name)), (common.StringCatter)new common.StringCatter((common.StringCatter)((common.StringCatter)context.childDecorated(silver.extension.convenience.PattributeDclSynMultiple.i_tl).synthesized(silver.definition.type.syntax.Init.silver_definition_env_pp__ON__silver_definition_type_syntax_BracketedOptTypeExprs)), (common.StringCatter)new common.StringCatter((common.StringCatter)(new common.StringCatter(" :: ")), (common.StringCatter)new common.StringCatter((common.StringCatter)((common.StringCatter)context.childDecorated(silver.extension.convenience.PattributeDclSynMultiple.i_te).synthesized(silver.definition.type.syntax.Init.silver_definition_env_pp__ON__silver_definition_type_syntax_TypeExpr)), (common.StringCatter)new common.StringCatter((common.StringCatter)(new common.StringCatter(" occurs on ")), (common.StringCatter)new common.StringCatter((common.StringCatter)((common.StringCatter)context.childDecorated(silver.extension.convenience.PattributeDclSynMultiple.i_qs).synthesized(silver.extension.convenience.Init.silver_definition_env_pp__ON__silver_extension_convenience_QNames)), (common.StringCatter)(new common.StringCatter(";"))))))))); } };

	}

	public static final common.NodeFactory<PattributeDclSynMultiple> factory = new Factory();

	public static final class Factory extends common.NodeFactory<PattributeDclSynMultiple> {

		@Override
		public PattributeDclSynMultiple invoke(final Object[] children, final Object[] annotations) {
			return new PattributeDclSynMultiple(children[0], children[1], children[2], children[3], children[4], children[5], children[6], children[7], children[8], children[9], annotations[0]);
		}
	};
