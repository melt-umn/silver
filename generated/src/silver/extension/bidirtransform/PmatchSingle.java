...
else if(scrutineeNode instanceof silver.extension.patternmatching.PwildcPattern) { final common.Thunk<Object> __SV_LOCAL___pv12854___sv_tmp_pv_12855 = new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return (silver.definition.core.TUnderScore_t)scrutinee.childAsIs(0); } };
 return (silver.definition.core.NExpr)context.childDecorated(silver.extension.bidirtransform.PmatchSingle.i_ifTrue).undecorate(); }if(!scrutineeIter.undecorate().hasForward()) break;scrutineeIter = scrutineeIter.forward();}return ((silver.definition.core.NExpr)(__SV_LOCAL_12848___fail_12849.eval()));}}.eval(context, (common.DecoratedNode)context.childDecorated(silver.extension.bidirtransform.PmatchSingle.i_arg)); } }).eval());
	}
