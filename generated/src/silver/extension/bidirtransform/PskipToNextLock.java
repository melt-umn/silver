...
public final class PskipToNextLock extends common.FunctionNode {
	...
	public static common.ConsCell invoke(final Object c_fnnt, final Object c_dfs, final Object c_skipGrammar) {
		...
		return (common.ConsCell)(new common.PatternLazy<common.DecoratedNode, common.ConsCell>() { public final common.ConsCell eval(final common.DecoratedNode context, common.DecoratedNode scrutineeIter) {while(true) {final common.DecoratedNode scrutinee = scrutineeIter; final common.Node scrutineeNode = scrutinee.undecorate(); if(scrutineeNode instanceof silver.definition.env.PconsDefs) { final common.Thunk<Object> __SV_LOCAL___pv13271___sv_pv_13272_d = new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return (common.DecoratedNode)scrutinee.childDecorated(0); } };
final common.Thunk<Object> __SV_LOCAL___pv13273___sv_pv_13270_dfs2 = new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return (common.DecoratedNode)scrutinee.childDecorated(1); } };
 return (common.ConsCell)((common.ConsCell)(new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { final common.Thunk<Object> __SV_LOCAL_13274_dfs2 = new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((common.DecoratedNode)(__SV_LOCAL___pv13273___sv_pv_13270_dfs2.eval())); } };
return ((common.ConsCell)(new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { final common.Thunk<Object> __SV_LOCAL_13275_d = new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((common.DecoratedNode)(__SV_LOCAL___pv13271___sv_pv_13272_d.eval())); } };
return (((Boolean)((common.DecoratedNode)(__SV_LOCAL_13275_d.eval())).synthesized(silver.extension.bidirtransform.Init.silver_extension_bidirtransform_isLock__ON__silver_definition_env_Def)) ? ((common.ConsCell)silver.extension.bidirtransform.PgetProdsFromDefs.invoke(context.childAsIsLazy(silver.extension.bidirtransform.PskipToNextLock.i_fnnt), common.Thunk.transformUndecorate(__SV_LOCAL_13274_dfs2), context.childAsIsLazy(silver.extension.bidirtransform.PskipToNextLock.i_skipGrammar))) : ((common.ConsCell)silver.extension.bidirtransform.PskipToNextLock.invoke(context.childAsIsLazy(silver.extension.bidirtransform.PskipToNextLock.i_fnnt), common.Thunk.transformUndecorate(__SV_LOCAL_13274_dfs2), context.childAsIsLazy(silver.extension.bidirtransform.PskipToNextLock.i_skipGrammar)))); } }).eval()); } }).eval()); }
