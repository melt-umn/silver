...
public final class PannoOn extends silver.definition.core.NAGDcl {
  ...
  public final silver.extension.convenience.NQNameWithTL invoke(final Object[] args, final Object[] namedArgs) {
    final Object __SV_LAMBDA_PARAM_10445_s = args[0];

    return ((silver.extension.convenience.NQNameWithTL)new silver.extension.convenience.PqNameWithTL(new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((silver.definition.core.NQName)silver.definition.core.PqName.invoke(new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((core.NLocation)((silver.definition.core.NAGDcl)context.undecorate()).getAnno_core_location()); } }, ((common.StringCatter)common.Util.demand(__SV_LAMBDA_PARAM_10445_s)))); } }, new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((silver.definition.type.syntax.NBracketedOptTypeExprs)new silver.definition.type.syntax.PbotlNone(new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((core.NLocation)((silver.definition.core.NAGDcl)context.undecorate()).getAnno_core_location()); } })); } }));
  }
