...
public final class PgetProdsFromDefs extends common.FunctionNode {
	...
	public static common.ConsCell invoke(final Object c_fnnt, final Object c_dfs, final Object c_skipGrammar) {
		...
		return (common.ConsCell)(new common.PatternLazy<common.DecoratedNode, common.ConsCell>() { public final common.ConsCell eval(final common.DecoratedNode context, common.DecoratedNode scrutineeIter) {while(true) {final common.DecoratedNode scrutinee = scrutineeIter; final common.Node scrutineeNode = scrutinee.undecorate(); if(scrutineeNode instanceof silver.definition.env.PconsDefs) { final common.Thunk<Object> __SV_LOCAL___pv13272___sv_pv_13273_d = new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return (common.DecoratedNode)scrutinee.childDecorated(0); } };
final common.Thunk<Object> __SV_LOCAL___pv13274___sv_pv_13271_dfs2 = new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return (common.DecoratedNode)scrutinee.childDecorated(1); } };
 return (common.ConsCell)((common.ConsCell)(new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { final common.Thunk<Object> __SV_LOCAL_13275_dfs2 = new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((common.DecoratedNode)(__SV_LOCAL___pv13274___sv_pv_13271_dfs2.eval())); } };
return ((common.ConsCell)(new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { final common.Thunk<Object> __SV_LOCAL_13276_d = new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((common.DecoratedNode)(__SV_LOCAL___pv13272___sv_pv_13273_d.eval())); } };
return ((common.ConsCell)silver.extension.bidirtransform.PgetProdsFromConsDefs.invoke(context.childAsIsLazy(silver.extension.bidirtransform.PgetProdsFromDefs.i_fnnt), common.Thunk.transformUndecorate(__SV_LOCAL_13276_d), common.Thunk.transformUndecorate(__SV_LOCAL_13275_dfs2), context.childAsIsLazy(silver.extension.bidirtransform.PgetProdsFromDefs.i_skipGrammar))); } }).eval()); } }).eval()); }
