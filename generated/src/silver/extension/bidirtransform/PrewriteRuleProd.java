...
public final class PrewriteRuleProd extends silver.extension.bidirtransform.NRewriteRule {
	...
	public static final Class<?> childTypes[] = {silver.extension.bidirtransform.NRewriteProduction.class,silver.extension.patternmatching.TArrow_kwd.class,silver.definition.core.NExpr.class};
	...
	public PrewriteRuleProd(final Object c_prd, final Object c__G_1, final Object c_e, final Object a_core_location) {
	...
	public common.Node evalForward(final common.DecoratedNode context) {
		return ((silver.extension.bidirtransform.NRewriteRule)new silver.extension.bidirtransform.PrewriteRule(common.Thunk.transformUndecorate(context.childDecoratedLazy(silver.extension.bidirtransform.PrewriteRuleProd.i_e)), (new common.StringCatter("")), context.childDecoratedSynthesizedLazy(silver.extension.bidirtransform.PrewriteRuleProd.i_prd, silver.extension.bidirtransform.Init.silver_definition_env_typerep__ON__silver_extension_bidirtransform_RewriteProduction), context.childDecoratedSynthesizedLazy(silver.extension.bidirtransform.PrewriteRuleProd.i_e, silver.definition.core.Init.silver_definition_env_typerep__ON__silver_definition_core_Expr), common.Thunk.transformUndecorate(context.childDecoratedLazy(silver.extension.bidirtransform.PrewriteRuleProd.i_prd)), true, false, new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((core.NLocation)((silver.extension.bidirtransform.NRewriteRule)context.undecorate()).getAnno_core_location()); } }));
	}
