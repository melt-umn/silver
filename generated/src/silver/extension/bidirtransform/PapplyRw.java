...
public final class PapplyRw extends silver.definition.core.NExpr {
	...
	public common.Node evalForward(final common.DecoratedNode context) {
		return ((silver.definition.core.NExpr)new silver.extension.bidirtransform.PapplyRwOrigin(context.childAsIsLazy(silver.extension.bidirtransform.PapplyRw.i_rwr), context.childAsIsLazy(silver.extension.bidirtransform.PapplyRw.i_rhsTy), context.childAsIsLazy(silver.extension.bidirtransform.PapplyRw.i_lhsTy), context.childAsIsLazy(silver.extension.bidirtransform.PapplyRw.i_elemName), context.childAsIsLazy(silver.extension.bidirtransform.PapplyRw.i_elemName), new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((core.NLocation)((silver.definition.core.NExpr)context.undecorate()).getAnno_core_location()); } }));
	}
