...
public final class PmatchAppExpToPattern extends common.FunctionNode {
	...
	public static core.NPair invoke(final Object c_appexp, final Object c_pattern) {
		...
		//case appexp of missingAppExpr(_) -> pair([], []) | presentAppExpr(e) -> matchExpToPattern(e, pattern) end
		return (core.NPair)(new common.PatternLazy<common.DecoratedNode, core.NPair>() { public final core.NPair eval(final common.DecoratedNode context, common.DecoratedNode scrutineeIter) {while(true) {final common.DecoratedNode scrutinee = scrutineeIter; final common.Node scrutineeNode = scrutinee.undecorate(); if(scrutineeNode instanceof silver.definition.core.PmissingAppExpr) { final common.Thunk<Object> __SV_LOCAL___pv12221___sv_tmp_pv_12222 = new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return (silver.definition.core.TUnderScore_t)scrutinee.childAsIs(0); } };
...
else if(scrutineeNode instanceof silver.definition.core.PpresentAppExpr) { final common.Thunk<Object> __SV_LOCAL___pv12224___sv_pv_12223_e = new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return (common.DecoratedNode)scrutinee.childDecorated(0); } };
 return (core.NPair)((core.NPair)(new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { final common.Thunk<Object> __SV_LOCAL_12225_e = new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((common.DecoratedNode)(__SV_LOCAL___pv12224___sv_pv_12223_e.eval())); } };
return ((core.NPair)silver.extension.bidirtransform.PmatchExpToPattern.invoke(common.Thunk.transformUndecorate(__SV_LOCAL_12225_e), common.Thunk.transformUndecorate(context.childDecoratedLazy(silver.extension.bidirtransform.PmatchAppExpToPattern.i_pattern)))); } }).eval()); }if(!scrutineeIter.undecorate().hasForward()) break;scrutineeIter = scrutineeIter.forward();}return ((core.NPair)core.Perror.invoke((new common.StringCatter("Error: pattern match failed at silver:extension:bidirtransform 'HelpFills.sv', 161, 11, 164, 7, 6548, 6675\n"))));}}.eval(context, (common.DecoratedNode)context.childDecorated(silver.extension.bidirtransform.PmatchAppExpToPattern.i_appexp)));
