...
public final class PrewriteRuleCons extends silver.extension.bidirtransform.NRewriteRuleList {
	...
	static void initProductionAttributeDefinitions() {
		// l.config = rrl.config
		silver.extension.bidirtransform.PrewriteRuleCons.childInheritedAttributes[silver.extension.bidirtransform.PrewriteRuleCons.i_l][silver.extension.bidirtransform.Init.silver_definition_env_config__ON__silver_extension_bidirtransform_RewriteRule] = new common.Lazy() { public final Object eval(final common.DecoratedNode context) { return ((common.DecoratedNode)context.inherited(silver.extension.bidirtransform.Init.silver_definition_env_config__ON__silver_extension_bidirtransform_RewriteRuleList)); } };
		// r.config = rrl.config
		silver.extension.bidirtransform.PrewriteRuleCons.childInheritedAttributes[silver.extension.bidirtransform.PrewriteRuleCons.i_r][silver.extension.bidirtransform.Init.silver_definition_env_config__ON__silver_extension_bidirtransform_RewriteRuleList] = new common.Lazy() { public final Object eval(final common.DecoratedNode context) { return ((common.DecoratedNode)context.inherited(silver.extension.bidirtransform.Init.silver_definition_env_config__ON__silver_extension_bidirtransform_RewriteRuleList)); } };
		// l.env = rrl.env
		silver.extension.bidirtransform.PrewriteRuleCons.childInheritedAttributes[silver.extension.bidirtransform.PrewriteRuleCons.i_l][silver.extension.bidirtransform.Init.silver_definition_env_env__ON__silver_extension_bidirtransform_RewriteRule] = new common.Lazy() { public final Object eval(final common.DecoratedNode context) { return ((common.DecoratedNode)context.inherited(silver.extension.bidirtransform.Init.silver_definition_env_env__ON__silver_extension_bidirtransform_RewriteRuleList)); } };
		// r.env = rrl.env
		silver.extension.bidirtransform.PrewriteRuleCons.childInheritedAttributes[silver.extension.bidirtransform.PrewriteRuleCons.i_r][silver.extension.bidirtransform.Init.silver_definition_env_env__ON__silver_extension_bidirtransform_RewriteRuleList] = new common.Lazy() { public final Object eval(final common.DecoratedNode context) { return ((common.DecoratedNode)context.inherited(silver.extension.bidirtransform.Init.silver_definition_env_env__ON__silver_extension_bidirtransform_RewriteRuleList)); } };
