...
public final class PautocAttr extends silver.definition.core.NAGDcl {
	...
	public static final int num_local_attrs = Init.count_local__ON__silver_extension_bidirtransform_autocAttr;
	...
	public PautocAttr(final Object c_nme, final Object c_tyexpr, final Object a_core_location) {
	...
	public String getName() {
		return "silver:extension:bidirtransform:autocAttr";
	}
	...
	public static final common.NodeFactory<PautocAttr> factory = new Factory();

	public static final class Factory extends common.NodeFactory<PautocAttr> {

		@Override
		public PautocAttr invoke(final Object[] children, final Object[] annotations) {
			return new PautocAttr(children[0], children[1], annotations[0]);
		}
	};
