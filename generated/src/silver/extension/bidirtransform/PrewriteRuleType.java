...
public final class PrewriteRuleType extends silver.extension.bidirtransform.NRewriteRule {
	...
	static void initProductionAttributeDefinitions() {
		...
		silver.extension.bidirtransform.PrewriteRuleType.localAttributes[silver.extension.bidirtransform.Init.rhsType__ON__silver_extension_bidirtransform_rewriteRuleType] = new common.Lazy() { public final Object eval(final common.DecoratedNode context) { return new common.PatternLazy<common.DecoratedNode, silver.definition.type.NType>() { public final silver.definition.type.NType eval(final common.DecoratedNode context, common.DecoratedNode scrutineeIter) {while(true) {final common.DecoratedNode scrutinee = scrutineeIter; final common.Node scrutineeNode = scrutinee.undecorate(); if(scrutineeNode instanceof core.Pjust) { final common.Thunk<Object> __SV_LOCAL___pv12456___sv_pv_12455_t = new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return (silver.definition.type.syntax.NTypeExpr)scrutinee.childAsIs(0); } };
 return (silver.definition.type.NType)((silver.definition.type.NType)(new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { final common.Thunk<Object> __SV_LOCAL_12457_t = new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((silver.definition.type.syntax.NTypeExpr)(__SV_LOCAL___pv12456___sv_pv_12455_t.eval())); } };
return ((silver.definition.type.NType)((silver.definition.type.syntax.NTypeExpr)(__SV_LOCAL_12457_t.eval())).decorate(context, (common.Lazy[])null).synthesized(silver.definition.type.syntax.Init.silver_definition_env_typerep__ON__silver_definition_type_syntax_TypeExpr)); } }).eval()); }
