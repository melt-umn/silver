...
public final class PmkMaybeString extends silver.definition.type.syntax.NTypeExpr {
	...
	public static final int num_local_attrs = Init.count_local__ON__silver_extension_bidirtransform_mkMaybeString;
	...
	public PmkMaybeString(final Object c_inner, final Object a_core_location) {
	...
	public String getName() {
		return "silver:extension:bidirtransform:mkMaybeString";
	}
	...
	public static final common.NodeFactory<PmkMaybeString> factory = new Factory();

	public static final class Factory extends common.NodeFactory<PmkMaybeString> {

		@Override
		public PmkMaybeString invoke(final Object[] children, final Object[] annotations) {
			return new PmkMaybeString(children[0], annotations[0]);
		}
	};
