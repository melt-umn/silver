...
public final class PmkAspectProdSigDec extends silver.definition.core.NAspectProductionSignature {
	...
	public static final int num_local_attrs = Init.count_local__ON__silver_extension_bidirtransform_mkAspectProdSigDec;
	...
	public PmkAspectProdSigDec(final Object c_lhsName, final Object c_lhsType, final Object c_rhsName, final Object c_rhsType, final Object a_core_location) {
	...
	public String getName() {
		return "silver:extension:bidirtransform:mkAspectProdSigDec";
	}
	...
	public static final common.NodeFactory<PmkAspectProdSigDec> factory = new Factory();

	public static final class Factory extends common.NodeFactory<PmkAspectProdSigDec> {

		@Override
		public PmkAspectProdSigDec invoke(final Object[] children, final Object[] annotations) {
			return new PmkAspectProdSigDec(children[0], children[1], children[2], children[3], annotations[0]);
		}
	};
