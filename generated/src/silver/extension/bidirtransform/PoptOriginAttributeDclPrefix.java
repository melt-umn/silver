...
public final class PoptOriginAttributeDclPrefix extends silver.definition.core.NAGDcl {
	...
	static void initProductionAttributeDefinitions() {
		...
		// top.moduleNames = []
		silver.extension.bidirtransform.PoptOriginAttributeDclPrefix.synthesizedAttributes[silver.definition.core.Init.silver_definition_env_moduleNames__ON__silver_definition_core_AGDcl] = new common.Lazy() { public final Object eval(final common.DecoratedNode context) { return ((common.ConsCell)core.Pnil.invoke()); } };
		// top.mdaSpecs = []
		silver.extension.bidirtransform.PoptOriginAttributeDclPrefix.synthesizedAttributes[silver.modification.copper_mda.Init.silver_modification_copper_mda_mdaSpecs__ON__silver_definition_core_AGDcl] = new common.Lazy() { public final Object eval(final common.DecoratedNode context) { return ((common.ConsCell)core.Pnil.invoke()); } };
