...
public final class PhasRwMatch extends common.FunctionNode {
	...
	public static Boolean invoke(final Object c_rwrs, final Object c_outType, final Object c_ns) {
		...
		//hasRwProd(rwrs, outType, ns) || hasRwID(rwrs, unFull(ns.typerep.typeName), unFull(outType))
		return (Boolean)((((Boolean)silver.extension.bidirtransform.PhasRwProd.invoke(context.childAsIsLazy(silver.extension.bidirtransform.PhasRwMatch.i_rwrs), context.childAsIsLazy(silver.extension.bidirtransform.PhasRwMatch.i_outType), context.childAsIsLazy(silver.extension.bidirtransform.PhasRwMatch.i_ns))) || ((Boolean)silver.extension.bidirtransform.PhasRwID.invoke(context.childAsIsLazy(silver.extension.bidirtransform.PhasRwMatch.i_rwrs), new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((common.StringCatter)silver.extension.bidirtransform.PunFull.invoke(new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((common.StringCatter)((silver.definition.type.NType)((common.DecoratedNode)context.childAsIs(silver.extension.bidirtransform.PhasRwMatch.i_ns)).synthesized(silver.definition.env.Init.silver_definition_env_typerep__ON__silver_definition_env_NamedSignature)).decorate(context, (common.Lazy[])null).synthesized(silver.definition.env.Init.silver_definition_env_typeName__ON__silver_definition_type_Type)); } })); } }, new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((common.StringCatter)silver.extension.bidirtransform.PunFull.invoke(context.childAsIsLazy(silver.extension.bidirtransform.PhasRwMatch.i_outType))); } }))));
