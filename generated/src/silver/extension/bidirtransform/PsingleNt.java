...
public final class PsingleNt extends silver.extension.bidirtransform.NNonterminalList {
	...
	static void initProductionAttributeDefinitions() {
		...
		// fnt.env = top.env
		silver.extension.bidirtransform.PsingleNt.childInheritedAttributes[silver.extension.bidirtransform.PsingleNt.i_fnt][silver.extension.bidirtransform.Init.silver_definition_env_env__ON__silver_extension_bidirtransform_FullNonterminal] = new common.Lazy() { public final Object eval(final common.DecoratedNode context) { return ((common.DecoratedNode)context.inherited(silver.extension.bidirtransform.Init.silver_definition_env_env__ON__silver_extension_bidirtransform_NonterminalList)); } };
