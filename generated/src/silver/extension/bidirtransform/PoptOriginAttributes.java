...
public final class PoptOriginAttributes extends silver.definition.core.NAGDcl {
	...
	static void initProductionAttributeDefinitions() {
		...
		silver.extension.bidirtransform.PoptOriginAttributes.localAttributes[silver.extension.bidirtransform.Init.qnsTail__ON__silver_extension_bidirtransform_optOriginAttributes] = new common.Lazy() { public final Object eval(final common.DecoratedNode context) { return new common.PatternLazy<common.DecoratedNode, silver.extension.bidirtransform.NQNameList>() { public final silver.extension.bidirtransform.NQNameList eval(final common.DecoratedNode context, common.DecoratedNode scrutineeIter) {while(true) {final common.DecoratedNode scrutinee = scrutineeIter; final common.Node scrutineeNode = scrutinee.undecorate(); if(scrutineeNode instanceof silver.extension.bidirtransform.PqNameListCons) { final common.Thunk<Object> __SV_LOCAL___pv12649___sv_tmp_pv_12650 = new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return (common.DecoratedNode)scrutinee.childDecorated(0); } };
final common.Thunk<Object> __SV_LOCAL___pv12651___sv_tmp_pv_12652 = new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return (silver.definition.core.TComma_t)scrutinee.childAsIs(1); } };
final common.Thunk<Object> __SV_LOCAL___pv12653___sv_pv_12648_tl = new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return (common.DecoratedNode)scrutinee.childDecorated(2); } };
 return (silver.extension.bidirtransform.NQNameList)((silver.extension.bidirtransform.NQNameList)(new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { final common.Thunk<Object> __SV_LOCAL_12654_tl = new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((common.DecoratedNode)(__SV_LOCAL___pv12653___sv_pv_12648_tl.eval())); } };
return ((silver.extension.bidirtransform.NQNameList)((common.DecoratedNode)__SV_LOCAL_12654_tl.eval()).undecorate()); } }).eval()); }if(!scrutineeIter.undecorate().hasForward()) break;scrutineeIter = scrutineeIter.forward();}return ((silver.extension.bidirtransform.NQNameList)core.Perror.invoke((new common.StringCatter("Error: pattern match failed at silver:extension:bidirtransform 'OriginsAttrs.sv', 101, 31, 101, 74, 3304, 3347\n"))));}}.eval(context, (common.DecoratedNode)context.childDecorated(silver.extension.bidirtransform.PoptOriginAttributes.i_qns)); } };
