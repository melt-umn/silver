...
public final class PproductionDef extends silver.extension.bidirtransform.NProductionDef {
	...
	static void initProductionAttributeDefinitions() {
		...
		silver.extension.bidirtransform.PproductionDef.childInheritedAttributes[silver.extension.bidirtransform.PproductionDef.i_args][silver.extension.patternmatching.Init.silver_definition_env_config__ON__silver_extension_patternmatching_PatternList] = new common.Lazy() { public final Object eval(final common.DecoratedNode context) { return ((common.DecoratedNode)context.inherited(silver.extension.bidirtransform.Init.silver_definition_env_config__ON__silver_extension_bidirtransform_ProductionDef)); } };
		// args.env = pd.env
		silver.extension.bidirtransform.PproductionDef.childInheritedAttributes[silver.extension.bidirtransform.PproductionDef.i_args][silver.extension.patternmatching.Init.silver_definition_env_env__ON__silver_extension_patternmatching_PatternList] = new common.Lazy() { public final Object eval(final common.DecoratedNode context) { return ((common.DecoratedNode)context.inherited(silver.extension.bidirtransform.Init.silver_definition_env_env__ON__silver_extension_bidirtransform_ProductionDef)); } };
		// absSig = getProdFromGroup(qn.name, pd.absGroup)
		silver.extension.bidirtransform.PproductionDef.localAttributes[silver.extension.bidirtransform.Init.absSig__ON__silver_extension_bidirtransform_productionDef] = new common.Lazy() { public final Object eval(final common.DecoratedNode context) { return ((common.ConsCell)silver.extension.bidirtransform.PgetProdFromGroup.invoke(context.childDecoratedSynthesizedLazy(silver.extension.bidirtransform.PproductionDef.i_qn, silver.definition.core.Init.silver_definition_core_name__ON__silver_definition_core_QName), context.contextInheritedLazy(silver.extension.bidirtransform.Init.silver_extension_bidirtransform_absGroup__ON__silver_extension_bidirtransform_ProductionDef))); } };
		// cncSig = getProdFromGroup(qn.name, pd.cncGroup)
		silver.extension.bidirtransform.PproductionDef.localAttributes[silver.extension.bidirtransform.Init.cncSig__ON__silver_extension_bidirtransform_productionDef] = new common.Lazy() { public final Object eval(final common.DecoratedNode context) { return ((common.ConsCell)silver.extension.bidirtransform.PgetProdFromGroup.invoke(context.childDecoratedSynthesizedLazy(silver.extension.bidirtransform.PproductionDef.i_qn, silver.definition.core.Init.silver_definition_core_name__ON__silver_definition_core_QName), context.contextInheritedLazy(silver.extension.bidirtransform.Init.silver_extension_bidirtransform_cncGroup__ON__silver_extension_bidirtransform_ProductionDef))); } };
		// pd.namedSig = if length(absSig) != 0 then head(absSig) else head(cncSig)
		silver.extension.bidirtransform.PproductionDef.synthesizedAttributes[silver.extension.bidirtransform.Init.silver_extension_bidirtransform_namedSig__ON__silver_extension_bidirtransform_ProductionDef] = new common.Lazy() { public final Object eval(final common.DecoratedNode context) { return (!((Integer)core.PlistLength.invoke(context.localAsIsLazy(silver.extension.bidirtransform.Init.absSig__ON__silver_extension_bidirtransform_productionDef))).equals(Integer.valueOf((int)0)) ? ((common.DecoratedNode)core.Phead.invoke(context.localAsIsLazy(silver.extension.bidirtransform.Init.absSig__ON__silver_extension_bidirtransform_productionDef))) : ((common.DecoratedNode)core.Phead.invoke(context.localAsIsLazy(silver.extension.bidirtransform.Init.cncSig__ON__silver_extension_bidirtransform_productionDef)))); } };
