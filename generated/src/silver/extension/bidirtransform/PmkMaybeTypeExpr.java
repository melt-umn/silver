...
public final class PmkMaybeTypeExpr extends silver.definition.type.syntax.NTypeExpr {
	...
	static {
	childInheritedAttributes[i_inner] = new common.Lazy[silver.definition.type.syntax.NTypeExpr.num_inh_attrs];
	...
	public final silver.definition.type.syntax.NTypeExpr getChild_inner() {
		return (silver.definition.type.syntax.NTypeExpr) (child_inner = common.Util.demand(child_inner));
	}
