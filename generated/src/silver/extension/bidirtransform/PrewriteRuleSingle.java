...
public final class PrewriteRuleSingle extends silver.extension.bidirtransform.NRewriteRuleList {
	...
	static void initProductionAttributeDefinitions() {
		...
		silver.extension.bidirtransform.PrewriteRuleSingle.childInheritedAttributes[silver.extension.bidirtransform.PrewriteRuleSingle.i_rule][silver.extension.bidirtransform.Init.silver_definition_env_config__ON__silver_extension_bidirtransform_RewriteRule] = new common.Lazy() { public final Object eval(final common.DecoratedNode context) { return ((common.DecoratedNode)context.inherited(silver.extension.bidirtransform.Init.silver_definition_env_config__ON__silver_extension_bidirtransform_RewriteRuleList)); } };
		// rule.env = rrl.env
		silver.extension.bidirtransform.PrewriteRuleSingle.childInheritedAttributes[silver.extension.bidirtransform.PrewriteRuleSingle.i_rule][silver.extension.bidirtransform.Init.silver_definition_env_env__ON__silver_extension_bidirtransform_RewriteRule] = new common.Lazy() { public final Object eval(final common.DecoratedNode context) { return ((common.DecoratedNode)context.inherited(silver.extension.bidirtransform.Init.silver_definition_env_env__ON__silver_extension_bidirtransform_RewriteRuleList)); } };
