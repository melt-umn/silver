...
public final class PdclQName extends common.FunctionNode {
  ...
  public final silver.definition.core.NQName invoke(final Object[] args, final Object[] namedArgs) {
    final Object __SV_LAMBDA_PARAM_13786_s = args[0];

    return ((silver.definition.core.NQName)silver.definition.core.PqName.invoke(common.Thunk.transformUndecorate(context.childDecoratedLazy(silver.extension.bidirtransform.PdclQName.i_loc)), ((common.StringCatter)common.Util.demand(__SV_LAMBDA_PARAM_13786_s))));
  }
}));
