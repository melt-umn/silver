...
public final class PmkProdSigDec extends silver.definition.core.NProductionSignature {
	...
	public static final int num_local_attrs = Init.count_local__ON__silver_extension_bidirtransform_mkProdSigDec;
	...
	public PmkProdSigDec(final Object c_lhsName, final Object c_lhsType, final Object c_rhsName, final Object c_rhsType, final Object a_core_location) {
	...
	public String getName() {
		return "silver:extension:bidirtransform:mkProdSigDec";
	}
	...
	public static final common.NodeFactory<PmkProdSigDec> factory = new Factory();

	public static final class Factory extends common.NodeFactory<PmkProdSigDec> {

		@Override
		public PmkProdSigDec invoke(final Object[] children, final Object[] annotations) {
			return new PmkProdSigDec(children[0], children[1], children[2], children[3], annotations[0]);
		}
	};
