...
public class Init{
	...
	private static void setupInheritedAttributes(){
		...
		silver.extension.bidirtransform.PdeclareTNameAttributes.occurs_local[silver.extension.bidirtransform.Init.tName__ON__silver_extension_bidirtransform_declareTNameAttributes] = "silver:extension:bidirtransform:declareTNameAttributes:local:tName";
		silver.extension.bidirtransform.PdeclareTNameAttributes.occurs_local[silver.extension.bidirtransform.Init.inhRedexName__ON__silver_extension_bidirtransform_declareTNameAttributes] = "silver:extension:bidirtransform:declareTNameAttributes:local:inhRedexName";
		//	local attribute agDcls::AGDcl;
		silver.extension.bidirtransform.PdeclareTNameAttributes.localInheritedAttributes[silver.extension.bidirtransform.Init.agDcls__ON__silver_extension_bidirtransform_declareTNameAttributes] = new common.Lazy[silver.definition.core.NAGDcl.num_inh_attrs];
		silver.extension.bidirtransform.PdeclareTNameAttributes.occurs_local[silver.extension.bidirtransform.Init.agDcls__ON__silver_extension_bidirtransform_declareTNameAttributes] = "silver:extension:bidirtransform:declareTNameAttributes:local:agDcls";
		...
		silver.extension.bidirtransform.PdeclareTNameAttributes.localInheritedAttributes[silver.extension.bidirtransform.Init.agDcls3__ON__silver_extension_bidirtransform_declareTNameAttributes] = new common.Lazy[silver.definition.core.NAGDcl.num_inh_attrs];
		silver.extension.bidirtransform.PdeclareTNameAttributes.occurs_local[silver.extension.bidirtransform.Init.agDcls3__ON__silver_extension_bidirtransform_declareTNameAttributes] = "silver:extension:bidirtransform:declareTNameAttributes:local:agDcls3";
		//	local attribute agDcls4::AGDcl;
		silver.extension.bidirtransform.PdeclareTNameAttributes.localInheritedAttributes[silver.extension.bidirtransform.Init.agDcls4__ON__silver_extension_bidirtransform_declareTNameAttributes] = new common.Lazy[silver.definition.core.NAGDcl.num_inh_attrs];
		silver.extension.bidirtransform.PdeclareTNameAttributes.occurs_local[silver.extension.bidirtransform.Init.agDcls4__ON__silver_extension_bidirtransform_declareTNameAttributes] = "silver:extension:bidirtransform:declareTNameAttributes:local:agDcls4";
		//	local attribute agDcls5::AGDcl;
		silver.extension.bidirtransform.PdeclareTNameAttributes.localInheritedAttributes[silver.extension.bidirtransform.Init.agDcls5__ON__silver_extension_bidirtransform_declareTNameAttributes] = new common.Lazy[silver.definition.core.NAGDcl.num_inh_attrs];
		silver.extension.bidirtransform.PdeclareTNameAttributes.occurs_local[silver.extension.bidirtransform.Init.agDcls5__ON__silver_extension_bidirtransform_declareTNameAttributes] = "silver:extension:bidirtransform:declareTNameAttributes:local:agDcls5";
		//	local attribute agDcls6::AGDcl;
		silver.extension.bidirtransform.PdeclareTNameAttributes.localInheritedAttributes[silver.extension.bidirtransform.Init.agDcls6__ON__silver_extension_bidirtransform_declareTNameAttributes] = new common.Lazy[silver.definition.core.NAGDcl.num_inh_attrs];
		silver.extension.bidirtransform.PdeclareTNameAttributes.occurs_local[silver.extension.bidirtransform.Init.agDcls6__ON__silver_extension_bidirtransform_declareTNameAttributes] = "silver:extension:bidirtransform:declareTNameAttributes:local:agDcls6";
		//	local attribute agDcls7::AGDcl;
		silver.extension.bidirtransform.PdeclareTNameAttributes.localInheritedAttributes[silver.extension.bidirtransform.Init.agDcls7__ON__silver_extension_bidirtransform_declareTNameAttributes] = new common.Lazy[silver.definition.core.NAGDcl.num_inh_attrs];
		silver.extension.bidirtransform.PdeclareTNameAttributes.occurs_local[silver.extension.bidirtransform.Init.agDcls7__ON__silver_extension_bidirtransform_declareTNameAttributes] = "silver:extension:bidirtransform:declareTNameAttributes:local:agDcls7";
		//	local attribute agDcls8::AGDcl;
		silver.extension.bidirtransform.PdeclareTNameAttributes.localInheritedAttributes[silver.extension.bidirtransform.Init.agDcls8__ON__silver_extension_bidirtransform_declareTNameAttributes] = new common.Lazy[silver.definition.core.NAGDcl.num_inh_attrs];
		silver.extension.bidirtransform.PdeclareTNameAttributes.occurs_local[silver.extension.bidirtransform.Init.agDcls8__ON__silver_extension_bidirtransform_declareTNameAttributes] = "silver:extension:bidirtransform:declareTNameAttributes:local:agDcls8";
		...
		//	local attribute qnsTail::QNameList;
		silver.extension.bidirtransform.PoptOriginAttributes.localInheritedAttributes[silver.extension.bidirtransform.Init.qnsTail__ON__silver_extension_bidirtransform_optOriginAttributes] = new common.Lazy[silver.extension.bidirtransform.NQNameList.num_inh_attrs];
		silver.extension.bidirtransform.PoptOriginAttributes.occurs_local[silver.extension.bidirtransform.Init.qnsTail__ON__silver_extension_bidirtransform_optOriginAttributes] = "silver:extension:bidirtransform:optOriginAttributes:local:qnsTail";
...
public static final int tName__ON__silver_extension_bidirtransform_declareTNameAttributes = silver.extension.bidirtransform.Init.count_local__ON__silver_extension_bidirtransform_declareTNameAttributes++;
public static final int inhRedexName__ON__silver_extension_bidirtransform_declareTNameAttributes = silver.extension.bidirtransform.Init.count_local__ON__silver_extension_bidirtransform_declareTNameAttributes++;
public static final int agDcls__ON__silver_extension_bidirtransform_declareTNameAttributes = silver.extension.bidirtransform.Init.count_local__ON__silver_extension_bidirtransform_declareTNameAttributes++;
...
public static final int agDcls3__ON__silver_extension_bidirtransform_declareTNameAttributes = silver.extension.bidirtransform.Init.count_local__ON__silver_extension_bidirtransform_declareTNameAttributes++;
public static final int agDcls4__ON__silver_extension_bidirtransform_declareTNameAttributes = silver.extension.bidirtransform.Init.count_local__ON__silver_extension_bidirtransform_declareTNameAttributes++;
public static final int agDcls5__ON__silver_extension_bidirtransform_declareTNameAttributes = silver.extension.bidirtransform.Init.count_local__ON__silver_extension_bidirtransform_declareTNameAttributes++;
public static final int agDcls6__ON__silver_extension_bidirtransform_declareTNameAttributes = silver.extension.bidirtransform.Init.count_local__ON__silver_extension_bidirtransform_declareTNameAttributes++;
public static final int agDcls7__ON__silver_extension_bidirtransform_declareTNameAttributes = silver.extension.bidirtransform.Init.count_local__ON__silver_extension_bidirtransform_declareTNameAttributes++;
public static final int agDcls8__ON__silver_extension_bidirtransform_declareTNameAttributes = silver.extension.bidirtransform.Init.count_local__ON__silver_extension_bidirtransform_declareTNameAttributes++;
...
public static final int qnsTail__ON__silver_extension_bidirtransform_optOriginAttributes = silver.extension.bidirtransform.Init.count_local__ON__silver_extension_bidirtransform_optOriginAttributes++;
