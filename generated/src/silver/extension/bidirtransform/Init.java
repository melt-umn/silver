...
public class Init{
	...
	public static void postInit(){
		...
		common.Decorator.applyDecorators(silver.extension.bidirtransform.NTransformRule.decorators, PgetTrans.class);
		...
		common.Decorator.applyDecorators(silver.definition.core.NExpr.decorators, PfillExprPatternHelper.class);
		...
		common.Decorator.applyDecorators(silver.definition.core.NExpr.decorators, PidxOf.class);
		...
		common.Decorator.applyDecorators(silver.extension.bidirtransform.NRewriteRule.decorators, PrewriteRuleRestoreProd.class);
		common.Decorator.applyDecorators(silver.extension.bidirtransform.NRewriteRule.decorators, PrewriteRuleType.class);
		common.Decorator.applyDecorators(silver.extension.bidirtransform.NRewriteRule.decorators, PrewriteRuleRestoreType.class);
		...
		common.Decorator.applyDecorators(silver.definition.core.NAGDcls.decorators, PoriginAttributeDcl.class);
	...
	private static void setupInheritedAttributes(){
		...
		//	local attribute hd::TransformRule;
		silver.extension.bidirtransform.PhasTrans.localInheritedAttributes[silver.extension.bidirtransform.Init.hd__ON__silver_extension_bidirtransform_hasTrans] = new common.Lazy[silver.extension.bidirtransform.NTransformRule.num_inh_attrs];
		...
		silver.extension.bidirtransform.PproductionDef.occurs_local[silver.extension.bidirtransform.Init.absSig__ON__silver_extension_bidirtransform_productionDef] = "silver:extension:bidirtransform:productionDef:local:absSig";
		silver.extension.bidirtransform.PproductionDef.occurs_local[silver.extension.bidirtransform.Init.cncSig__ON__silver_extension_bidirtransform_productionDef] = "silver:extension:bidirtransform:productionDef:local:cncSig";
		...
		//	local attribute addAttrs::AGDcl;
		silver.extension.bidirtransform.PoriginAttributeDcl.localInheritedAttributes[silver.extension.bidirtransform.Init.addAttrs__ON__silver_extension_bidirtransform_originAttributeDcl] = new common.Lazy[silver.definition.core.NAGDcl.num_inh_attrs];
		silver.extension.bidirtransform.PoriginAttributeDcl.occurs_local[silver.extension.bidirtransform.Init.addAttrs__ON__silver_extension_bidirtransform_originAttributeDcl] = "silver:extension:bidirtransform:originAttributeDcl:local:addAttrs";
		//	local attribute qnsTail::QNameList;
		silver.extension.bidirtransform.PoriginAttributes.localInheritedAttributes[silver.extension.bidirtransform.Init.qnsTail__ON__silver_extension_bidirtransform_originAttributes] = new common.Lazy[silver.extension.bidirtransform.NQNameList.num_inh_attrs];
		silver.extension.bidirtransform.PoriginAttributes.occurs_local[silver.extension.bidirtransform.Init.qnsTail__ON__silver_extension_bidirtransform_originAttributes] = "silver:extension:bidirtransform:originAttributes:local:qnsTail";
		silver.extension.bidirtransform.PoriginAttribute.occurs_local[silver.extension.bidirtransform.Init.oProds__ON__silver_extension_bidirtransform_originAttribute] = "silver:extension:bidirtransform:originAttribute:local:oProds";
		...
		silver.extension.bidirtransform.PoptOriginAttribute.occurs_local[silver.extension.bidirtransform.Init.oProds__ON__silver_extension_bidirtransform_optOriginAttribute] = "silver:extension:bidirtransform:optOriginAttribute:local:oProds";
	...
	private static void initProductionAttributeDefinitions(){
		...
		//FUNCTION hasTrans Boolean ::= rules::[TransformRule] dcl::[Decorated NamedSignature] absGroup::Decorated NonterminalList cncGroup::Decorated NonterminalList 
		// hd = head(rules)
		silver.extension.bidirtransform.PhasTrans.localAttributes[silver.extension.bidirtransform.Init.hd__ON__silver_extension_bidirtransform_hasTrans] = new common.Lazy() { public final Object eval(final common.DecoratedNode context) { return ((silver.extension.bidirtransform.NTransformRule)core.Phead.invoke(context.childAsIsLazy(silver.extension.bidirtransform.PhasTrans.i_rules))); } };
		// hd.absGroup = absGroup
		silver.extension.bidirtransform.PhasTrans.localInheritedAttributes[silver.extension.bidirtransform.Init.hd__ON__silver_extension_bidirtransform_hasTrans][silver.extension.bidirtransform.Init.silver_extension_bidirtransform_absGroup__ON__silver_extension_bidirtransform_TransformRule] = new common.Lazy() { public final Object eval(final common.DecoratedNode context) { return ((common.DecoratedNode)context.childAsIs(silver.extension.bidirtransform.PhasTrans.i_absGroup)); } };
		// hd.cncGroup = cncGroup
		silver.extension.bidirtransform.PhasTrans.localInheritedAttributes[silver.extension.bidirtransform.Init.hd__ON__silver_extension_bidirtransform_hasTrans][silver.extension.bidirtransform.Init.silver_extension_bidirtransform_cncGroup__ON__silver_extension_bidirtransform_TransformRule] = new common.Lazy() { public final Object eval(final common.DecoratedNode context) { return ((common.DecoratedNode)context.childAsIs(silver.extension.bidirtransform.PhasTrans.i_cncGroup)); } };
		silver.extension.bidirtransform.PgetTrans.initProductionAttributeDefinitions();
		...
		silver.extension.bidirtransform.PfillExprPatternHelper.initProductionAttributeDefinitions();
		...
		silver.extension.bidirtransform.PidxOf.initProductionAttributeDefinitions();
		//FUNCTION findIdx Integer ::= ls::[String] item::String 
		//FUNCTION findIdxHelper Integer ::= ls::[String] item::String idx::Integer 
		//FUNCTION matchAppExpsToPattern Pair<[Expr] [String]> ::= appexps::AppExprs pattern::PatternList 
		...
		silver.extension.bidirtransform.PrewriteRuleRestoreProd.initProductionAttributeDefinitions();
		silver.extension.bidirtransform.PrewriteRuleType.initProductionAttributeDefinitions();
		silver.extension.bidirtransform.PrewriteRuleRestoreType.initProductionAttributeDefinitions();
		...
		silver.definition.core.PproductionDcl.childInheritedAttributes[silver.definition.core.PproductionDcl.i_body][silver.extension.bidirtransform.Init.silver_extension_bidirtransform_prodOutput__ON__silver_definition_core_ProductionBody] = new common.Lazy() { public final Object eval(final common.DecoratedNode context) { return ((silver.definition.env.NNamedSignatureElement)((silver.definition.env.NNamedSignature)context.childDecorated(silver.definition.core.PproductionDcl.i_ns).synthesized(silver.definition.core.Init.silver_definition_env_namedSignature__ON__silver_definition_core_ProductionSignature)).decorate(context, (common.Lazy[])null).synthesized(silver.definition.env.Init.silver_definition_env_outputElement__ON__silver_definition_env_NamedSignature)); } };
		...
		// top.ppDebug = "prodDcl"
		silver.definition.env.PprodDcl.synthesizedAttributes[silver.extension.bidirtransform.Init.silver_extension_bidirtransform_ppDebug__ON__silver_definition_env_DclInfo] = new common.Lazy() { public final Object eval(final common.DecoratedNode context) { return (new common.StringCatter("prodDcl")); } };
		// top.prodNamedSig = [ ns ]
		...
		//FUNCTION inhRedexNameSig String ::= ns::Decorated NamedSignature 
		//FUNCTION validInhRedex String ::= test::String def::String 
	...
	public static int count_local__ON__silver_extension_bidirtransform_fillExprPatternHelper = 0;
	...
	public static int count_local__ON__silver_extension_bidirtransform_rewriteRuleRestoreProd = 0;
	public static int count_local__ON__silver_extension_bidirtransform_rewriteRuleType = 0;
	public static int count_local__ON__silver_extension_bidirtransform_rewriteRuleRestoreType = 0;
	...
	public static int count_local__ON__silver_extension_bidirtransform_validInhRedex = 0;
...
public static final int absSig__ON__silver_extension_bidirtransform_productionDef = silver.extension.bidirtransform.Init.count_local__ON__silver_extension_bidirtransform_productionDef++;
public static final int cncSig__ON__silver_extension_bidirtransform_productionDef = silver.extension.bidirtransform.Init.count_local__ON__silver_extension_bidirtransform_productionDef++;
...
public static final int addAttrs__ON__silver_extension_bidirtransform_originAttributeDcl = silver.extension.bidirtransform.Init.count_local__ON__silver_extension_bidirtransform_originAttributeDcl++;
public static final int qnsTail__ON__silver_extension_bidirtransform_originAttributes = silver.extension.bidirtransform.Init.count_local__ON__silver_extension_bidirtransform_originAttributes++;
public static final int oProds__ON__silver_extension_bidirtransform_originAttribute = silver.extension.bidirtransform.Init.count_local__ON__silver_extension_bidirtransform_originAttribute++;
...
public static final int oProds__ON__silver_extension_bidirtransform_optOriginAttribute = silver.extension.bidirtransform.Init.count_local__ON__silver_extension_bidirtransform_optOriginAttribute++;
