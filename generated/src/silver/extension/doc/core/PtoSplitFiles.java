...
public final class PtoSplitFiles extends common.FunctionNode {
	...
	public static common.ConsCell invoke(final Object c_comments, final Object c_sortedComments, final Object c_header) {
		...
		return (common.ConsCell)(new common.PatternLazy<common.ConsCell, common.ConsCell>() { public final common.ConsCell eval(final common.DecoratedNode context, common.ConsCell scrutineeIter) {final common.ConsCell scrutinee = scrutineeIter; if(!scrutineeIter.nil()) {final common.Thunk<Object> __SV_LOCAL_11252___sv_pv_11253_c = new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return scrutinee.head(); } };
final common.Thunk<Object> __SV_LOCAL_11254___sv_pv_11251_rest = new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return scrutinee.tail(); } };
return ((common.ConsCell)(new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { final common.Thunk<Object> __SV_LOCAL_11255_rest = new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((common.ConsCell)(__SV_LOCAL_11254___sv_pv_11251_rest.eval())); } };
return ((common.ConsCell)(new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { final common.Thunk<Object> __SV_LOCAL_11256_c = new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((silver.extension.doc.core.NCommentItem)(__SV_LOCAL_11252___sv_pv_11253_c.eval())); } };
return ((common.ConsCell)silver.extension.doc.core.PtoSplitFiles.invoke(__SV_LOCAL_11255_rest, new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((common.ConsCell)silver.extension.doc.core.PplaceComment.invoke(__SV_LOCAL_11256_c, context.childAsIsLazy(silver.extension.doc.core.PtoSplitFiles.i_sortedComments), context.childAsIsLazy(silver.extension.doc.core.PtoSplitFiles.i_header))); } }, context.childAsIsLazy(silver.extension.doc.core.PtoSplitFiles.i_header))); } }).eval()); } }).eval()); }
