...
public final class PtoSingleMarkdown extends common.FunctionNode {
	...
	public static common.StringCatter invoke(final Object c_comments) {
		...
		return (common.StringCatter)(new common.PatternLazy<common.ConsCell, common.StringCatter>() { public final common.StringCatter eval(final common.DecoratedNode context, common.ConsCell scrutineeIter) {final common.ConsCell scrutinee = scrutineeIter; if(!scrutineeIter.nil()) {final common.Thunk<Object> __SV_LOCAL_11302___sv_pv_11303_c = new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return scrutinee.head(); } };
final common.Thunk<Object> __SV_LOCAL_11304___sv_pv_11301_rest = new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return scrutinee.tail(); } };
return ((common.StringCatter)(new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { final common.Thunk<Object> __SV_LOCAL_11305_rest = new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((common.ConsCell)(__SV_LOCAL_11304___sv_pv_11301_rest.eval())); } };
return ((common.StringCatter)(new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { final common.Thunk<Object> __SV_LOCAL_11306_c = new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((silver.extension.doc.core.NCommentItem)(__SV_LOCAL_11302___sv_pv_11303_c.eval())); } };
return new common.StringCatter((common.StringCatter)((common.StringCatter)silver.extension.doc.core.PtoMarkdown.invoke(__SV_LOCAL_11306_c)), (common.StringCatter)((common.StringCatter)silver.extension.doc.core.PtoSingleMarkdown.invoke(__SV_LOCAL_11305_rest))); } }).eval()); } }).eval()); }
