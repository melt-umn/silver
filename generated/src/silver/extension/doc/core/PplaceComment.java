...
public final class PplaceComment extends common.FunctionNode {
	...
	public static common.ConsCell invoke(final Object c_comment, final Object c_sortedComments, final Object c_header) {
		...
		return (common.ConsCell)(new common.PatternLazy<common.ConsCell, common.ConsCell>() { public final common.ConsCell eval(final common.DecoratedNode context, common.ConsCell scrutineeIter) {final common.ConsCell scrutinee = scrutineeIter; if(!scrutineeIter.nil()) {final common.Thunk<Object> __SV_LOCAL_11271___sv_tmp_pv_11270 = new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return scrutinee.head(); } };
final common.Thunk<Object> __SV_LOCAL_11272___sv_pv_11273_rest = new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return scrutinee.tail(); } };
return new common.PatternLazy<common.DecoratedNode, common.ConsCell>() { public final common.ConsCell eval(final common.DecoratedNode context, common.DecoratedNode scrutineeIter) {while(true) {final common.DecoratedNode scrutinee = scrutineeIter; final common.Node scrutineeNode = scrutinee.undecorate(); if(scrutineeNode instanceof core.Ppair) { final common.Thunk<Object> __SV_LOCAL___pv11275___sv_pv_11276_filename = new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return (common.StringCatter)scrutinee.childAsIs(0); } };
final common.Thunk<Object> __SV_LOCAL___pv11277___sv_pv_11278_contents = new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return (common.StringCatter)scrutinee.childAsIs(1); } };
 return (common.ConsCell)((common.ConsCell)(new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { final common.Thunk<Object> __SV_LOCAL_11279_rest = new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((common.ConsCell)(__SV_LOCAL_11272___sv_pv_11273_rest.eval())); } };
return ((common.ConsCell)(new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { final common.Thunk<Object> __SV_LOCAL_11280_contents = new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((common.StringCatter)(__SV_LOCAL___pv11277___sv_pv_11278_contents.eval())); } };
return ((common.ConsCell)(new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { final common.Thunk<Object> __SV_LOCAL_11281_filename = new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((common.StringCatter)(__SV_LOCAL___pv11275___sv_pv_11276_filename.eval())); } };
return (((common.StringCatter)(__SV_LOCAL_11281_filename.eval())).equals(((common.StringCatter)silver.extension.doc.core.PtoMarkdownExtension.invoke(context.childDecoratedSynthesizedLazy(silver.extension.doc.core.PplaceComment.i_comment, silver.extension.doc.core.Init.silver_extension_doc_core_file__ON__silver_extension_doc_core_CommentItem)))) ? ((common.ConsCell)core.Pcons.invoke(new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((core.NPair)new core.Ppair(__SV_LOCAL_11281_filename, new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return new common.StringCatter((common.StringCatter)((common.StringCatter)(__SV_LOCAL_11280_contents.eval())), (common.StringCatter)((common.StringCatter)context.localAsIs(silver.extension.doc.core.Init.markdown__ON__silver_extension_doc_core_placeComment))); } })); } }, __SV_LOCAL_11279_rest)) : ((common.ConsCell)core.Pcons.invoke(new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((core.NPair)new core.Ppair(__SV_LOCAL_11281_filename, __SV_LOCAL_11280_contents)); } }, new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((common.ConsCell)silver.extension.doc.core.PplaceComment.invoke(common.Thunk.transformUndecorate(context.childDecoratedLazy(silver.extension.doc.core.PplaceComment.i_comment)), __SV_LOCAL_11279_rest, context.childAsIsLazy(silver.extension.doc.core.PplaceComment.i_header))); } }))); } }).eval()); } }).eval()); } }).eval()); }if(!scrutineeIter.undecorate().hasForward()) break;scrutineeIter = scrutineeIter.forward();}return ((common.ConsCell)core.Perror.invoke((new common.StringCatter("Error: pattern match failed at silver:extension:doc:core 'RootSpec.sv', 44, 9, 49, 11, 1104, 1433\n"))));}}.eval(context, (common.DecoratedNode)((core.NPair)(__SV_LOCAL_11271___sv_tmp_pv_11270.eval())).decorate(context, (common.Lazy[])null)); }
