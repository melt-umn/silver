...
public final class PsingleLineTemplateExpr extends silver.definition.core.NExpr {

	public static final int i__G_1 = 0;
	public static final int i_t = 1;


	public static final Class<?> childTypes[] = {silver.extension.templating.TSLTemplate_kwd.class,silver.extension.templating.syntax.NSingleLineTemplateString.class};

	public static final int num_local_attrs = Init.count_local__ON__silver_extension_templating_singleLineTemplateExpr;
	...
	public PsingleLineTemplateExpr(final Object c__G_1, final Object c_t, final Object a_core_location) {
	...
	public final silver.extension.templating.TSLTemplate_kwd getChild__G_1() {
		return (silver.extension.templating.TSLTemplate_kwd) (child__G_1 = common.Util.demand(child__G_1));
	}
	...
	public String getName() {
		return "silver:extension:templating:singleLineTemplateExpr";
	}
	...
	public static final common.NodeFactory<PsingleLineTemplateExpr> factory = new Factory();

	public static final class Factory extends common.NodeFactory<PsingleLineTemplateExpr> {

		@Override
		public PsingleLineTemplateExpr invoke(final Object[] children, final Object[] annotations) {
			return new PsingleLineTemplateExpr(children[0], children[1], annotations[0]);
		}
	};
