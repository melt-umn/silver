...
public final class PitemEscape extends silver.extension.templating.syntax.NTemplateStringBodyItem {
	...
	public static final int num_local_attrs = Init.count_local__ON__silver_extension_templating_syntax_itemEscape;
	...
	public PitemEscape(final Object c_nw, final Object a_core_location) {
	...
	public common.Node evalForward(final common.DecoratedNode context) {
		throw new common.exceptions.SilverInternalError("Production silver:extension:templating:syntax:itemEscape erroneously claimed to forward");
	}
	...
	public String getName() {
		return "silver:extension:templating:syntax:itemEscape";
	}
	...
	public static final common.NodeFactory<PitemEscape> factory = new Factory();

	public static final class Factory extends common.NodeFactory<PitemEscape> {

		@Override
		public PitemEscape invoke(final Object[] children, final Object[] annotations) {
			return new PitemEscape(children[0], annotations[0]);
		}
	};
