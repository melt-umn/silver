...
public final class PmruleEqForGrouping extends common.FunctionNode {
	...
	public static final int num_local_attrs = Init.count_local__ON__silver_extension_patternmatching_mruleEqForGrouping;
	...
	public PmruleEqForGrouping(final Object c_a, final Object c_b) {
		this.child_a = c_a;
		this.child_b = c_b;
	...
	public String getName() {
		return "silver:extension:patternmatching:mruleEqForGrouping";
	}

	public static Boolean invoke(final Object c_a, final Object c_b) {
		try {
		final common.DecoratedNode context = new PmruleEqForGrouping(c_a, c_b).decorate();
		//a.headPattern.patternSortKey == b.headPattern.patternSortKey
		return (Boolean)(((common.StringCatter)((common.DecoratedNode)context.childDecorated(silver.extension.patternmatching.PmruleEqForGrouping.i_a).synthesized(silver.extension.patternmatching.Init.silver_extension_patternmatching_headPattern__ON__silver_extension_patternmatching_AbstractMatchRule)).synthesized(silver.extension.patternmatching.Init.silver_extension_patternmatching_patternSortKey__ON__silver_extension_patternmatching_Pattern)).equals(((common.StringCatter)((common.DecoratedNode)context.childDecorated(silver.extension.patternmatching.PmruleEqForGrouping.i_b).synthesized(silver.extension.patternmatching.Init.silver_extension_patternmatching_headPattern__ON__silver_extension_patternmatching_AbstractMatchRule)).synthesized(silver.extension.patternmatching.Init.silver_extension_patternmatching_patternSortKey__ON__silver_extension_patternmatching_Pattern))));

		} catch(Throwable t) {
			throw new common.exceptions.TraceException("Error while evaluating function silver:extension:patternmatching:mruleEqForGrouping", t);
		}
	}
	...
	public static final class Factory extends common.NodeFactory<Boolean> {
		...
		public Boolean invoke(final Object[] children, final Object[] namedNotApplicable) {
			return PmruleEqForGrouping.invoke(children[0], children[1]);
		}
	};
}