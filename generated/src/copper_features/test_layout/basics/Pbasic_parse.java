...
public final class Pbasic_parse extends common.FunctionNode {
	...
	public static final int num_local_attrs = Init.count_local__ON__copper_features_test_layout_basics_basic_parse;
	...
	public Pbasic_parse(final Object c_stringToParse, final Object c_filenameToReport) {
	...
	public String getName() {
		return "copper_features:test_layout:basics:basic_parse";
	}

	public static core.NParseResult invoke(final Object c_stringToParse, final Object c_filenameToReport) {
		try {
		return common.Util.callCopperParser(new copper_features.test_layout.basics.Parser_copper_features_test_layout_basics_basic_parse(), c_stringToParse, c_filenameToReport);
		} catch(Throwable t) {
			throw new common.exceptions.TraceException("Error while evaluating function copper_features:test_layout:basics:basic_parse", t);
		}
	}
	...
	public static final class Factory extends common.NodeFactory<core.NParseResult> {
		...
		public core.NParseResult invoke(final Object[] children, final Object[] namedNotApplicable) {
			return Pbasic_parse.invoke(children[0], children[1]);
		}
	};
}