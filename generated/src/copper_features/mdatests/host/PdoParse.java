...
public final class PdoParse extends common.FunctionNode {
	...
	public static final int num_local_attrs = Init.count_local__ON__copper_features_mdatests_host_doParse;
	...
	public PdoParse(final Object c_stringToParse, final Object c_filenameToReport) {
	...
	public String getName() {
		return "copper_features:mdatests:host:doParse";
	}

	public static core.NParseResult invoke(final Object c_stringToParse, final Object c_filenameToReport) {
		try {
		return common.Util.callCopperParser(new copper_features.mdatests.host.Parser_copper_features_mdatests_host_doParse(), c_stringToParse, c_filenameToReport);
		} catch(Throwable t) {
			throw new common.exceptions.TraceException("Error while evaluating function copper_features:mdatests:host:doParse", t);
		}
	}
	...
	public static final class Factory extends common.NodeFactory<core.NParseResult> {
		...
		public core.NParseResult invoke(final Object[] children, final Object[] namedNotApplicable) {
			return PdoParse.invoke(children[0], children[1]);
		}
	};
}