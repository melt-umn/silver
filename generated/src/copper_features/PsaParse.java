...
public final class PsaParse extends common.FunctionNode {
	...
	public static final int num_local_attrs = Init.count_local__ON__copper_features_saParse;
	...
	public PsaParse(final Object c_stringToParse, final Object c_filenameToReport) {
	...
	public String getName() {
		return "copper_features:saParse";
	}

	public static core.NParseResult invoke(final Object c_stringToParse, final Object c_filenameToReport) {
		try {
		return common.Util.callCopperParser(new copper_features.Parser_copper_features_saParse(), c_stringToParse, c_filenameToReport);
		} catch(Throwable t) {
			throw new common.exceptions.TraceException("Error while evaluating function copper_features:saParse", t);
		}
	}
	...
	public static final class Factory extends common.NodeFactory<core.NParseResult> {
		...
		public core.NParseResult invoke(final Object[] children, final Object[] namedNotApplicable) {
			return PsaParse.invoke(children[0], children[1]);
		}
	};
}