...
public final class Pmain extends common.FunctionNode {
	...
	public static final int num_local_attrs = Init.count_local__ON__cstast_main;
	...
	public static core.NIOVal invoke(final Object c__G_1, final Object c_mainIO) {
		...
		return (core.NIOVal)(((core.NIOVal)new core.Pioval(new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((Object)core.Pexit.invoke(new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((Integer)context.localDecorated(cstast.Init.testResults__ON__cstast_main).synthesized(silver.testing.Init.silver_testing_numFailed__ON__silver_testing_TestSuite)); } }, new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((Object)core.Pprint.invoke(new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return new common.StringCatter((common.StringCatter)(new common.StringCatter("\n\n")), (common.StringCatter)new common.StringCatter((common.StringCatter)(new common.StringCatter("============================================================\n")), (common.StringCatter)new common.StringCatter((common.StringCatter)(new common.StringCatter("Test Results:\n")), (common.StringCatter)new common.StringCatter((common.StringCatter)((common.StringCatter)context.localDecorated(cstast.Init.testResults__ON__cstast_main).synthesized(silver.testing.Init.silver_testing_msg__ON__silver_testing_TestSuite)), (common.StringCatter)new common.StringCatter((common.StringCatter)(new common.StringCatter("\n\n")), (common.StringCatter)new common.StringCatter((common.StringCatter)(new common.StringCatter("Passed ")), (common.StringCatter)new common.StringCatter((common.StringCatter)((common.StringCatter)lib.extcore.PtoStringFromInteger.invoke(new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((Integer)context.localDecorated(cstast.Init.testResults__ON__cstast_main).synthesized(silver.testing.Init.silver_testing_numPassed__ON__silver_testing_TestSuite)); } })), (common.StringCatter)new common.StringCatter((common.StringCatter)(new common.StringCatter(" tests out of ")), (common.StringCatter)new common.StringCatter((common.StringCatter)((common.StringCatter)lib.extcore.PtoStringFromInteger.invoke(new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((Integer)context.localDecorated(cstast.Init.testResults__ON__cstast_main).synthesized(silver.testing.Init.silver_testing_numTests__ON__silver_testing_TestSuite)); } })), (common.StringCatter)new common.StringCatter((common.StringCatter)(new common.StringCatter("\n")), (common.StringCatter)new common.StringCatter((common.StringCatter)(new common.StringCatter("============================================================\n")), (common.StringCatter)(new common.StringCatter(""))))))))))))); } }, new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((Object)context.localDecorated(cstast.Init.testResults__ON__cstast_main).synthesized(silver.testing.Init.silver_testing_ioOut__ON__silver_testing_TestSuite)); } })); } })); } }, Integer.valueOf((int)0))));

		} catch(Throwable t) {
			throw new common.exceptions.TraceException("Error while evaluating function cstast:main", t);
		}
	}
