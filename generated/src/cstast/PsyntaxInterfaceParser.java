...
public final class PsyntaxInterfaceParser extends common.FunctionNode {
	...
	public static final int num_local_attrs = Init.count_local__ON__cstast_syntaxInterfaceParser;
	...
	public PsyntaxInterfaceParser(final Object c_stringToParse, final Object c_filenameToReport) {
	...
	public String getName() {
		return "cstast:syntaxInterfaceParser";
	}

	public static core.NParseResult invoke(final Object c_stringToParse, final Object c_filenameToReport) {
		try {
		return common.Util.callCopperParser(new cstast.Parser_cstast_syntaxInterfaceParser(), c_stringToParse, c_filenameToReport);
		} catch(Throwable t) {
			throw new common.exceptions.TraceException("Error while evaluating function cstast:syntaxInterfaceParser", t);
		}
	}
	...
	public static final class Factory extends common.NodeFactory<core.NParseResult> {
		...
		public core.NParseResult invoke(final Object[] children, final Object[] namedNotApplicable) {
			return PsyntaxInterfaceParser.invoke(children[0], children[1]);
		}
	};
}