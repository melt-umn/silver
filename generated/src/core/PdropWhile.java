...
public final class PdropWhile extends common.FunctionNode {
	...
	public static common.ConsCell invoke(final Object c_f, final Object c_lst) {
		...
		return (common.ConsCell)(((((Boolean)core.Pnull.invoke(context.childAsIsLazy(core.PdropWhile.i_lst))) || (!((Boolean)((common.NodeFactory<Boolean>)context.childAsIs(core.PdropWhile.i_f)).invoke(new Object[]{new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((Object)core.Phead.invoke(context.childAsIsLazy(core.PdropWhile.i_lst))); } }}, null)))) ? ((common.ConsCell)context.childAsIs(core.PdropWhile.i_lst)) : ((common.ConsCell)core.PdropWhile.invoke(context.childAsIsLazy(core.PdropWhile.i_f), new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((common.ConsCell)core.Ptail.invoke(context.childAsIsLazy(core.PdropWhile.i_lst))); } }))));
