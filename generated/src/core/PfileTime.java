...
public final class PfileTime extends common.FunctionNode {
	...
	public static core.NIOVal invoke(final Object c_s, final Object c_i) {
		try {
		return (core.NIOVal)new core.Pioval(((Object)common.Util.demand(c_i)), common.Util.fileTime(((common.StringCatter)common.Util.demand(c_s)).toString()));

		} catch(Throwable t) {
			throw new common.exceptions.TraceException("Error while evaluating function core:fileTime", t);
		}
	}
	...
	public static final class Factory extends common.NodeFactory<core.NIOVal> {
		...
		public core.NIOVal invoke(final Object[] children, final Object[] namedNotApplicable) {
			return PfileTime.invoke(children[0], children[1]);
		}
	};
}