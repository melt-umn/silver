...
public final class PdeleteFiles extends common.FunctionNode {
	...
	public static final int num_local_attrs = Init.count_local__ON__core_deleteFiles;
	...
	public PdeleteFiles(final Object c_s, final Object c_i) {
		this.child_s = c_s;
		this.child_i = c_i;
	...
	public String getName() {
		return "core:deleteFiles";
	}

	public static core.NIOVal invoke(final Object c_s, final Object c_i) {
		try {
		return (core.NIOVal)new core.Pioval(((Object)common.Util.demand(c_i)), common.Util.deleteFiles(((common.ConsCell)common.Util.demand(c_s))));

		} catch(Throwable t) {
			throw new common.exceptions.TraceException("Error while evaluating function core:deleteFiles", t);
		}
	}
	...
	public static final class Factory extends common.NodeFactory<core.NIOVal> {
		...
		public core.NIOVal invoke(final Object[] children, final Object[] namedNotApplicable) {
			return PdeleteFiles.invoke(children[0], children[1]);
		}
	};
}