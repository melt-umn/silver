...
public final class PbindMaybe extends common.FunctionNode {
	...
	public static core.NMaybe invoke(final Object c_m, final Object c_fn) {
		...
		return (core.NMaybe)(new common.PatternLazy<common.DecoratedNode, core.NMaybe>() { public final core.NMaybe eval(final common.DecoratedNode context, common.DecoratedNode scrutineeIter) {while(true) {final common.DecoratedNode scrutinee = scrutineeIter; final common.Node scrutineeNode = scrutinee.undecorate(); if(scrutineeNode instanceof core.Pjust) { final common.Thunk<Object> __SV_LOCAL___pv5394___sv_pv_5393_x = new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return (Object)scrutinee.childAsIs(0); } };
 return (core.NMaybe)((core.NMaybe)(new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { final common.Thunk<Object> __SV_LOCAL_5395_x = new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((Object)(__SV_LOCAL___pv5394___sv_pv_5393_x.eval())); } };
return ((core.NMaybe)((common.NodeFactory<core.NMaybe>)context.childAsIs(core.monad.PbindMaybe.i_fn)).invoke(new Object[]{__SV_LOCAL_5395_x}, null)); } }).eval()); }
