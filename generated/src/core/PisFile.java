...
public final class PisFile extends common.FunctionNode {
	...
	public static core.NIOVal invoke(final Object c_s, final Object c_i) {
		try {
		return (core.NIOVal)new core.Pioval(((Object)common.Util.demand(c_i)), common.Util.isFile(((common.StringCatter)common.Util.demand(c_s)).toString()));

		} catch(Throwable t) {
			throw new common.exceptions.TraceException("Error while evaluating function core:isFile", t);
		}
	}
	...
	public static final class Factory extends common.NodeFactory<core.NIOVal> {
		...
		public core.NIOVal invoke(final Object[] children, final Object[] namedNotApplicable) {
			return PisFile.invoke(children[0], children[1]);
		}
	};
}