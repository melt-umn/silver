...
public final class Ptail extends common.FunctionNode {
	...
	public static common.ConsCell invoke(final Object c_l) {
		try {
		return (common.ConsCell)((common.ConsCell)common.Util.demand(c_l)).tail();

		} catch(Throwable t) {
			throw new common.exceptions.TraceException("Error while evaluating function core:tail", t);
		}
	}
	...
	public static final class Factory extends common.NodeFactory<common.ConsCell> {
		...
		public common.ConsCell invoke(final Object[] children, final Object[] namedNotApplicable) {
			return Ptail.invoke(children[0]);
		}
	};
}