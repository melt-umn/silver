...
public final class PcontainsBy extends common.FunctionNode {
	...
	public static Boolean invoke(final Object c_eq, final Object c_elem, final Object c_lst) {
		...
		return (Boolean)(((!((Boolean)core.Pnull.invoke(context.childAsIsLazy(core.PcontainsBy.i_lst)))) && (((Boolean)((common.NodeFactory<Boolean>)context.childAsIs(core.PcontainsBy.i_eq)).invoke(new Object[]{context.childAsIsLazy(core.PcontainsBy.i_elem), new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((Object)core.Phead.invoke(context.childAsIsLazy(core.PcontainsBy.i_lst))); } }}, null)) || ((Boolean)core.PcontainsBy.invoke(context.childAsIsLazy(core.PcontainsBy.i_eq), context.childAsIsLazy(core.PcontainsBy.i_elem), new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((common.ConsCell)core.Ptail.invoke(context.childAsIsLazy(core.PcontainsBy.i_lst))); } })))));
