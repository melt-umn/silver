...
public final class PisDigit extends common.FunctionNode {
	...
	public static Boolean invoke(final Object c_str) {
		try {
		return (Boolean)common.Util.isDigit(((common.StringCatter)common.Util.demand(c_str)).toString());

		} catch(Throwable t) {
			throw new common.exceptions.TraceException("Error while evaluating function core:isDigit", t);
		}
	}
	...
	public static final class Factory extends common.NodeFactory<Boolean> {
		...
		public Boolean invoke(final Object[] children, final Object[] namedNotApplicable) {
			return PisDigit.invoke(children[0]);
		}
	};
}