...
public final class PstringLte extends common.FunctionNode {
	...
	public static Boolean invoke(final Object c_s1, final Object c_s2) {
		try {
		final common.DecoratedNode context = new PstringLte(c_s1, c_s2).decorate();
		//s1 <= s2
		return (Boolean)((((common.StringCatter)context.childAsIs(core.PstringLte.i_s1)).toString().compareTo(((common.StringCatter)context.childAsIs(core.PstringLte.i_s2)).toString()) <= 0));
			...
			throw new common.exceptions.TraceException("Error while evaluating function core:stringLte", t);
		}
	}
	...
	public static final class Factory extends common.NodeFactory<Boolean> {
		...
		public Boolean invoke(final Object[] children, final Object[] namedNotApplicable) {
			return PstringLte.invoke(children[0], children[1]);
		}
	};
}