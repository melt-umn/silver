...
public final class Pright extends core.NEither {
	...
	public static final int num_local_attrs = Init.count_local__ON__core_right;
	...
	public Pright(final Object c_value) {
		super();
	...
	public common.Node evalForward(final common.DecoratedNode context) {
		throw new common.exceptions.SilverInternalError("Production core:right erroneously claimed to forward");
	}
	...
	public static final common.NodeFactory<Pright> factory = new Factory();

	public static final class Factory extends common.NodeFactory<Pright> {

		@Override
		public Pright invoke(final Object[] children, final Object[] annotations) {
			return new Pright(children[0]);
		}
	};
