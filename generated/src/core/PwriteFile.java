...
public final class PwriteFile extends common.FunctionNode {
	...
	public static Object invoke(final Object c_file, final Object c_contents, final Object c_i) {
		try {
		return (Object)common.Util.io(((Object)common.Util.demand(c_i)), common.Util.writeFile(((common.StringCatter)common.Util.demand(c_file)).toString(), ((common.StringCatter)common.Util.demand(c_contents))));

		} catch(Throwable t) {
			throw new common.exceptions.TraceException("Error while evaluating function core:writeFile", t);
		}
	}
	...
	public static final class Factory extends common.NodeFactory<Object> {
		...
		public Object invoke(final Object[] children, final Object[] namedNotApplicable) {
			return PwriteFile.invoke(children[0], children[1], children[2]);
		}
	};
}