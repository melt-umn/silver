...
public final class PfromRight extends common.FunctionNode {
	...
	public static Object invoke(final Object c_e, final Object c_o) {
		...
		return (Object)(new common.PatternLazy<common.DecoratedNode, Object>() { public final Object eval(final common.DecoratedNode context, common.DecoratedNode scrutineeIter) {while(true) {final common.DecoratedNode scrutinee = scrutineeIter; final common.Node scrutineeNode = scrutinee.undecorate(); if(scrutineeNode instanceof core.Pleft) { final common.Thunk<Object> __SV_LOCAL___pv4482___sv_tmp_pv_4483 = new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return (Object)scrutinee.childAsIs(0); } };
 return (Object)((Object)context.childAsIs(core.PfromRight.i_o)); }
else if(scrutineeNode instanceof core.Pright) { final common.Thunk<Object> __SV_LOCAL___pv4485___sv_pv_4484_b = new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return (Object)scrutinee.childAsIs(0); } };
 return (Object)((Object)(new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { final common.Thunk<Object> __SV_LOCAL_4486_b = new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((Object)(__SV_LOCAL___pv4485___sv_pv_4484_b.eval())); } };
return ((Object)(__SV_LOCAL_4486_b.eval())); } }).eval()); }if(!scrutineeIter.undecorate().hasForward()) break;scrutineeIter = scrutineeIter.forward();}return ((Object)core.Perror.invoke((new common.StringCatter("Error: pattern match failed at core 'Either.sv', 59, 9, 62, 5, 1142, 1192\n"))));}}.eval(context, (common.DecoratedNode)context.childDecorated(core.PfromRight.i_e)));
