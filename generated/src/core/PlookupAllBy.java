...
public final class PlookupAllBy extends common.FunctionNode {
	...
	public static common.ConsCell invoke(final Object c_eqf, final Object c_elem, final Object c_lst) {
		...
		return (common.ConsCell)((((Boolean)core.Pnull.invoke(context.childAsIsLazy(core.PlookupAllBy.i_lst))) ? ((common.ConsCell)core.Pnil.invoke()) : (((Boolean)((common.NodeFactory<Boolean>)context.childAsIs(core.PlookupAllBy.i_eqf)).invoke(new Object[]{context.childAsIsLazy(core.PlookupAllBy.i_elem), new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((Object)((core.NPair)core.Phead.invoke(context.childAsIsLazy(core.PlookupAllBy.i_lst))).decorate(context, (common.Lazy[])null).synthesized(core.Init.core_fst__ON__core_Pair)); } }}, null)) ? ((common.ConsCell)core.Pcons.invoke(new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((Object)((core.NPair)core.Phead.invoke(context.childAsIsLazy(core.PlookupAllBy.i_lst))).decorate(context, (common.Lazy[])null).synthesized(core.Init.core_snd__ON__core_Pair)); } }, new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((common.ConsCell)core.PlookupAllBy.invoke(context.childAsIsLazy(core.PlookupAllBy.i_eqf), context.childAsIsLazy(core.PlookupAllBy.i_elem), new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((common.ConsCell)core.Ptail.invoke(context.childAsIsLazy(core.PlookupAllBy.i_lst))); } })); } })) : ((common.ConsCell)core.PlookupAllBy.invoke(context.childAsIsLazy(core.PlookupAllBy.i_eqf), context.childAsIsLazy(core.PlookupAllBy.i_elem), new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((common.ConsCell)core.Ptail.invoke(context.childAsIsLazy(core.PlookupAllBy.i_lst))); } })))));
