...
public final class PindexOf extends common.FunctionNode {
	...
	public static Integer invoke(final Object c_needle, final Object c_haystack) {
		try {
		return (Integer)Integer.valueOf(((common.StringCatter)common.Util.demand(c_haystack)).toString().indexOf(((common.StringCatter)common.Util.demand(c_needle)).toString()));

		} catch(Throwable t) {
			throw new common.exceptions.TraceException("Error while evaluating function core:indexOf", t);
		}
	}
	...
	public static final class Factory extends common.NodeFactory<Integer> {
		...
		public Integer invoke(final Object[] children, final Object[] namedNotApplicable) {
			return PindexOf.invoke(children[0], children[1]);
		}
	};
}