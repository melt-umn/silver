...
public final class Pfoldl1 extends common.FunctionNode {
	...
	public static Object invoke(final Object c_f, final Object c_l) {
		...
		return (Object)((((Boolean)core.Pnull.invoke(context.childAsIsLazy(core.Pfoldl1.i_l))) ? ((Object)core.Perror.invoke((new common.StringCatter("Applying foldl1 to empty list.")))) : ((Object)core.Pfoldl.invoke(context.childAsIsLazy(core.Pfoldl1.i_f), new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((Object)core.Phead.invoke(context.childAsIsLazy(core.Pfoldl1.i_l))); } }, new common.Thunk<Object>(context) { public final Object doEval(final common.DecoratedNode context) { return ((common.ConsCell)core.Ptail.invoke(context.childAsIsLazy(core.Pfoldl1.i_l))); } }))));
