...
public final class Pnull extends common.FunctionNode {
	...
	public static Boolean invoke(final Object c_l) {
		try {
		return (Boolean)((common.ConsCell)common.Util.demand(c_l)).nil();

		} catch(Throwable t) {
			throw new common.exceptions.TraceException("Error while evaluating function core:null", t);
		}
	}
	...
	public static final class Factory extends common.NodeFactory<Boolean> {
		...
		public Boolean invoke(final Object[] children, final Object[] namedNotApplicable) {
			return Pnull.invoke(children[0]);
		}
	};
}