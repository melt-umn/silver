...
public final class Pcwd extends common.FunctionNode {
	...
	public static core.NIOVal invoke(final Object c_i) {
		try {
		return (core.NIOVal)new core.Pioval(((Object)common.Util.demand(c_i)), common.Util.cwd());

		} catch(Throwable t) {
			throw new common.exceptions.TraceException("Error while evaluating function core:cwd", t);
		}
	}
