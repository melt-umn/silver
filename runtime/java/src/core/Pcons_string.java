...
public class Pcons_string extends core.NStringList {

	public static final int i_h = 0;
	public static final int i_t = 1;

	public static final Class<?> childTypes[] = {StringBuffer.class, core.NStringList.class};
	...
	static{
	Pcons_string.inheritedAttributes.put(i_h, new java.util.TreeMap<String, common.Lazy>());
	Pcons_string.inheritedAttributes.put(i_t, new java.util.TreeMap<String, common.Lazy>());
	}

	public Pcons_string(Object c_h, Object c_t){
		super(2);
