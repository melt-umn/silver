...
public class PconsString extends core.NStringList {
	...
	static{
	PconsString.inheritedAttributes.put(i_h, new java.util.TreeMap<String, common.Lazy>());
	PconsString.inheritedAttributes.put(i_t, new java.util.TreeMap<String, common.Lazy>());
	}

	public PconsString(Object c_h, Object c_t){
		super(2);
