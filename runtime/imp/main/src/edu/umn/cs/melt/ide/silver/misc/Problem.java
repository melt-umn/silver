...
public class Problem {
	...
	public static Problem extractProblem(NMessage ideMsg) {
		...
		String filename = ((StringCatter)where.synthesized(silver.core.Init.core_filename__ON__core_Location)).toString();
		...
		int line = (Integer)where.synthesized(silver.core.Init.core_line__ON__core_Location);
		int column = (Integer)where.synthesized(silver.core.Init.core_column__ON__core_Location);
		int index = (Integer)where.synthesized(silver.core.Init.core_index__ON__core_Location);
		int endIndex = (Integer)where.synthesized(silver.core.Init.core_endIndex__ON__core_Location);
