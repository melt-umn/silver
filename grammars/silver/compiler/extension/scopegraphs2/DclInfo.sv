...
top::ProductionStmt ::= @dl::DefLHS @attr::QNameAttrOccur e::Expr
{
  ...
  local labs::[String] =
    let res::AttributeDclInfo = attrQn.lookupAttribute.dcl in
      ...
      | _ -> error("Impossible(?) silver:compiler:extension:scopegraphs2:scopeAttributeAttributionDcl:labs")
      end
    end;
...
fun appendToQName QName ::= orig::QName extra::String =
  ...
  | qNameError(_) -> error("Impossible(?) silver:compiler:extension:scopegraphs2:appendToQName")
  end;
